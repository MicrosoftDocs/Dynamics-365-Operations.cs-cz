...
Toto téma popisuje funkci, které je určena uživatelům, kteří mají různá postižení. Existují například funkce pro zrakově postižené uživatele, kteří používají technologie jako je Microsoft Windows Narrator
