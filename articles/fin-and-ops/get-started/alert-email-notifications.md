...
Služba odešle e-mailová upozornění pomocí předdefinovaných šablon e-mailu, které doručují základní podrobnosti výstražných upozornění. Tyto podrobnosti zahrnují přímý odkaz na stránku, kde bylo definováno pravidla výstrahy.
