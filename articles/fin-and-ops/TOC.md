...
### [Standardní náklady](../supply-chain/cost-management/prerequisites-standard-costs.md)
...
### [Předem stanovené náklady](../supply-chain/cost-management/costing-versions.md)
...
### [Skladové účetnictví](../supply-chain/cost-management/fifo-physical-value-marking.md)
...
### [Účetnictví pro výrobu](../supply-chain/cost-management/production-order-cost-analysis.md)
...
#### [Generování elektronických dokumentů a aktualizace dat aplikací pomocí nástroje elektronického výkaznictví](../dev-itpro/analytics/generate-electronic-documents-update-application-data.md)
...
##### [Životní cyklus dávkové objednávky od vytvoření po spuštění (průvodce záznamem úloh)](../supply-chain/production-control/tasks/batch-order-lifecycle-start.md)
##### [Seřazení výrobních úloh pro procesní výrobu (průvodce záznamem úloh)](../supply-chain/production-control/tasks/sequence-production-jobs-process-manufacturing.md)
##### [Nahrazení materiálů ve výrobě](../supply-chain/production-control/substitute-items-bom-lines.md)
##### [Registrace pro realizaci výroby](../supply-chain/production-control/registration-manufacturing-execution.md)
##### [Zpětná vazba z výroby](../supply-chain/production-control/production-feedback.md)
##### [Registrace času a docházky](../supply-chain/production-control/time-attendance-registrations.md) 
...
##### [Vytvoření nového stavu životního cyklu produktu (Průvodce záznamem úloh)](../supply-chain/pim/tasks/new-product-lifecycle-state.md)
##### [Vytvoření výchozího stavu životního cyklu produktu (Průvodce záznamem úloh)](../supply-chain/pim/tasks/default-product-lifecycle-state.md)
##### [Přiřazení stavu životního cyklu produktu k uvolněnému základnímu produktu (Průvodce záznamem úloh)](../supply-chain/pim/tasks/product-lifecycle-state-released-product-master.md)
##### [Přiřazení stavu životního cyklu produktu k uvolněnému produktu (Průvodce záznamem úloh)](../supply-chain/pim/tasks/product-lifecycle-state-released-product.md)
##### [Vyhledání zastaralých variant produktů (Průvodce záznamem úloh)](../supply-chain/pim/tasks/obsolete-product-variants.md)
##### [Vyjmutí produktů z hlavního plánu (Průvodce záznamem úloh)](../supply-chain/pim/tasks/exclude-products-master-planning.md)
