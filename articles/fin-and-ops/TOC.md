...
##### [Microsoft FastTrack pro Dynamics 365](get-started/fasttrack-dynamics-365-overview.md)
...
#### [Formulář výpočtu nákladů](../supply-chain/cost-management/costing-sheets.md)
#### [Verze výpočtu nákladů](../supply-chain/cost-management/costing-versions.md)
#### [Simulace změny nákladů pomocí verze výpočtu nákladů pro plánované náklady](../supply-chain/cost-management/simulate-cost-changes-costing-version-planned-costs.md)
...
#### Výpočty kusovníku pomocí formuláře výpočtu nákladů (Přehrajte si průvodce záznamem úloh podle pořadí)
...
#### [Výpočty kusovníků se standardními náklady](../supply-chain/cost-management/information-used-bom-calculations-standard-costs.md)
...
##### [Balíčky dat konfigurace (pouze vydání z července 2017)](../dev-itpro/data-entities/configuration-data-packages.md)
...
#### [Hledání informací o standardních datových entitách](../dev-itpro/data-entities/data-entities-report.md)
...
##### [Storno elektronické faktury](../financials/localizations/tasks/mx-00010-cancel-electronic-invoice.md)
...
#### [Finanční přehledy](../dev-itpro/analytics/financial-insights.md)
...
#### [Rozšíření položek nabídky sestavy](../dev-itpro/analytics/extend-report-menu-items.md)
...
#### [Nastavení elektronického výkaznictví pomocí služby Power BI](../dev-itpro/analytics/general-electronic-reporting-report-configuration-get-data-powerbi.md)
...
#### [Výběr definice datového modelu při vytváření formátu pro elektronické výkaznictví](../dev-itpro/analytics/tasks/er-select-data-model-definition-creating-er-format-july-2017.md)
...
##### [Návrh datového modelu k používání finančních dimenzí jako zdroje dat pro elektronické výkaznictví](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-1.md)
...
##### [Návrh konfigurací pro generování sestav ve formátu Microsoft Office s integrovanými obrázky pro elektronické výkaznictví (ER) (Část 1) ](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md)
##### [Kontrola konfigurací pro provedení sestav ve formátech Microsoft Office s integrovanými obrázky pro elektronické výkaznictví](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-2-review-configurations.md)
##### [Generování sestav ve formátech Microsoft Office s integrovanými obrázky pro elektronické výkaznictví](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-3-generate-reports.md)
...
#### [Analýza příchozích dokumentů k aktualizaci dat aplikace](../dev-itpro/analytics/parse-incoming-electronic-documents.md)
#### [Analýza vstupních dokumentů ve formátu CSV](../dev-itpro/analytics/parse-incoming-electronic-documents-csv-format.md)

##### [Změny rozhraní API architektury elektronického výkaznictví pro Application update 7.3](../dev-itpro/analytics/er-apis-app73.md)
