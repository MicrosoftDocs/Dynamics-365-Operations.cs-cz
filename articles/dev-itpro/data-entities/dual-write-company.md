...
Koncept *společnosti* v Microsoft Dynamics 365 for Finance and Operations je právní i obchodní konstrukt. Je to také hranice pro zabezpečení a viditelnost dat. Uživatelé pracují vždy v kontextu jedné společnosti a většina dat je rozdělena podle společnosti.

Common Data Service nemá ekvivalentní koncepci. Nejbližší koncept je *organizační jednotka*, která je primárně hranicí zabezpečení a viditelnosti pro uživatelská data. Tento koncept nemá stejné právní nebo obchodní důsledky jako koncepce společnosti v aplikaci Finance and Operations.

Vzhledem k tomu, že organizační jednotka a společnost nejsou rovnocennými koncepty, není možné vynutit mapování mezi nimi (1:1) pro účely integrace Common Data Service. Protože však uživatelé musí mít ve výchozím nastavení možnost zobrazit stejné záznamy v aplikac Finance and Operations a Common Data Service, společnost Microsoft zavedla novou entitu v aplikaci Common Data Service s názvem cdm\_Company. Tato entita je ekvivalentní s entitou společnosti v aplikaci Finance and Operations. Chcete-li zajistit, aby viditelnost záznamů byla ekvivalentní mezi Finance and Operations a Common Data Service, doporučujeme následující nastavení dat v aplikaci Common Data Service:
...
+ Ve výchozím nastavení je vlastník libovolného záznamu vytvořeného v Finance and Operations a s dvojím zápisem do Common Data Service nastaven na tým "DW Owner", který je propojen s přidruženou organizační jednotkou.
...
+ Pouze záznamy s daty společnosti jsou způsobilé pro duální zápis mezi Finance and Operations a Common Data Service.
