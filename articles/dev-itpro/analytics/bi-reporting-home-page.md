...
Toto téma vás nasměruje na zdroje, které můžete použít, abyste se dozvěděli více o business intelligence (BI) a nástrojích pro vykazování v aplikaci Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition.
...
- [Sestava klíčových ukazatelů výkonnosti (KPI)](key-performance-indicators-report.md)
