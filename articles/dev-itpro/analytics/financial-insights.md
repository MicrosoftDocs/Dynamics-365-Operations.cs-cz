...
**Finanční přehledy** používají Microsoft Power BI pro spojení finančních klíčových indikátorů výkonnosti, grafů a finančních výkazů. Power BI je integrováno v aplikaci Microsoft Dynamics 365 Finance and Operations, Enterprise edition.
...
## <a name="finance-and-operations-setup"></a>Nastavení aplikace Finance and Operations
**Hlavní kniha**
...
Uživatelé mohou filtrovat sestavu pomocí podokna **Filtr** na levé straně. Toto podokno je stejné, jako podokno dostupné prostřednictvím Power BI Desktop.
Existují různé úrovně filtrování, z nichž některé nemusí být k dispozici v závislosti na výběru na stránce (kartě) nebo použíití podrobných možností:
...
## <a name="what-is-coming-in-future-releases"></a>Co můžete očekávat v dalších verzích?
Nové pracovní prostory a finanční výkazy, které používají Power BI, budou nadále vylepšovány. Zde jsou uvedeny některé nové funkce, které jsou plánovány pro budoucí verze:

 - Možnost kopírovat, upravit, odstranit a vytvořit vizuální prvky, i finanční výkazy                                                  
 - Další výchozí sestavy                                                                                                            
    - Podpora pro další data dílčí hlavní knihy                                                                                            
 - Podpora pro měnu výkaznictví                                                                                                      
 - Přidání vlastních výpočtů pro řádky a sloupce                                                                                          
 - Možnost exportovat finanční výkazy do aplikace Microsoft Excel                                                                     
   - Zachování formátu finančního výkazu během exportu.                                                                          
   - Analyzujte data v aplikaci Excek vytvořením kontingenční tabulky, která používá informace o vizuálním prvku.                                              
 - Podpora národního prostředí                                                                                                                        
 - Možnost definovat hierarchie výkaznictví, abyste mohli definovat hierarchie hlavního účtu nebo organizační hierarchii, kterou lze použít ve finančních výkazech pro návrh, filtrování a zabezpečení.                                                                    
 - Podpora pro tisk

Nové funkce budou komunikovány prostřednictvím webových stránek, jakmile bude práce zahájena: https://roadmap.dynamics.com/.

## <a name="additional-resources-for-power-bi"></a>Další zdroje pro Power BI

Informace v následujících zdrojích není vyžadována, aby bylo možné povolit integrované sestavy pro pracovní prostory **Přehled CFO** nebo **Finanční přehledy** v produkčním prostředí. Namísto toho jsou užitečné pro vývojářská pole a pokud chcete integrovat sestavy Power BI do aplikace Finance and Operations.
