...
14. Pokud chcete znovu otestovat konfigurovaný výraz, znovu vyberte **Test**.
    ...
    ![Stránka návrháře vzorců](media/GER-BaselineSample-DefineProcessingDTExpression.PNG "Snímek obrazovky stránky návrháře vzorců")
...
Nové možnosti ER umožňují exportovat nastavení směrného plánu pro vybraný formát ER z aktuálního prostředí pro modul Finance and Operations a uložit je jako soubory XML. 
...
Exportované nastavení směrného plánu lze importovat do prostředí modulu Finance and Operations. Prostředí musí být nejprve importováno jako formát ER. Poté můžete importovat nastavení směrného plánu.
