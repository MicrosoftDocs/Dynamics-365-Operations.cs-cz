...
---
# <a name="generate-electronic-documents-for-payments-by-using-format-configurations"></a>Generování elektronických dokumentů pro platby za použití konfigurace formátu
