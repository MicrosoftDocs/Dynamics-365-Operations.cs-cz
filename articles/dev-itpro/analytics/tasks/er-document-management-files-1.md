...
---
# <a name="prepare-data-models-to-use-document-management-files-in-er-output"></a>Příprava datových modelů k použití souborů pro správu dokumentů ve výstupu elektronického výkaznictví
