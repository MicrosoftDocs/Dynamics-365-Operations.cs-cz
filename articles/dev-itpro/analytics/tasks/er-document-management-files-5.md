...
---
# <a name="modify-and-run-format-to-use-document-management-files-in-format-outputs"></a>Úprava a spuštění formátu k použití souborů pro správu dokumentů ve formátech výstupu
