...
---
# <a name="extend-data-models-to-use-document-management-files-in-er-output"></a>Rozšíření datových modelů k použití souborů pro správu dokumentů ve výstupu elektronického výkaznictví
