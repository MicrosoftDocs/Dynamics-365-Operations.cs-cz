...
---
# <a name="create-format-to-use-document-management-files-in-format-outputs"></a>Vytvoření formátu k použití souborů pro správu dokumentů ve formátech výstupu
