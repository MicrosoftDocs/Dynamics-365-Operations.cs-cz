...
4. Vyberte nabídku **Soubor**, poté **Uložit jako** a zadejte název sestavy Podrobná předvaha s atributy.
    ...
    > [!NOTE]
    > Při každém vytvoření nové sestavy v návrháři sestav se seznam finančních sestav v aplikaci Finance and Operations aktualizuje.
...
[Finanční výkaznictví](../../financials/general-ledger/financial-reporting-getting-started.md)
