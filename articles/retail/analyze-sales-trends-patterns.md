...
# <a name="analyze-sales-trends-and-patterns"></a><span data-ttu-id="35ea3-103">Analýza trendů a vzorců prodeje</span><span class="sxs-lookup"><span data-stu-id="35ea3-103">Analyze sales trends and patterns</span></span>

[!include [banner](includes/banner.md)]

<span data-ttu-id="35ea3-104">Můžete studovat trendy prodeje a vzory v reálném čase v aplikaci Microsoft Dynamics 365 for Retail.</span><span class="sxs-lookup"><span data-stu-id="35ea3-104">You can study sales trends and patterns in real time in Microsoft Dynamics 365 for Retail.</span></span>
