...
description: Toto téma poskytuje přehled omnikanálových plateb v aplikaci Microsoft Dynamics 365 for Retail.
author: rubendel
manager: AnnBe
ms.date: 05/12/2019
ms.topic: article
...
ms.locfileid: "1606185"
---
# <a name="omni-channel-payments-overview"></a>Přehled omnikanálových plateb

[!include [banner](../includes/banner.md)]

Toto téma poskytuje přehled omnikanálových plateb v aplikaci Microsoft Dynamics 365 for Retail. Obsahuje obsáhlý seznam podporovaných scénářů, informace o funkcích, nastavení a řešení problémů a popis některých typických problémů.
...
Sada SDK plateb spoléhá na dvě sady aplikačních programovacích rozhraní (API) pro platby. První sada rozhraní API je pojmenovaná **iPaymentProcessor**. Používá se k implementaci konektorů pro platby "karta není přítomna", které lze použít v kontaktních střediscích a na platformě elektronického obchodování Microsoft Dynamics. Další informace o rozhraní **iPaymentProcessor** naleznete v dokumentu white paper [Implementace platebního konektoru a platebního zařízení](https://download.microsoft.com/download/4/D/7/4D7C6B05-0C23-4C6C-BA13-AB62ED08AA61/The%20Guide%20to%20Implementing%20Payment%20Connector%20and%20Payment%20Device.docx), který se věnuje platbám. 
...
- **Konfigurace omnikanálových plateb:** V účetním systému přejděte na **Maloobchod \> Nastavení centrály \> Parametry \> Sdílené parametry maloobchodu**. Pak na kartě **Omnikanálové platby** nastavte možnost **Použít omnikanálové platby** na **Ano**.
...
- Možnost **Omnikanálové platby** na stránce **Sdílené parametry maloobchodu** je nastavená na **Pravda**.
...
3. V maloobchodu použijte dávkovou úlohu **synchronizovat objednávky** a distribuční plán **P-001** k vytvoření objednávek v kanceláři.
...
1. V maloobchodu na stránce **Sužby pro zákazníky** zadejte do vyhledávacího pole text **Karen Berg** a vyberte **Hledat.** 
