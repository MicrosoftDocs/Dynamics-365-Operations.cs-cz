...
Navigace: klikněte na **Retail** &gt; **Kanály** &gt; **Maloobchody** &gt; **Všechny maloobchody**. Vyberte obchod a potom klikněte na pevnou záložku **Hardwarové stanice**.
...
>
> Cloud POS vyžaduje samostatnou hardwarovou stanici ke komunikaci s maloobchodními periferními zařízeními.
