...
- Probíhá přijímání dat maloobchodní transakce online do HQ.
- Synchronizace objednávek za účelem vytvoření prodejních objednávek v HQ.

Přenášení dat online maloobchodní transakce lze provést buď ručním spuštěním úlohy P nebo vytvořením opakující se dávkové úlohy.

### <a name="manually-running-the-p-job"></a>Ruční spuštění úlohy P.

1. Přejděte na Všechny pracovní prostory > IT pro maloobchod.
...
3. Vyberte „Maloobchody podle regionu“ v poli Organizační hierarchie.
