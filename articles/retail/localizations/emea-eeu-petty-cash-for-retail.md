...
Tento článek obsahuje informace o východoevropské lokalizaci specifické pro oblast maloobchodu.
...
Pomocí správy hotovosti v aplikaci Retail můžete provádět následující akce:

- Vytvoření pokladního účtu pro vybraný způsob platby pro každý maloobchod.
- Použít deníky hotovosti k zaúčtování hotovostních transakcí a plateb zákazníků přijímaných v Retail POS.
- Sdružení transakcí v řádku výkazu při zaúčtování maloobchodního výkazu. Můžete sdružovat odvody do trezoru, odvody do banky, transakce dokladu, odebírat transakce odvodu, transakce s plovoucí položkou, příjmové transakce, výdajové transakce, platby odběratelů, prodejní transakce a návratové transakce.

Všechny transakce, které se uskutečňují v programu Retail POS, jsou zaúčtovány pomocí deníku hlavní knihy. Pokladní deníky plateb, deníky plateb odběratelů a hlavní deníky můžete používat k vytvoření a zaúčtování výkazů. Více informací naleznete v části [Vytvoření, výpočet a zaúčtování výkazů pro maloobchod](https://docs.microsoft.com/dynamics365/unified-operations/retail/tasks/create-calculate-post-statement-retail-store).
...
## <a name="set-up-for-cash-management-for-retail-pos"></a>Nastavení správy hotovosti pro Retail POS
...
### <a name="set-up-retail-parameters-for-cash-operations"></a>Nastavení parametrů maloobchodu pro hotovostní operace

Můžete nastavit parametry pro vytvoření a zaúčtování hotovostních transakcí v maloobchodě. K zaúčtování prodejních transakcí a platebních transakcí v Retail POS můžete použít deníky hotovostních plateb, deníky plateb odběratelů nebo hlavní deníky. Lze seskupit transakce, které mají stejné vlastnosti při zaúčtování výkazu.

1. Přejděte na možnost **Maloobchod \> Nastavení centrály \> Parametry \> Parametry maloobchodu**. V levém podokně klikněte na **Zaúčtování**.
...
### <a name="set-up-a-payment-method-for-cash-payments-in-a-retail-store"></a>Nastavení metody platby pro platby v hotovosti v programu maloobchodě

Následující postup slouží k nastavení metody platby pro platby v hotovosti v maloobchodě.

1. Přejděte do nabídky **Maloobchod \> Kanály \> Maloobchody \> Všechny maloobchody**.
2. Na stránce se seznamem **Všechny maloobchody** vyberte obchod, pro který chcete nastavit platební metodu.
