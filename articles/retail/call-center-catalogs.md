...
description: Toto téma popisuje funkce kontaktního střediska pro katalogy v aplikaci Dynamics 365 Retail.
author: josaw1
manager: AnnBe
ms.date: 05/15/2018
ms.topic: article
...
Po potvrzení ověření klepněte na tlačítko **Workflow** v nabídce ke spuštění workflow schválení. Klepněte na tlačítko **odeslat** v nabídce **workflow** ke spuštění procesu. Nakonfigurujte kroky a oprávněné uživatele workflowu z karty **Maloobchod** \> **Nastavení maloobchodní centrály** \> **Maloobchodní workflowy**. Workflow definuje postup potřebný k přesunutí katalogu do stavu **schváleno**. Když je katalog ve stavu **schváleno**, můžete klepnout na možnost **publikovat** v nabídce **katalogy** a proces dokončit. Jakmile je katalog ve stavu **publikován**, lze jej použít k zadávání objednávek call centra a procesy odeslání katalogu.
...
Abyste mohli nakonfigurovat katalogové ceny, vyberte možnost **cenové skupiny** na kartě **katalogy** k propojení jedné nebo více cenových skupiny s katalogem. Všechny obchodní smlouvy, deníky úprav cen a maloobchodní rozšířené slevy (prahová hodnota, množství, kombinace a shoda), které byly propojeny se stejnou cenovou skupinou, budou použity, když si zákazníci objednají z tohoto katalogu.
