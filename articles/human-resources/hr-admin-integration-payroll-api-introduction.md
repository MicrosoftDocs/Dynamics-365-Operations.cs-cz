...
description: Tento článek popisuje rozhraní API Dynamics 365 Human Resources pro integraci mezd.
author: twheeloc
ms.date: 02/03/2021
ms.topic: article
ms.prod: ''
...
- [Funkce pro označení zaměstnance jako připraveného k výplatě.](hr-compensation-payroll.md)
