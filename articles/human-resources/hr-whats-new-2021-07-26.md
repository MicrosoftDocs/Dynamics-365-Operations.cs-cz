---
title: Co je nového nebo co se změnilo v aplikaci Dynamics 365 Human Resources 26. července 2021
description: Tento článek popisuje funkce, které jsou nové nebo se změnily v aplikaci Microsoft Dynamics 365 Human Resources k 26. červenci 2021.
author: marcelbf
ms.date: 07/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9070073"
---
# <a name="whats-new-or-changed-in-dynamics-365-human-resources-july-26-2021"></a>Co je nového nebo co se změnilo v aplikaci Dynamics 365 Human Resources 26. července 2021
...
Tato verze obsahuje následující nové funkce a opravené chyby. Změny se vztahují na sestavení číslo 8.1.4384.
...
| --- | --- | --- |
| Platform update 10.0.20 | -- | [Aktualizace platformy pro verze 10.0.20 finančních a provozních aplikací (srpen 2021)](/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-20) |
...
| --- | --- | --- |
| 600422 | Selhání ověření adresy mzdy pro Ready to Pay. | Ověření bylo aktualizováno tak, aby vyžadovalo pouze jednu adresu typu „Místo pobytu pro mzdu“ a pouze jednu adresu typu „Místo práce pro mzdu“. |
| 601226 | Problém s integrací dat: projekt exportu integrace mezd nemá možnost úplného nabízení | Integrace mezd do Ceridian DayForce prováděla přírůstkové nabízení místo úplného nabízení. Ceridian vyžaduje vždy úplné obnovení. Tento problém je nyní vyřešen, entity v projektu exportu dat se již nebudou překlápět na přírůstkové nabízení. |
| 602272 | Dlaždice, které byly přidány do pracovního prostoru zaměstnanecké samoobsluhy, nyní chybí a dlaždice do něj již nelze přidat | Opravili jsme problém s personalizací pro samoobsluhu zaměstnanců. Do zobrazení lze přidat nové dlaždice a uživatelé budou moci vidět jakékoli stávající přizpůsobení |
| 600711 | Pole pro výběr půldenní definice je povoleno pro žádosti o volno na celý den | Tento problém je nyní vyřešen a pole definice půldne bude povoleno pouze v případě, že zaměstnanci vyberou typ volna s povolenou definicí půldne a půlden jako vybranou hodnotu množství |
| 602208 | Jednotky míry časového rozlišení zobrazující hodiny místo dnů | Tento problém je nyní vyřešen. Formulář **Volno** zobrazí správnou jednotku volna (hodiny nebo dny) pro sloupec **Míra časového rozlišení**. |
