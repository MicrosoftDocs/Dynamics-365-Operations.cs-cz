...
description: Tento článek popisuje, jak vytvořit logic app v Microsoft Azure, která exportuje data z Microsoft Dynamics 365 Human Resources podle opakujícího se plánu.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
