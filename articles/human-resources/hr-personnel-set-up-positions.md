...
description: Tento článek popisuje jak jsou pozice důležitým prvkem nižší úrovně hierarchie organizace.
author: twheeloc
ms.date: 10/28/2021
...
2. Zvolte **Otevřít pozice**.
3. Výběrem možnosti **Nové** otevřete rozevírací dialogové okno.
