...
Další informace o procesu aktualizaci služby najdete v tématu [Proces aktualizace](https://docs.microsoft.com/dynamics365/human-resources/hr-admin-setup-update-process).
