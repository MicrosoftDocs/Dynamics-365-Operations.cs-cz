...
1. V pracovním prostoru **Správa výhod** vyberte v části **Nastavení** možnost **Kódy úrovně**.
...
3. Zadejte hodnoty pro zbývající pole:
   ...
   | Pole | Popis |
   | --- | --- |
   | **Kód úrovní** | Jedinečný kód úrovně zaměstnaneckých výhod, který určuje kód úrovně. |
