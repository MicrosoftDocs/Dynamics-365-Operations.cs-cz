...
- <span data-ttu-id="4b73f-111">Data lidských zdrojů</span><span class="sxs-lookup"><span data-stu-id="4b73f-111">Human resources data</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="4b73f-141">Konfigurace vašich dat</span><span class="sxs-lookup"><span data-stu-id="4b73f-141">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="4b73f-158">Zam. výhody</span><span class="sxs-lookup"><span data-stu-id="4b73f-158">Benefits</span></span>
...
- <span data-ttu-id="4b73f-226">Platební cyklus (povinný)</span><span class="sxs-lookup"><span data-stu-id="4b73f-226">Pay cycle (required)</span></span>
...
#### <a name="pay-cycles-and-pay-periods"></a><span data-ttu-id="4b73f-241">Platební cykly a platební období</span><span class="sxs-lookup"><span data-stu-id="4b73f-241">Pay cycles and pay periods</span></span>
...
#### <a name="earning-codes"></a><span data-ttu-id="4b73f-257">Kódy příjmů</span><span class="sxs-lookup"><span data-stu-id="4b73f-257">Earning codes</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="4b73f-296">Kontaktní informace</span><span class="sxs-lookup"><span data-stu-id="4b73f-296">Contact information</span></span> 
...
- <span data-ttu-id="4b73f-358">Primární (povinné)</span><span class="sxs-lookup"><span data-stu-id="4b73f-358">Primary (required)</span></span>
...
- <span data-ttu-id="4b73f-380">Primární (povinné)</span><span class="sxs-lookup"><span data-stu-id="4b73f-380">Primary (required)</span></span>
...
<span data-ttu-id="4b73f-421">Následující kódy důvodů a popisy jsou povinné.</span><span class="sxs-lookup"><span data-stu-id="4b73f-421">The following reason codes and descriptions are required.</span></span>
...
| <span data-ttu-id="4b73f-458">Vdovec/vdova</span><span class="sxs-lookup"><span data-stu-id="4b73f-458">Widowed</span></span>                | <span data-ttu-id="4b73f-459">Vdovec/vdova</span><span class="sxs-lookup"><span data-stu-id="4b73f-459">Widowed</span></span>              |
...
- <span data-ttu-id="4b73f-491">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-491">2OFMTH</span></span>
...
- <span data-ttu-id="4b73f-511">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="4b73f-511">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="4b73f-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="4b73f-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="4b73f-513">Adresy</span><span class="sxs-lookup"><span data-stu-id="4b73f-513">Addresses</span></span>

<span data-ttu-id="4b73f-514">Identifikace konkrétních kódů země nebo oblasti, státu a okresu vyžaduje konkrétní formáty, které Dayforce a místní poskytovatelé mohou rozpoznat.</span><span class="sxs-lookup"><span data-stu-id="4b73f-514">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="4b73f-515">Ačkoliv je formát pro města flexibilní, je nutné přiřadit ke každému městu stát.</span><span class="sxs-lookup"><span data-stu-id="4b73f-515">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="4b73f-516">Lidské zdroje</span><span class="sxs-lookup"><span data-stu-id="4b73f-516">Human Resources</span></span>          | <span data-ttu-id="4b73f-517">Dayforce</span><span class="sxs-lookup"><span data-stu-id="4b73f-517">Dayforce</span></span>              |
|-----------------|-----------------------|
| <span data-ttu-id="4b73f-518">Země/region</span><span class="sxs-lookup"><span data-stu-id="4b73f-518">Country/Region</span></span>  | <span data-ttu-id="4b73f-519">Kód země</span><span class="sxs-lookup"><span data-stu-id="4b73f-519">Country Code</span></span>          |
| <span data-ttu-id="4b73f-520">PSČ</span><span class="sxs-lookup"><span data-stu-id="4b73f-520">Zip/Postal Code</span></span> | <span data-ttu-id="4b73f-521">PSČ</span><span class="sxs-lookup"><span data-stu-id="4b73f-521">Postal Code</span></span>           |
| <span data-ttu-id="4b73f-522">Kraj</span><span class="sxs-lookup"><span data-stu-id="4b73f-522">State</span></span>           | <span data-ttu-id="4b73f-523">Kód státu</span><span class="sxs-lookup"><span data-stu-id="4b73f-523">State Code</span></span>            |
| <span data-ttu-id="4b73f-524">Město</span><span class="sxs-lookup"><span data-stu-id="4b73f-524">City</span></span>            | <span data-ttu-id="4b73f-525">Město</span><span class="sxs-lookup"><span data-stu-id="4b73f-525">City</span></span>                  |
| <span data-ttu-id="4b73f-526">Okres</span><span class="sxs-lookup"><span data-stu-id="4b73f-526">County</span></span>          | <span data-ttu-id="4b73f-527">Okres</span><span class="sxs-lookup"><span data-stu-id="4b73f-527">County (Municipality)</span></span> |
| <span data-ttu-id="4b73f-528">Ulice</span><span class="sxs-lookup"><span data-stu-id="4b73f-528">Street</span></span>          | <span data-ttu-id="4b73f-529">Řádek adresy 1</span><span class="sxs-lookup"><span data-stu-id="4b73f-529">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="4b73f-530">Daňové oblasti</span><span class="sxs-lookup"><span data-stu-id="4b73f-530">Tax regions</span></span>

<span data-ttu-id="4b73f-531">Oblasti daně se používají pro určení příslušné daně, která se má použít během generování mzdy.</span><span class="sxs-lookup"><span data-stu-id="4b73f-531">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="4b73f-532">Daňové oblasti jsou mapovány na Dayforce jako adresy místa.</span><span class="sxs-lookup"><span data-stu-id="4b73f-532">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="4b73f-533">Výchozí oblasti daně musí být přidruženy k aktivní pozici pracovníka.</span><span class="sxs-lookup"><span data-stu-id="4b73f-533">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="4b73f-534">Daňová oblast (povinná)</span><span class="sxs-lookup"><span data-stu-id="4b73f-534">Tax region (required)</span></span>
- <span data-ttu-id="4b73f-535">Země/oblast (povinné)</span><span class="sxs-lookup"><span data-stu-id="4b73f-535">Country/Region (required)</span></span>
- <span data-ttu-id="4b73f-536">Stát (povinný)</span><span class="sxs-lookup"><span data-stu-id="4b73f-536">State (required)</span></span>
- <span data-ttu-id="4b73f-537">Okres</span><span class="sxs-lookup"><span data-stu-id="4b73f-537">County</span></span> 
- <span data-ttu-id="4b73f-538">Město (povinné)</span><span class="sxs-lookup"><span data-stu-id="4b73f-538">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="4b73f-539">Konfigurace dat pro generování mezd v Mexiku</span><span class="sxs-lookup"><span data-stu-id="4b73f-539">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="4b73f-540">Když generujete mzdu pro zaměstnance v Mexiku, musí být nakonfigurovány následující prvky:</span><span class="sxs-lookup"><span data-stu-id="4b73f-540">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="4b73f-541">Pro pozice jsou požadována oddělení.</span><span class="sxs-lookup"><span data-stu-id="4b73f-541">Departments are required on positions.</span></span>
- <span data-ttu-id="4b73f-542">Nákladová střediska musí být nastavena jako finanční dimenze a musí být prvním prvkem ve výchozím řetězci finanční dimenze.</span><span class="sxs-lookup"><span data-stu-id="4b73f-542">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="4b73f-543">Typ úloh</span><span class="sxs-lookup"><span data-stu-id="4b73f-543">Job types</span></span>

<span data-ttu-id="4b73f-544">Typy prací se používají pro seskupení podobných pozic do kategorií.</span><span class="sxs-lookup"><span data-stu-id="4b73f-544">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="4b73f-545">Typy práce jsou povinné pro zpracování mezd v Mexiku.</span><span class="sxs-lookup"><span data-stu-id="4b73f-545">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="4b73f-546">Příklady typů prací zahrnují plný úvazek a částečný úvazek, nebo plat a hodinovou mzdu.</span><span class="sxs-lookup"><span data-stu-id="4b73f-546">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="4b73f-547">Typy prací jsou mapovány do Dayforce jako typy mezd, které označují, zda je zaměstnanec vyplácen hodinově nebo mzdou.</span><span class="sxs-lookup"><span data-stu-id="4b73f-547">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="4b73f-548">Následující typy práce a popisy jsou povinné.</span><span class="sxs-lookup"><span data-stu-id="4b73f-548">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="4b73f-549">Typ práce</span><span class="sxs-lookup"><span data-stu-id="4b73f-549">Job type</span></span>   | <span data-ttu-id="4b73f-550">popis</span><span class="sxs-lookup"><span data-stu-id="4b73f-550">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="4b73f-551">Hodinově</span><span class="sxs-lookup"><span data-stu-id="4b73f-551">Hourly</span></span>     | <span data-ttu-id="4b73f-552">MX hodinově</span><span class="sxs-lookup"><span data-stu-id="4b73f-552">MX Hourly</span></span>   |
| <span data-ttu-id="4b73f-553">Stálý plat</span><span class="sxs-lookup"><span data-stu-id="4b73f-553">Salaried</span></span>   | <span data-ttu-id="4b73f-554">MX Stálý plat</span><span class="sxs-lookup"><span data-stu-id="4b73f-554">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="4b73f-555">Typy pozic</span><span class="sxs-lookup"><span data-stu-id="4b73f-555">Position types</span></span> 

<span data-ttu-id="4b73f-556">Typy pozic používáte k popisu, zda je pozice na plný úvazek, částečný úvazek nebo jiná.</span><span class="sxs-lookup"><span data-stu-id="4b73f-556">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="4b73f-557">Typy pozic jsou mapovány do Dayforce jako třídy mezd, které označují, zda zaměstnanec pracuje na plný nebo částečný úvazek.</span><span class="sxs-lookup"><span data-stu-id="4b73f-557">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="4b73f-558">Následující typy pozic a popisy jsou povinné.</span><span class="sxs-lookup"><span data-stu-id="4b73f-558">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="4b73f-559">Typ pozice</span><span class="sxs-lookup"><span data-stu-id="4b73f-559">Position type</span></span>   | <span data-ttu-id="4b73f-560">popis</span><span class="sxs-lookup"><span data-stu-id="4b73f-560">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="4b73f-561">Plný úvazek</span><span class="sxs-lookup"><span data-stu-id="4b73f-561">Full-time</span></span>       | <span data-ttu-id="4b73f-562">Zaměstnanec na plný úvazek</span><span class="sxs-lookup"><span data-stu-id="4b73f-562">Full time employee</span></span> |
| <span data-ttu-id="4b73f-563">Částečný úvazek</span><span class="sxs-lookup"><span data-stu-id="4b73f-563">Part-time</span></span>       | <span data-ttu-id="4b73f-564">Zaměstnanec na částečný úvazek</span><span class="sxs-lookup"><span data-stu-id="4b73f-564">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="4b73f-565">Kódy důvodu</span><span class="sxs-lookup"><span data-stu-id="4b73f-565">Reason codes</span></span>

<span data-ttu-id="4b73f-566">Kódy důvodů poskytují informace o stavu zaměstnance.</span><span class="sxs-lookup"><span data-stu-id="4b73f-566">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="4b73f-567">Kódy důvodů jsou mapovány do Dayforce jako důvody stavů, které označují důvod pro změny stavu pozice nebo zaměstnání zaměstnance.</span><span class="sxs-lookup"><span data-stu-id="4b73f-567">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="4b73f-568">Následující kódy důvodů a popisy jsou povinné.</span><span class="sxs-lookup"><span data-stu-id="4b73f-568">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="4b73f-569">Kód důvodu</span><span class="sxs-lookup"><span data-stu-id="4b73f-569">Reason code</span></span>            | <span data-ttu-id="4b73f-570">popis</span><span class="sxs-lookup"><span data-stu-id="4b73f-570">Description</span></span>                    | <span data-ttu-id="4b73f-571">Použitelné scénáře</span><span class="sxs-lookup"><span data-stu-id="4b73f-571">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="4b73f-572">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="4b73f-572">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="4b73f-573">Odchod před první mzdou</span><span class="sxs-lookup"><span data-stu-id="4b73f-573">Departure before first payroll</span></span> | <span data-ttu-id="4b73f-574">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-574">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-575">RESIGNATION</span><span class="sxs-lookup"><span data-stu-id="4b73f-575">RESIGNATION</span></span>            | <span data-ttu-id="4b73f-576">Výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-576">Resignation</span></span>                    | <span data-ttu-id="4b73f-577">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-577">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-578">PENSION</span><span class="sxs-lookup"><span data-stu-id="4b73f-578">PENSION</span></span>                | <span data-ttu-id="4b73f-579">Důchod</span><span class="sxs-lookup"><span data-stu-id="4b73f-579">Pension</span></span>                        | <span data-ttu-id="4b73f-580">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-580">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-581">TERMINATION</span><span class="sxs-lookup"><span data-stu-id="4b73f-581">TERMINATION</span></span>            | <span data-ttu-id="4b73f-582">Ukončení</span><span class="sxs-lookup"><span data-stu-id="4b73f-582">Termination</span></span>                    | <span data-ttu-id="4b73f-583">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-583">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-584">RETIREMENT</span><span class="sxs-lookup"><span data-stu-id="4b73f-584">RETIREMENT</span></span>             | <span data-ttu-id="4b73f-585">Důchod</span><span class="sxs-lookup"><span data-stu-id="4b73f-585">Retirement</span></span>                     | <span data-ttu-id="4b73f-586">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-586">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-587">ABSENTEE</span><span class="sxs-lookup"><span data-stu-id="4b73f-587">ABSENTEE</span></span>               | <span data-ttu-id="4b73f-588">Nepřítomný</span><span class="sxs-lookup"><span data-stu-id="4b73f-588">Absentee</span></span>                       | <span data-ttu-id="4b73f-589">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-589">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-590">JINÝ</span><span class="sxs-lookup"><span data-stu-id="4b73f-590">OTHER</span></span>                  | <span data-ttu-id="4b73f-591">Jiné důvody</span><span class="sxs-lookup"><span data-stu-id="4b73f-591">Other Reasons</span></span>                  | <span data-ttu-id="4b73f-592">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-592">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-593">CLOSURE</span><span class="sxs-lookup"><span data-stu-id="4b73f-593">CLOSURE</span></span>                | <span data-ttu-id="4b73f-594">Obchodní uzávěrka</span><span class="sxs-lookup"><span data-stu-id="4b73f-594">Business Closure</span></span>               | <span data-ttu-id="4b73f-595">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-595">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-596">DEATH</span><span class="sxs-lookup"><span data-stu-id="4b73f-596">DEATH</span></span>                  | <span data-ttu-id="4b73f-597">Úmrtí</span><span class="sxs-lookup"><span data-stu-id="4b73f-597">Death</span></span>                          | <span data-ttu-id="4b73f-598">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-598">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-599">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="4b73f-599">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="4b73f-600">Dovolená</span><span class="sxs-lookup"><span data-stu-id="4b73f-600">Leave of Absence</span></span>               | <span data-ttu-id="4b73f-601">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-601">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-602">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="4b73f-602">CONTRACTEND</span></span>            | <span data-ttu-id="4b73f-603">Konec smlouvy</span><span class="sxs-lookup"><span data-stu-id="4b73f-603">End of Contract</span></span>                | <span data-ttu-id="4b73f-604">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="4b73f-604">Terminate worker</span></span>     |
| <span data-ttu-id="4b73f-605">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="4b73f-605">SALARYCHANGE</span></span>           | <span data-ttu-id="4b73f-606">Změna platu</span><span class="sxs-lookup"><span data-stu-id="4b73f-606">Change of Salary</span></span>               | <span data-ttu-id="4b73f-607">Kompenzace</span><span class="sxs-lookup"><span data-stu-id="4b73f-607">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="4b73f-608">Podmínky zaměstnání</span><span class="sxs-lookup"><span data-stu-id="4b73f-608">Terms of employment</span></span>

<span data-ttu-id="4b73f-609">Podmínky zaměstnání se použijí k vytvoření kategorií podmínek zaměstnání.</span><span class="sxs-lookup"><span data-stu-id="4b73f-609">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="4b73f-610">Podmínky jsou mapovány na Dayforce jako hodnoty indikátoru zaměstnání.</span><span class="sxs-lookup"><span data-stu-id="4b73f-610">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="4b73f-611">Následující podmínky zaměstnání a popisy jsou povinné.</span><span class="sxs-lookup"><span data-stu-id="4b73f-611">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="4b73f-612">Podmínky zaměstnání</span><span class="sxs-lookup"><span data-stu-id="4b73f-612">Terms of employment</span></span>   | <span data-ttu-id="4b73f-613">popis</span><span class="sxs-lookup"><span data-stu-id="4b73f-613">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="4b73f-614">Řádné</span><span class="sxs-lookup"><span data-stu-id="4b73f-614">Regular</span></span>               | <span data-ttu-id="4b73f-615">Řádné</span><span class="sxs-lookup"><span data-stu-id="4b73f-615">Regular</span></span>     |
| <span data-ttu-id="4b73f-616">Přímo</span><span class="sxs-lookup"><span data-stu-id="4b73f-616">Direct</span></span>                | <span data-ttu-id="4b73f-617">Přímo</span><span class="sxs-lookup"><span data-stu-id="4b73f-617">Direct</span></span>      |
| <span data-ttu-id="4b73f-618">Stáž</span><span class="sxs-lookup"><span data-stu-id="4b73f-618">Internship</span></span>            | <span data-ttu-id="4b73f-619">Stáž</span><span class="sxs-lookup"><span data-stu-id="4b73f-619">Internship</span></span>  |
| <span data-ttu-id="4b73f-620">Trvalé</span><span class="sxs-lookup"><span data-stu-id="4b73f-620">Permanent</span></span>             | <span data-ttu-id="4b73f-621">Trvalé</span><span class="sxs-lookup"><span data-stu-id="4b73f-621">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="4b73f-622">Rodinný stav</span><span class="sxs-lookup"><span data-stu-id="4b73f-622">Marital status</span></span>

<span data-ttu-id="4b73f-623">Hodnoty rodinného stavu jsou mapovány do Dayforce a překládány podle potřeby na přijaté hodnoty při integraci.</span><span class="sxs-lookup"><span data-stu-id="4b73f-623">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="4b73f-624">Následující tabulka zobrazuje, jak jsou hodnoty rodinného stavu mapovány do Dayforce.</span><span class="sxs-lookup"><span data-stu-id="4b73f-624">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="4b73f-625">Lidské zdroje</span><span class="sxs-lookup"><span data-stu-id="4b73f-625">Human Resources</span></span>                 | <span data-ttu-id="4b73f-626">Dayforce</span><span class="sxs-lookup"><span data-stu-id="4b73f-626">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="4b73f-627">Ženatý/vdaná</span><span class="sxs-lookup"><span data-stu-id="4b73f-627">Married</span></span>                | <span data-ttu-id="4b73f-628">Ženatý/vdaná</span><span class="sxs-lookup"><span data-stu-id="4b73f-628">Married</span></span>                   |
| <span data-ttu-id="4b73f-629">Jednotlivé</span><span class="sxs-lookup"><span data-stu-id="4b73f-629">Single</span></span>                 | <span data-ttu-id="4b73f-630">Jednotlivé</span><span class="sxs-lookup"><span data-stu-id="4b73f-630">Single</span></span>                    |
| <span data-ttu-id="4b73f-631">Vdovec/vdova</span><span class="sxs-lookup"><span data-stu-id="4b73f-631">Widowed</span></span>                | <span data-ttu-id="4b73f-632">Vdovec/vdova</span><span class="sxs-lookup"><span data-stu-id="4b73f-632">Widowed</span></span>                   |
| <span data-ttu-id="4b73f-633">Rozvedený/rozvedená</span><span class="sxs-lookup"><span data-stu-id="4b73f-633">Divorced</span></span>               | <span data-ttu-id="4b73f-634">Rozvedený/rozvedená</span><span class="sxs-lookup"><span data-stu-id="4b73f-634">Divorced</span></span>                  |
| <span data-ttu-id="4b73f-635">Registrované partnerství</span><span class="sxs-lookup"><span data-stu-id="4b73f-635">Registered Partnership</span></span> | <span data-ttu-id="4b73f-636">Domácí partnerství</span><span class="sxs-lookup"><span data-stu-id="4b73f-636">Domestic Partnership</span></span>      |
| <span data-ttu-id="4b73f-637">None</span><span class="sxs-lookup"><span data-stu-id="4b73f-637">None</span></span>                   | <span data-ttu-id="4b73f-638">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="4b73f-638">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="4b73f-639">Společná domácnost</span><span class="sxs-lookup"><span data-stu-id="4b73f-639">Cohabiting</span></span>             | <span data-ttu-id="4b73f-640">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="4b73f-640">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="4b73f-641">Rod</span><span class="sxs-lookup"><span data-stu-id="4b73f-641">Gender</span></span>

<span data-ttu-id="4b73f-642">Označení pohlaví jsou mapována do Dayforce a překládána podle potřeby na přijaté hodnoty při integraci.</span><span class="sxs-lookup"><span data-stu-id="4b73f-642">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="4b73f-643">Následující tabulka zobrazuje, jak jsou označení pohlaví mapována do Dayforce.</span><span class="sxs-lookup"><span data-stu-id="4b73f-643">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="4b73f-644">Lidské zdroje</span><span class="sxs-lookup"><span data-stu-id="4b73f-644">Human Resources</span></span>       | <span data-ttu-id="4b73f-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="4b73f-645">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="4b73f-646">Muž</span><span class="sxs-lookup"><span data-stu-id="4b73f-646">Male</span></span>         | <span data-ttu-id="4b73f-647">Muž</span><span class="sxs-lookup"><span data-stu-id="4b73f-647">Male</span></span>                      |
| <span data-ttu-id="4b73f-648">Žena</span><span class="sxs-lookup"><span data-stu-id="4b73f-648">Female</span></span>       | <span data-ttu-id="4b73f-649">Žena</span><span class="sxs-lookup"><span data-stu-id="4b73f-649">Female</span></span>                    |
| <span data-ttu-id="4b73f-650">Nespecifické</span><span class="sxs-lookup"><span data-stu-id="4b73f-650">Non-specific</span></span> | <span data-ttu-id="4b73f-651">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="4b73f-651">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="4b73f-652">Způsob platby</span><span class="sxs-lookup"><span data-stu-id="4b73f-652">Payment method</span></span>

<span data-ttu-id="4b73f-653">Způsoby platby poskytuje zaměstnanci a společnosti způsob, jak bude vyplácen zaměstnanec.</span><span class="sxs-lookup"><span data-stu-id="4b73f-653">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="4b73f-654">Metody platby jsou mapovány do Dayforce a překládány podle potřeby na přijaté hodnoty při integraci.</span><span class="sxs-lookup"><span data-stu-id="4b73f-654">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="4b73f-655">Následující tabulka zobrazuje, jak jsou metody platby mapována do Dayforce.</span><span class="sxs-lookup"><span data-stu-id="4b73f-655">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="4b73f-656">Lidské zdroje</span><span class="sxs-lookup"><span data-stu-id="4b73f-656">Human Resources</span></span>             | <span data-ttu-id="4b73f-657">Dayforce</span><span class="sxs-lookup"><span data-stu-id="4b73f-657">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="4b73f-658">Hotovost</span><span class="sxs-lookup"><span data-stu-id="4b73f-658">Cash</span></span>               | <span data-ttu-id="4b73f-659">Hotovost</span><span class="sxs-lookup"><span data-stu-id="4b73f-659">Cash</span></span>                      |
| <span data-ttu-id="4b73f-660">Elektronická platba</span><span class="sxs-lookup"><span data-stu-id="4b73f-660">Electronic Payment</span></span> | <span data-ttu-id="4b73f-661">Převod</span><span class="sxs-lookup"><span data-stu-id="4b73f-661">Transfer</span></span>                  |
| <span data-ttu-id="4b73f-662">Kontrola</span><span class="sxs-lookup"><span data-stu-id="4b73f-662">Check</span></span>              | <span data-ttu-id="4b73f-663">Šek</span><span class="sxs-lookup"><span data-stu-id="4b73f-663">Cheque</span></span>                    |
| <span data-ttu-id="4b73f-664">Bankovní směnka</span><span class="sxs-lookup"><span data-stu-id="4b73f-664">Bank Draft</span></span>         | <span data-ttu-id="4b73f-665">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="4b73f-665">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="4b73f-666">Další</span><span class="sxs-lookup"><span data-stu-id="4b73f-666">Other</span></span>              | <span data-ttu-id="4b73f-667">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="4b73f-667">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="4b73f-668">Typ bankovního účtu</span><span class="sxs-lookup"><span data-stu-id="4b73f-668">Bank account type</span></span>

<span data-ttu-id="4b73f-669">Typy bankovního účtu se používají pro elektronické platby zaměstnancům.</span><span class="sxs-lookup"><span data-stu-id="4b73f-669">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="4b73f-670">Typy bankovního účtu jsou mapovány do Dayforce jako informace o převodním účtu.</span><span class="sxs-lookup"><span data-stu-id="4b73f-670">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="4b73f-671">Typy bankovního účtu jsou překládány podle potřeby na přijaté hodnoty při integraci.</span><span class="sxs-lookup"><span data-stu-id="4b73f-671">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="4b73f-672">Lidské zdroje</span><span class="sxs-lookup"><span data-stu-id="4b73f-672">Human Resources</span></span>            | <span data-ttu-id="4b73f-673">Dayforce</span><span class="sxs-lookup"><span data-stu-id="4b73f-673">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="4b73f-674">Běžný účet</span><span class="sxs-lookup"><span data-stu-id="4b73f-674">Checking Account</span></span>  | <span data-ttu-id="4b73f-675">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="4b73f-675">CheckingAccount</span></span>           |
| <span data-ttu-id="4b73f-676">Mzdový účet</span><span class="sxs-lookup"><span data-stu-id="4b73f-676">Payroll Account</span></span>   | <span data-ttu-id="4b73f-677">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="4b73f-677">PayrollAccount</span></span>            |
| <span data-ttu-id="4b73f-678">Spořicí účet</span><span class="sxs-lookup"><span data-stu-id="4b73f-678">Savings Account</span></span>   | <span data-ttu-id="4b73f-679">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="4b73f-679">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="4b73f-680">BankGirot účet</span><span class="sxs-lookup"><span data-stu-id="4b73f-680">BankGirot account</span></span> | <span data-ttu-id="4b73f-681">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="4b73f-681">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="4b73f-682">PlusGirot účet</span><span class="sxs-lookup"><span data-stu-id="4b73f-682">PlusGirot account</span></span> | <span data-ttu-id="4b73f-683">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="4b73f-683">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="4b73f-684">Kódy příjmů</span><span class="sxs-lookup"><span data-stu-id="4b73f-684">Earning codes</span></span>

<span data-ttu-id="4b73f-685">Kódy příjmů jedinečným způsobem identifikují každý typ příjmu, který zaměstnanci dostávají.</span><span class="sxs-lookup"><span data-stu-id="4b73f-685">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="4b73f-686">Kódy pokrývají několik parametrů, které souvisejí s příjmy, například účetní pravidla, daňové předpisy, požadavky na vykazování a funkci hrubé mzdy.</span><span class="sxs-lookup"><span data-stu-id="4b73f-686">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="4b73f-687">Pokud použijete nepodporovaný interval, interval **Každá mzda** se použije jako výchozí pro výpočet.</span><span class="sxs-lookup"><span data-stu-id="4b73f-687">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="4b73f-688">Podporované intervaly</span><span class="sxs-lookup"><span data-stu-id="4b73f-688">Supported frequencies</span></span>

- <span data-ttu-id="4b73f-689">Všechna</span><span class="sxs-lookup"><span data-stu-id="4b73f-689">All</span></span>
- <span data-ttu-id="4b73f-690">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="4b73f-690">EVERYPAY</span></span>
- <span data-ttu-id="4b73f-691">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="4b73f-691">EACHPAYPERIOD</span></span>
- <span data-ttu-id="4b73f-692">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="4b73f-692">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="4b73f-693">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="4b73f-693">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="4b73f-694">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-694">1OFMTH</span></span>
- <span data-ttu-id="4b73f-695">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-695">LASTOFMTH</span></span>
- <span data-ttu-id="4b73f-696">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-696">2OFMTH</span></span>
- <span data-ttu-id="4b73f-697">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-697">3OFMTH</span></span>
- <span data-ttu-id="4b73f-698">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-698">4OFMTH</span></span>
- <span data-ttu-id="4b73f-699">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-699">5OFMTH</span></span>
- <span data-ttu-id="4b73f-700">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-700">1N2OFMTH</span></span>
- <span data-ttu-id="4b73f-701">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-701">3N4OFMTH</span></span>
- <span data-ttu-id="4b73f-702">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-702">1N3OFMTH</span></span>
- <span data-ttu-id="4b73f-703">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-703">1N4OFMTH</span></span>
- <span data-ttu-id="4b73f-704">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-704">2N3OFMTH</span></span>
- <span data-ttu-id="4b73f-705">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-705">2N4OFMTH</span></span>
- <span data-ttu-id="4b73f-706">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-706">1N2N3OFMTH</span></span>
- <span data-ttu-id="4b73f-707">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-707">1N2N4OFMTH</span></span>
- <span data-ttu-id="4b73f-708">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-708">1N3N4OFMTH</span></span>
- <span data-ttu-id="4b73f-709">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-709">2N3N4OFMTH</span></span>
- <span data-ttu-id="4b73f-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="4b73f-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="4b73f-711">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="4b73f-711">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="4b73f-712">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="4b73f-712">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="4b73f-713">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="4b73f-713">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="4b73f-714">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="4b73f-714">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="4b73f-715">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="4b73f-715">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="4b73f-716">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="4b73f-716">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="4b73f-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="4b73f-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="4b73f-718">Adresy</span><span class="sxs-lookup"><span data-stu-id="4b73f-718">Addresses</span></span>

<span data-ttu-id="4b73f-719">Identifikace konkrétních kódů země nebo oblasti, státu a okresu vyžaduje konkrétní formáty, které Dayforce a místní poskytovatelé mohou rozpoznat.</span><span class="sxs-lookup"><span data-stu-id="4b73f-719">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="4b73f-720">Ačkoliv je formát pro města flexibilní, je nutné přiřadit ke každému městu stát.</span><span class="sxs-lookup"><span data-stu-id="4b73f-720">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="4b73f-721">Lidské zdroje</span><span class="sxs-lookup"><span data-stu-id="4b73f-721">Human Resources</span></span>              | <span data-ttu-id="4b73f-722">Dayforce</span><span class="sxs-lookup"><span data-stu-id="4b73f-722">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="4b73f-723">Země/region</span><span class="sxs-lookup"><span data-stu-id="4b73f-723">Country/Region</span></span>      | <span data-ttu-id="4b73f-724">Kód země</span><span class="sxs-lookup"><span data-stu-id="4b73f-724">Country Code</span></span>          |
| <span data-ttu-id="4b73f-725">PSČ</span><span class="sxs-lookup"><span data-stu-id="4b73f-725">Zip/Postal Code</span></span>     | <span data-ttu-id="4b73f-726">PSČ</span><span class="sxs-lookup"><span data-stu-id="4b73f-726">Postal Code</span></span>           |
| <span data-ttu-id="4b73f-727">Kraj</span><span class="sxs-lookup"><span data-stu-id="4b73f-727">State</span></span>               | <span data-ttu-id="4b73f-728">Kód státu</span><span class="sxs-lookup"><span data-stu-id="4b73f-728">State Code</span></span>            |
| <span data-ttu-id="4b73f-729">Město</span><span class="sxs-lookup"><span data-stu-id="4b73f-729">City</span></span>                | <span data-ttu-id="4b73f-730">Město</span><span class="sxs-lookup"><span data-stu-id="4b73f-730">City</span></span>                  |
| <span data-ttu-id="4b73f-731">Okres</span><span class="sxs-lookup"><span data-stu-id="4b73f-731">County</span></span>              | <span data-ttu-id="4b73f-732">Okres</span><span class="sxs-lookup"><span data-stu-id="4b73f-732">County (Municipality)</span></span> |
| <span data-ttu-id="4b73f-733">Ulice</span><span class="sxs-lookup"><span data-stu-id="4b73f-733">Street</span></span>              | <span data-ttu-id="4b73f-734">Řádek adresy 1</span><span class="sxs-lookup"><span data-stu-id="4b73f-734">Address Line 1</span></span>        |
| <span data-ttu-id="4b73f-735">Číslo popisné</span><span class="sxs-lookup"><span data-stu-id="4b73f-735">Street Number</span></span>       | <span data-ttu-id="4b73f-736">Řádek adresy 2</span><span class="sxs-lookup"><span data-stu-id="4b73f-736">Address Line 2</span></span>        |
| <span data-ttu-id="4b73f-737">Doplňující název budovy</span><span class="sxs-lookup"><span data-stu-id="4b73f-737">Building Complement</span></span> | <span data-ttu-id="4b73f-738">Řádek adresy 5</span><span class="sxs-lookup"><span data-stu-id="4b73f-738">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="4b73f-739">Číslo cestovního pasu</span><span class="sxs-lookup"><span data-stu-id="4b73f-739">Passport number</span></span>

<span data-ttu-id="4b73f-740">Zaměstnanci mohou deklarovat informace o cestovním pasu.</span><span class="sxs-lookup"><span data-stu-id="4b73f-740">Employees can declare passport information.</span></span> <span data-ttu-id="4b73f-741">Tato informace je typu identifikace **Pas** a je integrována do Dayforce jako součást informací o zaměstnanci specifických pro Mexiko.</span><span class="sxs-lookup"><span data-stu-id="4b73f-741">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="4b73f-742">Typ identifikace = Pas</span><span class="sxs-lookup"><span data-stu-id="4b73f-742">Identification Type = "Passport"</span></span>
- <span data-ttu-id="4b73f-743">Datum vydání</span><span class="sxs-lookup"><span data-stu-id="4b73f-743">Issued Date</span></span>
- <span data-ttu-id="4b73f-744">Datum vypršení platnosti</span><span class="sxs-lookup"><span data-stu-id="4b73f-744">Expiration Date</span></span>

<span data-ttu-id="4b73f-745">Zaměstnanec může deklarovat více identifikačních čísel typu identifikace **Pas**.</span><span class="sxs-lookup"><span data-stu-id="4b73f-745">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="4b73f-746">Do aplikace Dayforce se integruje pouze zadání aktuálního aktivního pasu.</span><span class="sxs-lookup"><span data-stu-id="4b73f-746">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="4b73f-747">Po uplynutí platnosti všech zadání pasu se integruje do Dayforce ten, který byl naposledy vydán.</span><span class="sxs-lookup"><span data-stu-id="4b73f-747">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
