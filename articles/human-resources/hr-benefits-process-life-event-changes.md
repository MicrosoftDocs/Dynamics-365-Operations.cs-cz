...
description: Tento článek vysvětluje, jak zpracovat změny životní události v Microsoft Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
...
- Změny narozenin
- Změny platnosti přepisu pravidla nároku 

1. V pracovním prostoru **Správa výhod** vyberte v části **Zpracování** možnost **Zpracování změny životní události**.

2. V dialogovém okně **Spustit proces změny životní události** zadejte hodnoty pro následující pole:

   | Pole | Popis |
   | --- | --- |
   | Období registrace | Období registrace pro zpracování změn životní události. |
   | Právnická osoba | Právnická osoba pro zpracování změn životní události. |
