...
ms.locfileid: "4417644"
---
# <a name="configure-waiting-periods"></a>Konfigurace období čekání

Dny čekání v aplikaci Microsoft Dynamics 365 Human Resources představují milník, který se používá pro plány zaměstnaneckých výhod. Například tři měsíce od data přijetí, první den v měsíci nebo šest měsíců.   

1. V pracovním prostoru **Správa výhod** vyberte v části **Nastavení** možnost **Období čekání**.
