...
4. V **Centru stavu řešení** vyberte ikonu **Rozšířené hledání** v pravém horním rohu stránky.

5. Na stránce **Rozšířené hledání** vyberte v rozevíracím seznamu **Hledat** položku **Dostupné entity HR** .

6. Nastavením možností filtru vyhledejte entitu nebo entity, které chcete povolit.

7. Ze seznamu vyberte entitu.

8. Na stránce entity změňte vlastnost **Bylo vygenerováno** na **Ano** pro tuto entitu.

9. Uložte a zavřete stránku entity.

> [!NOTE]
> Můžete vygenerovat více virtuálních entit najednou pomocí stránky **Změnit více záznamů** . Vyberte více záznamů na stránce a pak **Upravit** na pásu karet. Poté můžete změnit vlastnost **Bylo vygenerováno** pro všechny vybrané záznamy.

![Dostupné entity HR](./media/hr-admin-integration-virtual-entities-available.jpg)

> [!NOTE]
> K zefektivnění procesu generování virtuálních entit v budoucích verzích bude proces probíhat na stránce v Human Resources.
