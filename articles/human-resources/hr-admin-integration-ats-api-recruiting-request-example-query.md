...
description: Tento článek poskytuje ukázkový dotaz pro entitu Žádost na nábor v Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
Tento článek poskytuje ukázkový dotaz pro entitu Žádost na nábor v Dynamics 365 Human Resources.

Následující dotaz ukazuje, jak můžete pomocí možnosti $rozbalit dotaz v operaci GET načíst zadaný záznam požadavku na nábor a všechny přidružené pozice, požadované dovednosti a vzdělávací požadavky pro zadaný požadavek. Příklad odpovědi ukazuje požadavek na nábor na dvě pozice a požadované dovednosti a vzdělání pro požadované pozice.
