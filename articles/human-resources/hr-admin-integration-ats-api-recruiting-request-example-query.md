...
---
# <a name="example-query-for-recruiting-request"></a><span data-ttu-id="945dd-103">Příklad dotazu na žádost o nábor</span><span class="sxs-lookup"><span data-stu-id="945dd-103">Example query for Recruiting request</span></span>

<span data-ttu-id="945dd-104">Toto téma poskytuje ukázkový dotaz pro entitu Žádost na nábor v Dynamics 365 Human Resources.</span><span class="sxs-lookup"><span data-stu-id="945dd-104">This topic provides an example query for the Recruiting request entity in Dynamics 365 Human Resources.</span></span>

<span data-ttu-id="945dd-105">Následující dotaz ukazuje, jak můžete pomocí možnosti $rozbalit dotaz v operaci GET načíst zadaný záznam požadavku na nábor a všechny přidružené pozice, požadované dovednosti a vzdělávací požadavky pro zadaný požadavek.</span><span class="sxs-lookup"><span data-stu-id="945dd-105">The following query shows how you can use the $expand query option in a GET operation to retrieve a specified recruiting request record and all associated positions, required skills, and educational requirements for the specified request.</span></span> <span data-ttu-id="945dd-106">Příklad odpovědi ukazuje požadavek na nábor na dvě pozice a požadované dovednosti a vzdělání pro požadované pozice.</span><span class="sxs-lookup"><span data-stu-id="945dd-106">The example response shows a recruiting request for two positions, and the required skills and education for the requested positions.</span></span>

<span data-ttu-id="945dd-107">**Žádost**</span><span class="sxs-lookup"><span data-stu-id="945dd-107">**Request**</span></span>
...
<span data-ttu-id="945dd-108">**Odezva**</span><span class="sxs-lookup"><span data-stu-id="945dd-108">**Response**</span></span>
...
## <a name="see-also"></a><span data-ttu-id="945dd-109">Viz také</span><span class="sxs-lookup"><span data-stu-id="945dd-109">See also</span></span>

[<span data-ttu-id="945dd-110">Úvod do rozhraní API pro integraci systému sledování žadatelů</span><span class="sxs-lookup"><span data-stu-id="945dd-110">Applicant Tracking System integration API introduction</span></span>](hr-admin-integration-ats-api-introduction.md)<br>