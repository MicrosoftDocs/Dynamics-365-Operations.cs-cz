...
ms.locfileid: "3092076"
---
# <a name="welcome-to-dynamics-365-human-resources"></a>Vítejte ve společnosti Dynamics 365 Human Resources

Dynamics 365 Human Resources poskytuje přehled o pracovních plochách, které potřebujete k vytváření pracovního prostředí zaměstnanců podle více oblastí, včetně následujících:
...
[Řešení problémů s Human Resources](hr-admin-troubleshooting-support.md)</br>
...
[Entity aplikace Human Resources v Common Data Service](hr-developer-entities.md)</br>
[Vlastní pole](hr-developer-custom-fields.md)</br>
[Nastavení integrace dat](hr-admin-integration-choose-technology.md)</br>
[Odkaz na API rozhraní entity](hr-developer-api-authentication.md)
