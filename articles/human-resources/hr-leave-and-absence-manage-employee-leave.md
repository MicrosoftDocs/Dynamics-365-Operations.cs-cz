...
## <a name="adjust-leave-balances"></a>Úprava zůstatků dovolené

1. V záznamu zaměstnance vyberte možnost **Pracovní volno**.

2. Vyberte **Nastavení dovolené a absence**.

3. Vyberte **Upravit zůstatek**.

4. Vyberte **typ dovolené**.

5. Zadejte **velikost úpravy**. 
