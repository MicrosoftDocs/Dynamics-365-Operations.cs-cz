...
ms.locfileid: "2974469"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-january-14-2020"></a>Co je nového nebo změněného v aplikaci Dynamics 365 Talent (14. ledna 2020)
...
Změny popsané v této části se vztahují na číslo sestavení 8.1.2709. Čísla v závorkách v některých záhlavích se vztahují na čísla podpory v Microsoft Dynamics Lifecycle Services (LCS).

### <a name="system-unable-to-generate-calendar-days-when-importing-through-data-management-framework-381195"></a>Systém nemůže vygenerovat kalendářní dny při importu prostřednictvím architektury pro správu dat (381195).

Tato změna opravuje problém, kdy import kalendářních dní vygeneruje **neplatný formát data**. Tato chyba zabrání vytvoření řádků pracovního kalendáře s datem.
