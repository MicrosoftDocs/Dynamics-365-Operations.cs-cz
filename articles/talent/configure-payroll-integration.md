...
- <span data-ttu-id="ded17-110">Data lidských zdrojů</span><span class="sxs-lookup"><span data-stu-id="ded17-110">Human resources data</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="ded17-140">Konfigurace vašich dat</span><span class="sxs-lookup"><span data-stu-id="ded17-140">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="ded17-157">Zam. výhody</span><span class="sxs-lookup"><span data-stu-id="ded17-157">Benefits</span></span>
...
<span data-ttu-id="ded17-186">Další informace o tom, jak definovat a spravovat program zaměstnaneckých výhod naleznete v následujících tématech:</span><span class="sxs-lookup"><span data-stu-id="ded17-186">For more information about how to define and manage a benefits program, see the following topics:</span></span>
...
- <span data-ttu-id="ded17-225">Platební cyklus (povinný)</span><span class="sxs-lookup"><span data-stu-id="ded17-225">Pay cycle (required)</span></span>
...
#### <a name="pay-cycles-and-pay-periods"></a><span data-ttu-id="ded17-240">Platební cykly a platební období</span><span class="sxs-lookup"><span data-stu-id="ded17-240">Pay cycles and pay periods</span></span>
...
#### <a name="earning-codes"></a><span data-ttu-id="ded17-256">Kódy příjmů</span><span class="sxs-lookup"><span data-stu-id="ded17-256">Earning codes</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="ded17-295">Kontaktní informace</span><span class="sxs-lookup"><span data-stu-id="ded17-295">Contact information</span></span> 
...
- <span data-ttu-id="ded17-357">Primární (povinné)</span><span class="sxs-lookup"><span data-stu-id="ded17-357">Primary (required)</span></span>
...
- <span data-ttu-id="ded17-379">Primární (povinné)</span><span class="sxs-lookup"><span data-stu-id="ded17-379">Primary (required)</span></span>
...
<span data-ttu-id="ded17-420">Následující kódy důvodů a popisy jsou povinné.</span><span class="sxs-lookup"><span data-stu-id="ded17-420">The following reason codes and descriptions are required.</span></span>
...
| <span data-ttu-id="ded17-459">Rozvedený/rozvedená</span><span class="sxs-lookup"><span data-stu-id="ded17-459">Divorced</span></span>               | <span data-ttu-id="ded17-460">Rozvedený/rozvedená</span><span class="sxs-lookup"><span data-stu-id="ded17-460">Divorced</span></span>             |
...
- <span data-ttu-id="ded17-491">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-491">3OFMTH</span></span>
...
| <span data-ttu-id="ded17-515">Talent</span><span class="sxs-lookup"><span data-stu-id="ded17-515">Talent</span></span>          | <span data-ttu-id="ded17-516">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ded17-516">Dayforce</span></span>              |
|-----------------|-----------------------|
...
| <span data-ttu-id="ded17-525">Okres</span><span class="sxs-lookup"><span data-stu-id="ded17-525">County</span></span>          | <span data-ttu-id="ded17-526">Okres</span><span class="sxs-lookup"><span data-stu-id="ded17-526">County (Municipality)</span></span> |
| <span data-ttu-id="ded17-527">Ulice</span><span class="sxs-lookup"><span data-stu-id="ded17-527">Street</span></span>          | <span data-ttu-id="ded17-528">Řádek adresy 1</span><span class="sxs-lookup"><span data-stu-id="ded17-528">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="ded17-529">Daňové oblasti</span><span class="sxs-lookup"><span data-stu-id="ded17-529">Tax regions</span></span>

<span data-ttu-id="ded17-530">Oblasti daně se používají pro určení příslušné daně, která se má použít během generování mzdy.</span><span class="sxs-lookup"><span data-stu-id="ded17-530">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="ded17-531">Daňové oblasti jsou mapovány na Dayforce jako adresy místa.</span><span class="sxs-lookup"><span data-stu-id="ded17-531">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="ded17-532">Výchozí oblasti daně musí být přidruženy k aktivní pozici pracovníka.</span><span class="sxs-lookup"><span data-stu-id="ded17-532">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="ded17-533">Daňová oblast (povinná)</span><span class="sxs-lookup"><span data-stu-id="ded17-533">Tax region (required)</span></span>
- <span data-ttu-id="ded17-534">Země/oblast (povinné)</span><span class="sxs-lookup"><span data-stu-id="ded17-534">Country/Region (required)</span></span>
- <span data-ttu-id="ded17-535">Stát (povinný)</span><span class="sxs-lookup"><span data-stu-id="ded17-535">State (required)</span></span>
- <span data-ttu-id="ded17-536">Okres</span><span class="sxs-lookup"><span data-stu-id="ded17-536">County</span></span> 
- <span data-ttu-id="ded17-537">Město (povinné)</span><span class="sxs-lookup"><span data-stu-id="ded17-537">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="ded17-538">Konfigurace dat pro generování mezd v Mexiku</span><span class="sxs-lookup"><span data-stu-id="ded17-538">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="ded17-539">Když generujete mzdu pro zaměstnance v Mexiku, musí být nakonfigurovány následující prvky:</span><span class="sxs-lookup"><span data-stu-id="ded17-539">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="ded17-540">Pro pozice jsou požadována oddělení.</span><span class="sxs-lookup"><span data-stu-id="ded17-540">Departments are required on positions.</span></span>
- <span data-ttu-id="ded17-541">Nákladová střediska musí být nastavena jako finanční dimenze a musí být prvním prvkem ve výchozím řetězci finanční dimenze.</span><span class="sxs-lookup"><span data-stu-id="ded17-541">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="ded17-542">Typ úloh</span><span class="sxs-lookup"><span data-stu-id="ded17-542">Job types</span></span>

<span data-ttu-id="ded17-543">Typy prací se používají pro seskupení podobných pozic do kategorií.</span><span class="sxs-lookup"><span data-stu-id="ded17-543">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="ded17-544">Typy práce jsou povinné pro zpracování mezd v Mexiku.</span><span class="sxs-lookup"><span data-stu-id="ded17-544">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="ded17-545">Příklady typů prací zahrnují plný úvazek a částečný úvazek, nebo plat a hodinovou mzdu.</span><span class="sxs-lookup"><span data-stu-id="ded17-545">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="ded17-546">Typy prací jsou mapovány do Dayforce jako typy mezd, které označují, zda je zaměstnanec vyplácen hodinově nebo mzdou.</span><span class="sxs-lookup"><span data-stu-id="ded17-546">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="ded17-547">Následující typy práce a popisy jsou povinné.</span><span class="sxs-lookup"><span data-stu-id="ded17-547">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="ded17-548">Typ práce</span><span class="sxs-lookup"><span data-stu-id="ded17-548">Job type</span></span>   | <span data-ttu-id="ded17-549">popis</span><span class="sxs-lookup"><span data-stu-id="ded17-549">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="ded17-550">Hodinově</span><span class="sxs-lookup"><span data-stu-id="ded17-550">Hourly</span></span>     | <span data-ttu-id="ded17-551">MX hodinově</span><span class="sxs-lookup"><span data-stu-id="ded17-551">MX Hourly</span></span>   |
| <span data-ttu-id="ded17-552">Stálý plat</span><span class="sxs-lookup"><span data-stu-id="ded17-552">Salaried</span></span>   | <span data-ttu-id="ded17-553">MX Stálý plat</span><span class="sxs-lookup"><span data-stu-id="ded17-553">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="ded17-554">Typy pozic</span><span class="sxs-lookup"><span data-stu-id="ded17-554">Position types</span></span> 

<span data-ttu-id="ded17-555">Typy pozic používáte k popisu, zda je pozice na plný úvazek, částečný úvazek nebo jiná.</span><span class="sxs-lookup"><span data-stu-id="ded17-555">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="ded17-556">Typy pozic jsou mapovány do Dayforce jako třídy mezd, které označují, zda zaměstnanec pracuje na plný nebo částečný úvazek.</span><span class="sxs-lookup"><span data-stu-id="ded17-556">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="ded17-557">Následující typy pozic a popisy jsou povinné.</span><span class="sxs-lookup"><span data-stu-id="ded17-557">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="ded17-558">Typ pozice</span><span class="sxs-lookup"><span data-stu-id="ded17-558">Position type</span></span>   | <span data-ttu-id="ded17-559">popis</span><span class="sxs-lookup"><span data-stu-id="ded17-559">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="ded17-560">Plný úvazek</span><span class="sxs-lookup"><span data-stu-id="ded17-560">Full-time</span></span>       | <span data-ttu-id="ded17-561">Zaměstnanec na plný úvazek</span><span class="sxs-lookup"><span data-stu-id="ded17-561">Full time employee</span></span> |
| <span data-ttu-id="ded17-562">Částečný úvazek</span><span class="sxs-lookup"><span data-stu-id="ded17-562">Part-time</span></span>       | <span data-ttu-id="ded17-563">Zaměstnanec na částečný úvazek</span><span class="sxs-lookup"><span data-stu-id="ded17-563">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="ded17-564">Kódy důvodu</span><span class="sxs-lookup"><span data-stu-id="ded17-564">Reason codes</span></span>

<span data-ttu-id="ded17-565">Kódy důvodů poskytují informace o stavu zaměstnance.</span><span class="sxs-lookup"><span data-stu-id="ded17-565">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="ded17-566">Kódy důvodů jsou mapovány do Dayforce jako důvody stavů, které označují důvod pro změny stavu pozice nebo zaměstnání zaměstnance.</span><span class="sxs-lookup"><span data-stu-id="ded17-566">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="ded17-567">Následující kódy důvodů a popisy jsou povinné.</span><span class="sxs-lookup"><span data-stu-id="ded17-567">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="ded17-568">Kód důvodu</span><span class="sxs-lookup"><span data-stu-id="ded17-568">Reason code</span></span>            | <span data-ttu-id="ded17-569">popis</span><span class="sxs-lookup"><span data-stu-id="ded17-569">Description</span></span>                    | <span data-ttu-id="ded17-570">Použitelné scénáře</span><span class="sxs-lookup"><span data-stu-id="ded17-570">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="ded17-571">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="ded17-571">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="ded17-572">Odchod před první mzdou</span><span class="sxs-lookup"><span data-stu-id="ded17-572">Departure before first payroll</span></span> | <span data-ttu-id="ded17-573">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-573">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-574">RESIGNATION</span><span class="sxs-lookup"><span data-stu-id="ded17-574">RESIGNATION</span></span>            | <span data-ttu-id="ded17-575">Výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-575">Resignation</span></span>                    | <span data-ttu-id="ded17-576">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-576">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-577">PENSION</span><span class="sxs-lookup"><span data-stu-id="ded17-577">PENSION</span></span>                | <span data-ttu-id="ded17-578">Důchod</span><span class="sxs-lookup"><span data-stu-id="ded17-578">Pension</span></span>                        | <span data-ttu-id="ded17-579">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-579">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-580">TERMINATION</span><span class="sxs-lookup"><span data-stu-id="ded17-580">TERMINATION</span></span>            | <span data-ttu-id="ded17-581">Ukončení</span><span class="sxs-lookup"><span data-stu-id="ded17-581">Termination</span></span>                    | <span data-ttu-id="ded17-582">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-582">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-583">RETIREMENT</span><span class="sxs-lookup"><span data-stu-id="ded17-583">RETIREMENT</span></span>             | <span data-ttu-id="ded17-584">Důchod</span><span class="sxs-lookup"><span data-stu-id="ded17-584">Retirement</span></span>                     | <span data-ttu-id="ded17-585">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-585">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-586">ABSENTEE</span><span class="sxs-lookup"><span data-stu-id="ded17-586">ABSENTEE</span></span>               | <span data-ttu-id="ded17-587">Nepřítomný</span><span class="sxs-lookup"><span data-stu-id="ded17-587">Absentee</span></span>                       | <span data-ttu-id="ded17-588">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-588">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-589">JINÝ</span><span class="sxs-lookup"><span data-stu-id="ded17-589">OTHER</span></span>                  | <span data-ttu-id="ded17-590">Jiné důvody</span><span class="sxs-lookup"><span data-stu-id="ded17-590">Other Reasons</span></span>                  | <span data-ttu-id="ded17-591">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-591">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-592">CLOSURE</span><span class="sxs-lookup"><span data-stu-id="ded17-592">CLOSURE</span></span>                | <span data-ttu-id="ded17-593">Obchodní uzávěrka</span><span class="sxs-lookup"><span data-stu-id="ded17-593">Business Closure</span></span>               | <span data-ttu-id="ded17-594">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-594">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-595">DEATH</span><span class="sxs-lookup"><span data-stu-id="ded17-595">DEATH</span></span>                  | <span data-ttu-id="ded17-596">Úmrtí</span><span class="sxs-lookup"><span data-stu-id="ded17-596">Death</span></span>                          | <span data-ttu-id="ded17-597">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-597">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-598">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="ded17-598">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="ded17-599">Dovolená</span><span class="sxs-lookup"><span data-stu-id="ded17-599">Leave of Absence</span></span>               | <span data-ttu-id="ded17-600">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-600">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-601">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="ded17-601">CONTRACTEND</span></span>            | <span data-ttu-id="ded17-602">Konec smlouvy</span><span class="sxs-lookup"><span data-stu-id="ded17-602">End of Contract</span></span>                | <span data-ttu-id="ded17-603">Dát pracovníkovi výpověď</span><span class="sxs-lookup"><span data-stu-id="ded17-603">Terminate worker</span></span>     |
| <span data-ttu-id="ded17-604">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="ded17-604">SALARYCHANGE</span></span>           | <span data-ttu-id="ded17-605">Změna platu</span><span class="sxs-lookup"><span data-stu-id="ded17-605">Change of Salary</span></span>               | <span data-ttu-id="ded17-606">Kompenzace</span><span class="sxs-lookup"><span data-stu-id="ded17-606">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="ded17-607">Podmínky zaměstnání</span><span class="sxs-lookup"><span data-stu-id="ded17-607">Terms of employment</span></span>

<span data-ttu-id="ded17-608">Podmínky zaměstnání se použijí k vytvoření kategorií podmínek zaměstnání.</span><span class="sxs-lookup"><span data-stu-id="ded17-608">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="ded17-609">Podmínky jsou mapovány na Dayforce jako hodnoty indikátoru zaměstnání.</span><span class="sxs-lookup"><span data-stu-id="ded17-609">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="ded17-610">Následující podmínky zaměstnání a popisy jsou povinné.</span><span class="sxs-lookup"><span data-stu-id="ded17-610">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="ded17-611">Podmínky zaměstnání</span><span class="sxs-lookup"><span data-stu-id="ded17-611">Terms of employment</span></span>   | <span data-ttu-id="ded17-612">popis</span><span class="sxs-lookup"><span data-stu-id="ded17-612">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="ded17-613">Řádné</span><span class="sxs-lookup"><span data-stu-id="ded17-613">Regular</span></span>               | <span data-ttu-id="ded17-614">Řádné</span><span class="sxs-lookup"><span data-stu-id="ded17-614">Regular</span></span>     |
| <span data-ttu-id="ded17-615">Přímo</span><span class="sxs-lookup"><span data-stu-id="ded17-615">Direct</span></span>                | <span data-ttu-id="ded17-616">Přímo</span><span class="sxs-lookup"><span data-stu-id="ded17-616">Direct</span></span>      |
| <span data-ttu-id="ded17-617">Stáž</span><span class="sxs-lookup"><span data-stu-id="ded17-617">Internship</span></span>            | <span data-ttu-id="ded17-618">Stáž</span><span class="sxs-lookup"><span data-stu-id="ded17-618">Internship</span></span>  |
| <span data-ttu-id="ded17-619">Trvalé</span><span class="sxs-lookup"><span data-stu-id="ded17-619">Permanent</span></span>             | <span data-ttu-id="ded17-620">Trvalé</span><span class="sxs-lookup"><span data-stu-id="ded17-620">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="ded17-621">Rodinný stav</span><span class="sxs-lookup"><span data-stu-id="ded17-621">Marital status</span></span>

<span data-ttu-id="ded17-622">Hodnoty rodinného stavu jsou mapovány do Dayforce a překládány podle potřeby na přijaté hodnoty při integraci.</span><span class="sxs-lookup"><span data-stu-id="ded17-622">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="ded17-623">Následující tabulka zobrazuje, jak jsou hodnoty rodinného stavu mapovány do Dayforce.</span><span class="sxs-lookup"><span data-stu-id="ded17-623">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="ded17-624">Talent</span><span class="sxs-lookup"><span data-stu-id="ded17-624">Talent</span></span>                 | <span data-ttu-id="ded17-625">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ded17-625">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="ded17-626">Ženatý/vdaná</span><span class="sxs-lookup"><span data-stu-id="ded17-626">Married</span></span>                | <span data-ttu-id="ded17-627">Ženatý/vdaná</span><span class="sxs-lookup"><span data-stu-id="ded17-627">Married</span></span>                   |
| <span data-ttu-id="ded17-628">Jedno</span><span class="sxs-lookup"><span data-stu-id="ded17-628">Single</span></span>                 | <span data-ttu-id="ded17-629">Jedno</span><span class="sxs-lookup"><span data-stu-id="ded17-629">Single</span></span>                    |
| <span data-ttu-id="ded17-630">Vdovec/vdova</span><span class="sxs-lookup"><span data-stu-id="ded17-630">Widowed</span></span>                | <span data-ttu-id="ded17-631">Vdovec/vdova</span><span class="sxs-lookup"><span data-stu-id="ded17-631">Widowed</span></span>                   |
| <span data-ttu-id="ded17-632">Rozvedený/rozvedená</span><span class="sxs-lookup"><span data-stu-id="ded17-632">Divorced</span></span>               | <span data-ttu-id="ded17-633">Rozvedený/rozvedená</span><span class="sxs-lookup"><span data-stu-id="ded17-633">Divorced</span></span>                  |
| <span data-ttu-id="ded17-634">Registrované partnerství</span><span class="sxs-lookup"><span data-stu-id="ded17-634">Registered Partnership</span></span> | <span data-ttu-id="ded17-635">Domácí partnerství</span><span class="sxs-lookup"><span data-stu-id="ded17-635">Domestic Partnership</span></span>      |
| <span data-ttu-id="ded17-636">None</span><span class="sxs-lookup"><span data-stu-id="ded17-636">None</span></span>                   | <span data-ttu-id="ded17-637">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="ded17-637">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="ded17-638">Společná domácnost</span><span class="sxs-lookup"><span data-stu-id="ded17-638">Cohabiting</span></span>             | <span data-ttu-id="ded17-639">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="ded17-639">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="ded17-640">Rod</span><span class="sxs-lookup"><span data-stu-id="ded17-640">Gender</span></span>

<span data-ttu-id="ded17-641">Označení pohlaví jsou mapována do Dayforce a překládána podle potřeby na přijaté hodnoty při integraci.</span><span class="sxs-lookup"><span data-stu-id="ded17-641">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="ded17-642">Následující tabulka zobrazuje, jak jsou označení pohlaví mapována do Dayforce.</span><span class="sxs-lookup"><span data-stu-id="ded17-642">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="ded17-643">Talent</span><span class="sxs-lookup"><span data-stu-id="ded17-643">Talent</span></span>       | <span data-ttu-id="ded17-644">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ded17-644">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="ded17-645">Muž</span><span class="sxs-lookup"><span data-stu-id="ded17-645">Male</span></span>         | <span data-ttu-id="ded17-646">Muž</span><span class="sxs-lookup"><span data-stu-id="ded17-646">Male</span></span>                      |
| <span data-ttu-id="ded17-647">Žena</span><span class="sxs-lookup"><span data-stu-id="ded17-647">Female</span></span>       | <span data-ttu-id="ded17-648">Žena</span><span class="sxs-lookup"><span data-stu-id="ded17-648">Female</span></span>                    |
| <span data-ttu-id="ded17-649">Nespecifické</span><span class="sxs-lookup"><span data-stu-id="ded17-649">Non-specific</span></span> | <span data-ttu-id="ded17-650">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="ded17-650">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="ded17-651">Způsob platby</span><span class="sxs-lookup"><span data-stu-id="ded17-651">Payment method</span></span>

<span data-ttu-id="ded17-652">Způsoby platby poskytuje zaměstnanci a společnosti způsob, jak bude vyplácen zaměstnanec.</span><span class="sxs-lookup"><span data-stu-id="ded17-652">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="ded17-653">Metody platby jsou mapovány do Dayforce a překládány podle potřeby na přijaté hodnoty při integraci.</span><span class="sxs-lookup"><span data-stu-id="ded17-653">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="ded17-654">Následující tabulka zobrazuje, jak jsou metody platby mapována do Dayforce.</span><span class="sxs-lookup"><span data-stu-id="ded17-654">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="ded17-655">Talent</span><span class="sxs-lookup"><span data-stu-id="ded17-655">Talent</span></span>             | <span data-ttu-id="ded17-656">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ded17-656">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="ded17-657">Hotovost</span><span class="sxs-lookup"><span data-stu-id="ded17-657">Cash</span></span>               | <span data-ttu-id="ded17-658">Hotovost</span><span class="sxs-lookup"><span data-stu-id="ded17-658">Cash</span></span>                      |
| <span data-ttu-id="ded17-659">Elektronická platba</span><span class="sxs-lookup"><span data-stu-id="ded17-659">Electronic Payment</span></span> | <span data-ttu-id="ded17-660">Převod</span><span class="sxs-lookup"><span data-stu-id="ded17-660">Transfer</span></span>                  |
| <span data-ttu-id="ded17-661">Kontrola</span><span class="sxs-lookup"><span data-stu-id="ded17-661">Check</span></span>              | <span data-ttu-id="ded17-662">Šek</span><span class="sxs-lookup"><span data-stu-id="ded17-662">Cheque</span></span>                    |
| <span data-ttu-id="ded17-663">Bankovní směnka</span><span class="sxs-lookup"><span data-stu-id="ded17-663">Bank Draft</span></span>         | <span data-ttu-id="ded17-664">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="ded17-664">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="ded17-665">Další</span><span class="sxs-lookup"><span data-stu-id="ded17-665">Other</span></span>              | <span data-ttu-id="ded17-666">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="ded17-666">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="ded17-667">Typ bankovního účtu</span><span class="sxs-lookup"><span data-stu-id="ded17-667">Bank account type</span></span>

<span data-ttu-id="ded17-668">Typy bankovního účtu se používají pro elektronické platby zaměstnancům.</span><span class="sxs-lookup"><span data-stu-id="ded17-668">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="ded17-669">Typy bankovního účtu jsou mapovány do Dayforce jako informace o převodním účtu.</span><span class="sxs-lookup"><span data-stu-id="ded17-669">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="ded17-670">Typy bankovního účtu jsou překládány podle potřeby na přijaté hodnoty při integraci.</span><span class="sxs-lookup"><span data-stu-id="ded17-670">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="ded17-671">Talent</span><span class="sxs-lookup"><span data-stu-id="ded17-671">Talent</span></span>            | <span data-ttu-id="ded17-672">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ded17-672">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="ded17-673">Běžný účet</span><span class="sxs-lookup"><span data-stu-id="ded17-673">Checking Account</span></span>  | <span data-ttu-id="ded17-674">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="ded17-674">CheckingAccount</span></span>           |
| <span data-ttu-id="ded17-675">Mzdový účet</span><span class="sxs-lookup"><span data-stu-id="ded17-675">Payroll Account</span></span>   | <span data-ttu-id="ded17-676">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="ded17-676">PayrollAccount</span></span>            |
| <span data-ttu-id="ded17-677">Spořicí účet</span><span class="sxs-lookup"><span data-stu-id="ded17-677">Savings Account</span></span>   | <span data-ttu-id="ded17-678">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="ded17-678">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="ded17-679">BankGirot účet</span><span class="sxs-lookup"><span data-stu-id="ded17-679">BankGirot account</span></span> | <span data-ttu-id="ded17-680">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="ded17-680">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="ded17-681">PlusGirot účet</span><span class="sxs-lookup"><span data-stu-id="ded17-681">PlusGirot account</span></span> | <span data-ttu-id="ded17-682">*Nepodporováno v Mexiku*</span><span class="sxs-lookup"><span data-stu-id="ded17-682">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="ded17-683">Kódy příjmů</span><span class="sxs-lookup"><span data-stu-id="ded17-683">Earning codes</span></span>

<span data-ttu-id="ded17-684">Kódy příjmů jedinečným způsobem identifikují každý typ příjmu, který zaměstnanci dostávají.</span><span class="sxs-lookup"><span data-stu-id="ded17-684">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="ded17-685">Kódy pokrývají několik parametrů, které souvisejí s příjmy, například účetní pravidla, daňové předpisy, požadavky na vykazování a funkci hrubé mzdy.</span><span class="sxs-lookup"><span data-stu-id="ded17-685">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="ded17-686">Pokud použijete nepodporovaný interval, interval **Každá mzda** se použije jako výchozí pro výpočet.</span><span class="sxs-lookup"><span data-stu-id="ded17-686">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="ded17-687">Podporované intervaly</span><span class="sxs-lookup"><span data-stu-id="ded17-687">Supported frequencies</span></span>

- <span data-ttu-id="ded17-688">Všechna</span><span class="sxs-lookup"><span data-stu-id="ded17-688">All</span></span>
- <span data-ttu-id="ded17-689">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="ded17-689">EVERYPAY</span></span>
- <span data-ttu-id="ded17-690">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="ded17-690">EACHPAYPERIOD</span></span>
- <span data-ttu-id="ded17-691">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="ded17-691">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="ded17-692">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="ded17-692">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="ded17-693">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-693">1OFMTH</span></span>
- <span data-ttu-id="ded17-694">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-694">LASTOFMTH</span></span>
- <span data-ttu-id="ded17-695">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-695">2OFMTH</span></span>
- <span data-ttu-id="ded17-696">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-696">3OFMTH</span></span>
- <span data-ttu-id="ded17-697">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-697">4OFMTH</span></span>
- <span data-ttu-id="ded17-698">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-698">5OFMTH</span></span>
- <span data-ttu-id="ded17-699">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-699">1N2OFMTH</span></span>
- <span data-ttu-id="ded17-700">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-700">3N4OFMTH</span></span>
- <span data-ttu-id="ded17-701">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-701">1N3OFMTH</span></span>
- <span data-ttu-id="ded17-702">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-702">1N4OFMTH</span></span>
- <span data-ttu-id="ded17-703">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-703">2N3OFMTH</span></span>
- <span data-ttu-id="ded17-704">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-704">2N4OFMTH</span></span>
- <span data-ttu-id="ded17-705">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-705">1N2N3OFMTH</span></span>
- <span data-ttu-id="ded17-706">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-706">1N2N4OFMTH</span></span>
- <span data-ttu-id="ded17-707">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-707">1N3N4OFMTH</span></span>
- <span data-ttu-id="ded17-708">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-708">2N3N4OFMTH</span></span>
- <span data-ttu-id="ded17-709">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ded17-709">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="ded17-710">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="ded17-710">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="ded17-711">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="ded17-711">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="ded17-712">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="ded17-712">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="ded17-713">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="ded17-713">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="ded17-714">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="ded17-714">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="ded17-715">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="ded17-715">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="ded17-716">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="ded17-716">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="ded17-717">Adresy</span><span class="sxs-lookup"><span data-stu-id="ded17-717">Addresses</span></span>

<span data-ttu-id="ded17-718">Identifikace konkrétních kódů země nebo oblasti, státu a okresu vyžaduje konkrétní formáty, které Dayforce a místní poskytovatelé mohou rozpoznat.</span><span class="sxs-lookup"><span data-stu-id="ded17-718">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="ded17-719">Ačkoliv je formát pro města flexibilní, je nutné přiřadit ke každému městu stát.</span><span class="sxs-lookup"><span data-stu-id="ded17-719">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="ded17-720">Talent</span><span class="sxs-lookup"><span data-stu-id="ded17-720">Talent</span></span>              | <span data-ttu-id="ded17-721">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ded17-721">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="ded17-722">Země nebo oblast</span><span class="sxs-lookup"><span data-stu-id="ded17-722">Country/Region</span></span>      | <span data-ttu-id="ded17-723">Kód země</span><span class="sxs-lookup"><span data-stu-id="ded17-723">Country Code</span></span>          |
| <span data-ttu-id="ded17-724">PSČ</span><span class="sxs-lookup"><span data-stu-id="ded17-724">Zip/Postal Code</span></span>     | <span data-ttu-id="ded17-725">PSČ</span><span class="sxs-lookup"><span data-stu-id="ded17-725">Postal Code</span></span>           |
| <span data-ttu-id="ded17-726">Kraj</span><span class="sxs-lookup"><span data-stu-id="ded17-726">State</span></span>               | <span data-ttu-id="ded17-727">Kód státu</span><span class="sxs-lookup"><span data-stu-id="ded17-727">State Code</span></span>            |
| <span data-ttu-id="ded17-728">Město</span><span class="sxs-lookup"><span data-stu-id="ded17-728">City</span></span>                | <span data-ttu-id="ded17-729">Město</span><span class="sxs-lookup"><span data-stu-id="ded17-729">City</span></span>                  |
| <span data-ttu-id="ded17-730">Okres</span><span class="sxs-lookup"><span data-stu-id="ded17-730">County</span></span>              | <span data-ttu-id="ded17-731">Okres</span><span class="sxs-lookup"><span data-stu-id="ded17-731">County (Municipality)</span></span> |
| <span data-ttu-id="ded17-732">Ulice</span><span class="sxs-lookup"><span data-stu-id="ded17-732">Street</span></span>              | <span data-ttu-id="ded17-733">Řádek adresy 1</span><span class="sxs-lookup"><span data-stu-id="ded17-733">Address Line 1</span></span>        |
| <span data-ttu-id="ded17-734">Číslo popisné</span><span class="sxs-lookup"><span data-stu-id="ded17-734">Street Number</span></span>       | <span data-ttu-id="ded17-735">Řádek adresy 2</span><span class="sxs-lookup"><span data-stu-id="ded17-735">Address Line 2</span></span>        |
| <span data-ttu-id="ded17-736">Doplňující název budovy</span><span class="sxs-lookup"><span data-stu-id="ded17-736">Building Complement</span></span> | <span data-ttu-id="ded17-737">Řádek adresy 5</span><span class="sxs-lookup"><span data-stu-id="ded17-737">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="ded17-738">Číslo cestovního pasu</span><span class="sxs-lookup"><span data-stu-id="ded17-738">Passport number</span></span>

<span data-ttu-id="ded17-739">Zaměstnanci mohou deklarovat informace o cestovním pasu.</span><span class="sxs-lookup"><span data-stu-id="ded17-739">Employees can declare passport information.</span></span> <span data-ttu-id="ded17-740">Tato informace je typu identifikace **Pas** a je integrována do Dayforce jako součást informací o zaměstnanci specifických pro Mexiko.</span><span class="sxs-lookup"><span data-stu-id="ded17-740">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="ded17-741">Typ identifikace = Pas</span><span class="sxs-lookup"><span data-stu-id="ded17-741">Identification Type = "Passport"</span></span>
- <span data-ttu-id="ded17-742">Datum vydání</span><span class="sxs-lookup"><span data-stu-id="ded17-742">Issued Date</span></span>
- <span data-ttu-id="ded17-743">Datum vypršení platnosti</span><span class="sxs-lookup"><span data-stu-id="ded17-743">Expiration Date</span></span>

<span data-ttu-id="ded17-744">Zaměstnanec může deklarovat více identifikačních čísel typu identifikace **Pas**.</span><span class="sxs-lookup"><span data-stu-id="ded17-744">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="ded17-745">Do aplikace Dayforce se integruje pouze zadání aktuálního aktivního pasu.</span><span class="sxs-lookup"><span data-stu-id="ded17-745">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="ded17-746">Po uplynutí platnosti všech zadání pasu se integruje do Dayforce ten, který byl naposledy vydán.</span><span class="sxs-lookup"><span data-stu-id="ded17-746">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
