...
---
# <a name="edit-onboarding-guides-and-templates-in-dynamics-365-for-talent-onboard"></a>Úprava průvodců a šablon zaškolení v aplikaci Dynamics 365 for Talent: Onboard

[!include [banner](includes/banner.md)]

Po vytvoření průvodce nebo šablony zaškolení v aplikaci Microsoft Dynamics 365 for Talent: Onboard je nutné přidat úvod, aktivity, kontakty a zdroje. Onboard umožňuje zahrnout do průvodců zaškolením bohatý obsah včetně následujících možností:
