...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Co je nového nebo upraveného v aplikaci Dynamics 365 Talent (12. listopadu 2019)
...
Změny popsané v této části se vztahují na číslo sestavení 8.1.2604. Čísla v závorkách v některých záhlavích se vztahují na čísla podpory v Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Umístění kanceláře není aktualizováno pomocí sešitu aplikace Excel (369727)

Tato změna umožňuje nyní aktualizovat umístění kanceláře pomocí návrháře sešitu aplikace Office.
