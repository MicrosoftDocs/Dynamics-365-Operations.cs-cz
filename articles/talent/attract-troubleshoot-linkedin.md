...
---
# <a name="troubleshoot-integration-with-linkedin"></a>Odstraňování potíží s integrací s řešením LinkedIn

[!include [banner](../includes/banner.md)]

Následující informace se používají k řešení potíží, které mohou nastat při pokusu o odeslání pracovních nabídek na LinkedIn z aplikace Microsoft Dynamics 365 for Talent: Attract.

## <a name="you-cant-sign-in-to-linkedin-from-attract"></a>Nemůžete se přihlásit k LinkedIn z Attract.

Pokud máte potíže s přihlášením k LinkedIn z aplikace Attract, zkuste provést následující kroky:

1. Ověřte, zda jsou přihlašovací údaje LinkedIn, které jste zadali v aplikaci Attract, platné a správné.
2. Pokud jsou přihlašovací údaje platné a správné, kontaktujte [Podporu LinkedIn](https://www.linkedin.com/help/linkedin).
3. Pokud problém přetrvává, obraťte se na [podporu společnosti Microsoft](./talent-support.md).

## <a name="job-posts-from-attract-dont-appear-on-linkedin"></a>Na LinkedIn nejsou zobrazeny pracovní příspěvky z aplikace Attract.
