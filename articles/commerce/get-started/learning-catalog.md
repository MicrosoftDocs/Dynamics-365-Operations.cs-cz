...
ms.locfileid: "3646875"
---
# <a name="dynamics-365-commerce-learning-catalog"></a>Dynamics 365 Commerce výukový katalog 

Vyberte si potřebné online školení, osobní workshopy a události pro vaši roli uživatele aplikace Dynamics 365 Commerce.
...
<!-- ![Universal Windows Platform (UWP)](images/platform-uwp.png)  -->  
    ...
    [Obchod](learning-catalog-business-user.md#commerce)

    [Elektronický obchod](learning-catalog-business-user.md#e-commerce)
...
:::row:::
    ...
    [Obchod](learning-catalog-administrator.md#commerce)

    [Elektronický obchod](learning-catalog-administrator.md#e-commerce)
...
:::row:::
    ...
    [Obchod](learning-catalog-developer.md#commerce)
    ...
    [Obchod](learning-catalog-functional-consultant.md#commerce)

    [Elektronický obchod](learning-catalog-functional-consultant.md#e-commerce)
...
:::row:::
    ...
    [Obchod](learning-catalog-partner-sales.md#commerce)

    [Elektronický obchod](learning-catalog-partner-sales.md#e-commerce)
    ...
    [Obchod](learning-catalog-solution-architect.md#commerce)
