...
| Přehledy  |  Streamujte události s provozními informacemi o místě prodeje (POS) do svého účtu Application Insights. | [Přístup k protokolům v Application Insights](../dev-itpro/operational-insights.md#enable-diagnostic-events-in-application-insights)   |  Přihlášení IT profesionála/vývojáře   |
