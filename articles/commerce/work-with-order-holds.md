...
description: Tento článek popisuje, jak pracovat s blokováním objednávek pomocí aplikace Dynamics 365 Commerce.
author: josaw1
ms.date: 05/14/2018
ms.topic: article
ms.prod: ''
...
Tento článek popisuje funkce blokování objednávky, které má aplikace Dynamics 365 Commerce pro objednávky kontaktního střediska.
