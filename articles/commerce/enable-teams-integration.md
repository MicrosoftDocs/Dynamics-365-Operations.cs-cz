...
1. Zkopírujte hodnotu certifikátu, která byla zadána, když jste [přidali certifikát](/azure/active-directory/develop/quickstart-register-app#add-a-certificate) v kroku 1. Certifikát je také známý jako veřejný klíč nebo klíč aplikace. Tuto hodnotu použijete k povolení integrace Teams v Commerce Headquarters.
