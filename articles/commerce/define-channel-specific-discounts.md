...
description: Maloobchodní prodejci často nastavují různé slevy v různých kanálech. Tento článek popisuje koncepty, které je nutné znát k vytvoření slevy pro konkrétní kanál.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9273547"
---
# <a name="define-channel-specific-discounts"></a>Definování slev specifických pro kanál

[!include [banner](includes/banner.md)]

Tento článek popisuje koncepty, které je nutné znát k vytvoření slevy pro konkrétní kanál.
