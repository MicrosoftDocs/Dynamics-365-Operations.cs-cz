...
Toto téma obsahuje informace o objednávkách odběratele v Modern POS (MPOS). Objednávky odběratele jsou označovány také jako speciální objednávky. Téma obsahuje diskuzi o souvisejících parametrech a transakčních tocích.
...
Zde jsou některé parametry, které lze nastavit na stránce **Parametry Commerce** za účelem definování způsobu plnění objednávek odběratele:
...
### <a name="create-a-customer-order-in-modern-pos"></a>Vytvoření objednávky odběratele v Modern POS
