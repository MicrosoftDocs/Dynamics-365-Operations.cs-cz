...
description: Tento článek vysvětluje, jak nainstalovat a používat funkci analýzy v Microsoft Dynamics 365 Commerce.
author: AamirAllaq
ms.date: 02/24/2022
...
ms.locfileid: "8887159"
---
# <a name="commerce-analytics-preview"></a>Analytické nástroje Commerce (Preview)

[!include [banner](includes/banner.md)]

Tento článek vysvětluje, jak nainstalovat analýzu Commerce (Preview), funkci funkční analýzy, která je součástí Microsoft Dynamics 365 Commerce.
