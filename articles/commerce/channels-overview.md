...
description: Tento článek poskytuje přehled kanálů v Microsoft Dynamics 365 Commerce.
author: samjarawan
ms.date: 01/27/2020
ms.topic: overview
ms.prod: ''
...
Tento článek poskytuje přehled kanálů v Microsoft Dynamics 365 Commerce. Jsou zde informace o úkolech, které je nutné dokončit před a po nastavení každého kanálu.
