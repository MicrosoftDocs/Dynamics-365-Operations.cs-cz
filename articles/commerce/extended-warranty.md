---
title: Vytváření a konfigurace rozšířených záruk
description: Tento článek popisuje rozšířené záruky a vysvětluje, jak je vytvořit a konfigurovat v aplikaci Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 06/08/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9268361"
---
# <a name="create-and-configure-extended-warranties"></a>Vytváření a konfigurace rozšířených záruk

[!include [banner](includes/banner.md)]

Tento článek popisuje rozšířené záruky a vysvětluje, jak je vytvořit a konfigurovat v aplikaci Microsoft Dynamics 365 Commerce.
