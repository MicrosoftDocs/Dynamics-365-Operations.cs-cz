...
description: Tento článek se zabývá moduly accordion a popisuje, jak je přidat na stránky webu v řešení Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9279149"
---
# <a name="accordion-module"></a>Modul ovládacího prvku Accordion

[!include [banner](includes/banner.md)]

Tento článek se zabývá moduly accordion a popisuje, jak je přidat na stránky webu v řešení Microsoft Dynamics 365 Commerce.
...
1. V dialogovém okně **Vybrat moduly** vyberte modul **Accordion** a poté klikněte na **OK**.
...
1. V dialogovém okně **Vybrat moduly** vyberte modul **Položka Accordion** a poté klikněte na **OK**.
