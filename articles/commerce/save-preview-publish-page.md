...
description: Tento článek popisuje, jak uložit, zobrazit náhled a publikovat stránku v aplikaci Microsoft Dynamics 365 Commerce.
author: psimolin
ms.date: 04/14/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8892252"
---
# <a name="save-preview-and-publish-a-page"></a>Uložení, náhled a publikování stránky

[!include [banner](includes/banner.md)]

Tento článek popisuje, jak uložit, zobrazit náhled a publikovat stránku v aplikaci Microsoft Dynamics 365 Commerce.
