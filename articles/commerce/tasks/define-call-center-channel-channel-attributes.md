...
---
# <a name="create-call-center-channels-and-define-channel-attributes"></a>Vytvoření kanálů kontaktního střediska a definování atributů kanálu

[!include [banner](../includes/banner.md)]

Tento postup vás provede vytvářením nového kanálu commerce a definováním atributů kanálu. Tento úkol byl vytvořen pomocí ukázkových dat společnosti USRT. Tento postup je určen pro roli IT Commerce.
