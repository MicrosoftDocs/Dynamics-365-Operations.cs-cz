...
> [!IMPORTANT]
> Pokyny v tomto článku musíte dodržovat pouze v případě, že používáte Microsoft Dynamics 365 Commerce verze 10.0.28 nebo starší. Od verze Commerce 10.0.29 je ukázka integrace fiskální tiskárny pro Itálii k dispozici v sadě pro vývoj softwaru Commerce (SDK). Další informace naleznete v tématu [Konfigurace komponent kanálů](./emea-ita-fpi-sample.md#configure-channel-components).
