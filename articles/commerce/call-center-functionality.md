...
[Nastavení kanálů kontaktního střediska](set-up-order-processing-options.md)

## <a name="configure-order-processing"></a>Konfigurace zpracování objednávky

[Nastavení a práce s výstrahami u podvodů kontaktního střediska](set-up-fraud-alerts.md)

[Konfigurace a práce s blokováním objednávek kontaktního střediska](work-with-order-holds.md)
...
[Nastavení analýzy recency, frekvence a peněžního období](set-up-rfm-analysis.md)
