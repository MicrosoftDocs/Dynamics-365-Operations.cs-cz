...
Následující video vás provede ukázkovým scénářem clientelingu v Dynamics 365 Commerce.
...
- V části **Tajné klíče**:
    ...
    - **Tajný klíč**: **trezor** :`//<Name of key vault>/<name of secret>>` V tomto příkladu to bude `vault://KeyVaultName/SecretName`.
