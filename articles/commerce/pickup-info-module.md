...
description: Tento článek se zabývá modulem informací o vyzvednutí a popisuje, jak jej přidat na stránky pokladny v řešení Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 11/06/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9288399"
---
# <a name="pickup-information-module"></a>Modul informací o vyzvednutí

[!include [banner](includes/banner.md)]

Tento článek se zabývá modulem informací o vyzvednutí a popisuje, jak jej přidat na stránky pokladny v řešení Microsoft Dynamics 365 Commerce.
