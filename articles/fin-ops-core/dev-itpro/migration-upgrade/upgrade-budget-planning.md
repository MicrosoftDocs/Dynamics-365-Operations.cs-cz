...
V aplikaci AX 2012 mělo plánování rozpočtu jednu částku plánu, která byla uložena pro každou hodnotu. V aplikaci Finance byl datový model rozšířen. Nyní existují částky zúčtovací měny, měny transakce a měny vykazování pro každou hodnotu. Během upgradu se tyto nové sloupce automaticky vyplní pro existující data.
