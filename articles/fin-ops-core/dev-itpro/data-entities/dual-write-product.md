...
Když je povolen dvojí zápis, jsou jednotky z aplikací Finance and Operations synchronizovány do aplikací Dynamics 365. Skupiny jednotek synchronizované z aplikací Finance and Operations v Common Data Service mají sadu příznaků, která označuje, že jsou „externě udržované“.
...
Pokud jsou stejné produkty uchovávány (překrývání a spárování) v aplikaci Finance and Operations a Common Data Service a v jiných aplikacích Dynamics 365 při povolování dvojího zápisu, dojde k provedení synchronizace produktů z Finance and Operations a duplicitní záznamy se zobrazí v Common Data Service pro stejný produkt.
