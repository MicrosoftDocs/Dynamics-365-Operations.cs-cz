...
Barvy základního produktu | msdyn_sharedproductcolors | Entita **Sdílená barva produktu** produktu označuje barvy, které může mít určitý základní produkt k dispozici. Účelem migrace tohoto konceptu do Common Data Service je zachování konzistence dat.
Velikosti základního produktu | msdyn_sharedproductsizes | Entita **Sdílená velikost produktu** produktu označuje velikosti, které může mít konkrétní základní produkt. Účelem migrace tohoto konceptu do Common Data Service je zachování konzistence dat.
Styly základního produktu | msdyn_sharedproductstyles | Entita **Sdílený styl produktu** produktu označuje styly, které má určitý základní produkt k dispozici. Účelem migrace tohoto konceptu do Common Data Service je zachování konzistence dat.
Konfigurace základního produktu | msdyn_sharedproductconfigurations | Entita **Sdílená konfigurace produktu** produktu označuje konfigurace, které má určitý základní produkt k dispozici. Účelem migrace tohoto konceptu do Common Data Service je zachování konzistence dat.
...
Když je povolen dvojí zápis, jsou jednotky z aplikací Finance and Operations synchronizovány do jiných aplikací Dynamics 365. Skupiny jednotek synchronizované z aplikací Finance and Operations v Common Data Service mají sadu příznaků, která označuje, že jsou „externě udržované“.
...
Nejprve je důležité poznamenat, že klíč integrace pro jednotku je msdyn_symbol. Tato hodnota musí být proto jedinečná v aplikaci Common Data Service nebo v jiných aplikacích Dynamics 365. Protože v jiných aplikacích Dynamics 365 je to pár „ID skupiny jednotek“ a „název“, které definují jedinečnost jednotky, musíte zvážit různé scénáře pro spárování dat jednotek mezi aplikacemi Finance and Operations a Common Data Service.
...
Pokud jsou stejné produkty uchovávány (překrývání a spárování) v aplikaci Finance and Operations a v Common Data Service a v jiných aplikacích Dynamics 365 při povolování dvojího zápisu, dojde k provedení synchronizace produktů z Finance and Operations a duplicitní záznamy se zobrazí v Common Data Service pro stejný produkt.
...
Pokud je synchronizace povolena a probíhá, budou produkty z Finance and Operations synchronizovány se spírovanými produkty v aplikaci Common Data Service a v dalších aplikacích Dynamics 365. To platí pro jedinečné produkty i varianty produktu. 
