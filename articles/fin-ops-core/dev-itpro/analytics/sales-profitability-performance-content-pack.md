...
description: Tento článek popisuje, co je součástí obsahu Power BI Prodej a ziskovost.
author: Henrikan
ms.date: 12/18/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9274652"
---
# <a name="sales-and-profitability-performance-power-bi-content"></a>Obsah výkonu prodeje a ziskovosti Power BI

[!include [banner](../includes/banner.md)]

Tento článek popisuje, co je součástí obsahu **Prodej a ziskovost** Microsoft Power BI. Vysvětluje přístup k sestavám Power BI a poskytuje informace o datovém modelu a entitách, které byly použity k sestavení obsahu.
