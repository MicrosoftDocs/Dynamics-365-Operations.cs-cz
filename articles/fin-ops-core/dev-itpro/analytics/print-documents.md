...
Kromě platformy, která je nasazena do předplatného Azure, finanční a provozní aplikace poskytuje zákazníkům integrovanou aplikaci Azure první strany, která jim pomáhá snadněji využívat zařízení hostovaná na doméně pro tisk dokumentů.
