...
description: Tento článek popisuje, co je součástí obsahu výkonu skladu v Power BI.
author: Mirzaab
ms.date: 12/18/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9206023"
---
# <a name="warehouse-performance-power-bi-content"></a>Obsah výkonnosti skladu v Power BI

[!include [banner](../includes/banner.md)]

Tento článek popisuje, co je součástí obsahu **výkonu skladu** v Microsoft Power BI. Vysvětluje přístup k sestavám Power BI a poskytuje informace o datovém modelu a entitách, které byly použity k sestavení obsahu.
