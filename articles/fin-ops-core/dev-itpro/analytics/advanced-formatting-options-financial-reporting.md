...
description: Tento článek popisuje pokročilé funkce formátování, včetně filtrů, omezení, netištěných řádků a podmíněných příkazů ve výpočtech.
author: panolte
ms.date: 04/26/2019
ms.topic: article
ms.prod: ''
