...
description: V tomto článku je vysvětleno, jak odložit provádění prvku XML ve formátu elektronického výkaznictví.
author: NickSelin
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
...
Pokud jste ještě nedokončili příklad v článku [Odložení provádění prvků posloupnosti ve formátech elektronického výkaznictví](er-defer-sequence-element.md#Example), stáhněte si následující [konfigurace](general-electronic-reporting.md#Configuration) ukázkového řešení elektronického výkaznictví.
