...
2. Na stránce **Stavy souboru pro zdroje** vyberte **aktualizovat** k obnovení stránky. Všimněte si, že soubor aplikace Excel, který byl nahrán do služby SharePoint, se zobrazil na této stránce se stavem **Připraven**. Jsou podporovány následující stavy:
