...
description: Tento článek vysvětluje, jak používat nástroj elektronického výkaznictví (ER) ke generování obchodních dokumentů, které mají vložené obrázky a tvary.
author: kfend
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
