...
description: Tento článek vysvětluje, jak navrhnout řešení elektronického výkaznictví (ER) pro tisk vlastní sestavy.
author: kfend
ms.date: 08/10/2020
ms.topic: article
ms.prod: ''
...
Další informace o verzích pro konfigurace ER viz [Přehled elektronického výkaznictví (ER)](general-electronic-reporting.md).
