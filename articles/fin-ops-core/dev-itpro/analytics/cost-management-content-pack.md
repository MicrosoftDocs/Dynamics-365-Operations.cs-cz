...
| Objekt                          | Klíčová opatření agregace | Datový zdroj pro finance a provoz | Pole               |
|---------------------------------|----------------------------|----------------------------------------|---------------------|
| CostObjectStatementCacheMonthly | Částka                     | CostObjectStatementCache               | Množství              |
