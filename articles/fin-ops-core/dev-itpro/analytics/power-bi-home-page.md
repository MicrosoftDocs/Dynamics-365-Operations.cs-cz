...
description: V tomto článku jsou popsána řešení PowerBI.com, která jsou k dispozici, a téma odkazuje na zdroje, které se o řešeních dozvíte více.
author: sericks007
ms.date: 10/02/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9206345"
---
# <a name="power-bi-content-home-page"></a>Domovská stránka obsahu Power BI

[!include [banner](../includes/banner.md)]

Pro prostředí aplikace jsou k dispozici následující řešení PowerBI.com.
...
> [!NOTE]
> Většina řešení PowerBI.com v následujícím seznamu jsou vložena do analytických pracovní prostorů v posledních verzích. Použití analytických pracovních prostorů eliminuje potřebu stahovat tato řešení z knihovny sdíleného majetku LCS. Téma v tomto seznamu určuje, kam byla tato PowerBI.com řešení integrována, pokud byla.

- [Skutečnost a rozpočet](ledger-budgets-power-bi.md)
- [Přehled hotovosti](../../../finance/cash-bank-management/Cash-Overview-Power-BI-content.md)
...
- [Správa kreditu a inkasa](../../../finance/accounts-receivable/credit-collections-power-bi.md)
...
- [Správa dlouhodobého majetku](../../../finance/fixed-assets/Fixed-asset-management-workspace.md)
...
- [Platby dodavatelů](../../../finance/accounts-payable/Vendor-payments-workspace.md)
...
Následující řešení PowerBI.com jsou k dispozici z [Microsoft AppSource](https://appsource.microsoft.com).
