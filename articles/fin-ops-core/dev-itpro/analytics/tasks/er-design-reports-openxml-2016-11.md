...
description: Tento článek popisuje, jak vytvořit novou konfiguraci elektronického výkaznictví, která obsahuje šablonu pro generování elektronických dokumentů ve formátu OPENXML.
author: NickSelin
ms.date: 04/23/2021
