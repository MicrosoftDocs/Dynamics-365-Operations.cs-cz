...
description: Tento článek popisuje, jak použít novou konfiguraci elektronického výkaznictví (ER) ke generování elektronických dokumentů ke zpracování plateb.
author: kfend
ms.date: 08/29/2018
