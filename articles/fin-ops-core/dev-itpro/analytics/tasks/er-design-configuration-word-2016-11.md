...
Pokud chcete generovat sestavy jako dokumenty aplikace Microsoft Word, můžete [konfigurovat](../er-design-configuration-word.md) nový formát [elektronického výkaznictví (ER)](../general-electronic-reporting.md). Alternativně můžete znovu použít formát ER, který byl původně navržen pro generování sestav jako sešity aplikace Excel. V takovém případě musíte nahradit šablonu aplikace Excel šablonou aplikace Word.
