...
description: Tento článek poskytuje informace o tom, jak nakonfigurovat cíl archivu pro každou SLOŽKU nebo SOUBOR ve formátu elektronického výkaznictví (ER).
author: NickSelin
ms.date: 11/30/2020
ms.topic: article
ms.prod: ''
