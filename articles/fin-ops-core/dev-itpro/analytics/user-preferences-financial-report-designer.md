...
description: Tento článek popisuje, jak nastavit uživatelské předvolby pro přizpůsobení interakce uživatelů v návrháři finančních sestav, a pro řízení výchozího prostředí po přihlášení.
author: aprilolson
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
