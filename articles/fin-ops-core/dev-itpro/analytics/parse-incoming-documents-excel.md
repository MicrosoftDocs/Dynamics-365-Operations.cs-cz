...
Pokud jste si ještě nepřehráli následující průvodce záznamem úloh, [ER vytvoření požadované konfigurace pro import dat z externího souboru](./tasks/er-required-configurations-import-data.md) v aktuální aplikaci Finance and Operations, stáhněte si následující soubor.
