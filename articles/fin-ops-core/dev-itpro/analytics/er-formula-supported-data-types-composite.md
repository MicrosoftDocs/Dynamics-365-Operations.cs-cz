...
description: Tento článek obsahuje informace o typech složených dat, které jsou podporovány ve vzorcích elektronického výkaznictví (ER).
author: kfend
ms.date: 06/02/2021
...
Tento článek obsahuje informace o typech složených dat, které jsou podporovány ve výrazech [elektronického výkaznictví (ER)](general-electronic-reporting.md). Složené datové typy jsou [třída](#class), [kontejner](#container), [záznam](#record), [seznam záznamů](#record-list) a [objekt](#object).
