...
description: Tento článek popisuje, co je součástí obsahu analýzy nákupu a výdajů v Power BI.
author: FrankDahl
ms.date: 04/24/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9206684"
---
# <a name="purchase-spend-analysis-power-bi-content"></a>Analýza obsahu výdajů na nákup v Power BI

[!include [banner](../includes/banner.md)]

Tento článek popisuje, co je součástí obsahu **analýzy nákupu a výdajů** v Microsoft Power BI. Vysvětluje přístup k sestavám Power BI a poskytuje informace o datovém modelu a entitách, které byly použity k sestavení obsahu.
