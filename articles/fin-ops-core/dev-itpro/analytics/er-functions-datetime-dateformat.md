...
description: Tento článek obsahuje obecné informace o použití funkce DATEFORMAT elektronického výkaznictví.
author: NickSelin
ms.date: 09/08/2021
ms.prod: ''
ms.technology: ''
