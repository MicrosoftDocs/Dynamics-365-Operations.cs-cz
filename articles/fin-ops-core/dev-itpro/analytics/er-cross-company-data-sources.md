...
description: Tento článek vysvětluje, jak je možné používat datové zdroje mezi více společnostmi v modulu Elektronické výkaznictví (ER).
author: kfend
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
...
- [Konfigurace modelu dat – ER CrossCompanyDataAccessModel.xml](https://download.microsoft.com/download/4/2/5/4258f891-7054-4821-aedd-3721ba25fdd5/CrossCompanyDataAccessModel.xml)
- [Konfigurace formátu ER – CrossCompanyDataAccessFormat.xml](https://download.microsoft.com/download/3/2/1/321deb75-3ba9-4323-99bf-207a52c60b5c/CrossCompanyDataAccessFormat.xml)
