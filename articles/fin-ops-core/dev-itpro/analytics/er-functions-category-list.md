...
Funkce seznamu elektronického výkaznictví (ER) lze používat k extrahování informací ze zdrojů dat a provádění operací se zdroji dat datových typů *Seznam záznamů* a *Kontejner (záznam)*. Tento článek obsahuje souhrn těchto funkcí.
