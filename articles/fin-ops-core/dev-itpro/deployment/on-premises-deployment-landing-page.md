...
- [Obchodní funkce, které jsou dostupné v místních nasazeních](../../../commerce/retail-onprem.md)
- [Instalační kroky pro komponenty maloobchodní sítě v místním prostředí](deploy-retail-onprem.md)
- [Konfigurace, Instalace a aktivace Modern POS (MPOS)](../../../commerce/retail-modern-pos-device-activation.md)
- [Konfigurace a instalace Commerce Scale Unit](../../../commerce/dev-itpro/retail-store-scale-unit-configuration-installation.md)
