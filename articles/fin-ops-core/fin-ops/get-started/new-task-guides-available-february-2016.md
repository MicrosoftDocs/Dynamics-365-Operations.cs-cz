...
description: Tento článek obsahuje průvodce záznamem úloh vydané pro knihovny Microsoft BPM k únoru 2016.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8861727"
---
# <a name="new-task-guides-february-2016"></a>Noví průvodci úkolem (únor 2016)

[!include [banner](../includes/banner.md)]

Tento článek obsahuje průvodce záznamem úloh vydané pro knihovny Microsoft BPM k únoru 2016. Publikované knihovny zahrnují (únor 2016) knihovnu APQC Unified Library pro Microsoft Dynamics AX a (únor 2016) příručku Začínáme.

## <a name="task-guides-in-the-february-2016-apqc-unified-library-for-microsoft-dynamics-ax"></a>Průvodci úkolem v knihovně APQC Unified Library (únor 2016) pro Microsoft Dynamics AX
...
| Řádek BPM                                                            | Země nebo oblast |
|---------------------------------------------------------------------|----------------|
| Porovnání aktivních, odhadovaných a realizovaných nákladů u výrobní zakázky | Globální         |
...
| Zobrazení výkazu zásob a ukazatele KPI podle objektů nákladů                     | Globální         |
...
### <a name="develop-vision-and-strategy"></a>Vývoj vize a strategie

| Řádek BPM                                                                                 | Země nebo oblast |
|------------------------------------------------------------------------------------------|----------------|
| Analýza výsledků dotazníku                                                            | Globální         |
| Vytvoření dotazu s uzavřeným koncem                                                           | Globální         |
...
| Řádek BPM                                                  | Země nebo oblast |
|-----------------------------------------------------------|----------------|
| Změna způsobu odpisování pro více položek dlouhodobého majetku | Globální         |
...
|------------------------------------------------------------------|----------------|
| Analýza výsledků dotazníku                                    | Globální         |
| Schválení záznamů doručených přihlášek                                | Globální         |
...
| Převedení fyzických zásob ve skladu                                  | Globální         |
...
| Vytvoření dílčí nákupní objednávky z nákupní smlouvy        | Globální         |
...
| Nastavení hierarchie kategorií zásobování                          | Globální         |
...
| Vytvořte základní produkt ..\\financial-dimensions\\dimension-based  | Globální         |
| Vytvoření hierarchie klasifikace produktu                       | Globální         |
...
| Vydejte základní produkt ..\\financial-dimensions\\dimension-based | Globální         |
...
| Konfigurace obchodů pro výkazy maloobchodu                                                | Globální         |
...
| Řádek BPM                                                                          | Země nebo oblast |
|-----------------------------------------------------------------------------------|----------------|
| Přidružení indexu paliva k dopravci jako nákladů na dodatečné služby                    | Globální         |
