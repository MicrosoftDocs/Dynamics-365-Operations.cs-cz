...
---
# <a name="grid-capabilites"></a>Možnosti mřížky
...
Každá tabulková mřížka v aplikacích Finance and Operations má oblast zápatí v dolní části mřížky, která může zobrazovat cenné informace vztahující se k zobrazeným datům. Tyto informace zahrnují: 
...
1.  Pravým tlačítkem klikněte na sloupec, pro který chcete zjistit celkovou hodnotu, a vyberte **Sečíst tento sloupec**. Tato akce provede tři věci. Za prvé bude zápatí viditelné. Za druhé, bude uložena vaše preference pro zobrazení součtu v tomto sloupci. Za třetí, tato akce zahájí výpočet součtu pro tento sloupec a všechny dříve konfigurované, pro zobrazení celkových hodnot. Čas potřebný k zobrazení souhrnu přímo souvisí s velikostí sady dat, které sčítáte.  

2.  Po zobrazení zápatí můžete také kliknout na tlačítko **Zobrazit součet** v oblasti zápatí v dolní části sloupce, pro který chcete zobrazit součet. Pokud neexistují žádné konfigurované sloupce, tlačítko **Zobrazit součet** bude viditelné pro všechny číselné sloupce. Je-li pro součty nakonfigurován alespoň jeden sloupec, budou tlačítka **Zobrazit součet** k dispozici pouze při přechodu nebo výběru. Tato akce jednoduše uloží vaši preferenci pro zobrazení součtu v tomto sloupci pro budoucí návštěvy na této stránce a tento stav je označen pomlčkou, která se zobrazí v tomto sloupci v zápatí (nebo se zobrazí součet ihned, pokud je sada dat dostatečně malá).
...
-  Popisek sloupce To je užitečné zejména tehdy, je-li podporováno více úrovní seskupení.  
...
Pokud vyberete možnost **Seskupit podle tohoto sloupce** v jiném sloupci, bude nahrazeno původní seskupení, protože v aktualizaci 10.0.9 / Platform Update 33 je podporována pouze úroveň seskupení.
...
Pro zvýšení produktivity může uživatel zadat matematické vzorce do číselných buněk v mřížce namísto provádění výpočtu v aplikaci mimo systém. Do pole můžete například zadat **=15\*4** a opustit toto pole. Systém vyhodnotí výraz a uloží pro pole hodnotu "60".

Chcete-li, aby systém rozpoznal hodnotu jako výraz, zahajte tuto hodnotu znaménkem rovná se (**=**). Další informace o podporovaných operátorech a syntaxi naleznete v tématu [Podporované matematické symboly](http://redhivesoftware.github.io/math-expression-evaluator/#supported-maths-symbols).  
