...
description: Tento článek vysvětluje, jak nakonfigurovat různé vlastnosti workflowu.
author: ChrisGarty
ms.date: 07/07/2020
ms.topic: article
ms.prod: ''
...
Tento článek vysvětluje, jak nakonfigurovat různé vlastnosti workflowu.
...
6. Proveďte pracovní postup s některými cílovými záznamy a ověřte, zda podmínka správně zahrnuje a vylučuje záznamy.
