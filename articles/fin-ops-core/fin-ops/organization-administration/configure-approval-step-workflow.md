...
description: Tento článek vysvětluje, jak nakonfigurovat vlastnosti schvalovacího kroku.
author: ChrisGarty
ms.date: 08/23/2017
ms.topic: article
ms.prod: ''
...
Tento článek vysvětluje, jak nakonfigurovat vlastnosti schvalovacího kroku.
