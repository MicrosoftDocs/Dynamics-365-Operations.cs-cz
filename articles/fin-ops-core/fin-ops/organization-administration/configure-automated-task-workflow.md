...
description: Tento článek vysvětluje, jak nakonfigurovat vlastnosti automatizovaného úkolu.
author: ChrisGarty
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Tento článek vysvětluje, jak nakonfigurovat vlastnosti automatizovaného úkolu.
