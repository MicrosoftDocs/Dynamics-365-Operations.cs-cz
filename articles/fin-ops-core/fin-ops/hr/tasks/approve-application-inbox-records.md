...
## <a name="review-application-inbox-record"></a>Kontrola záznamu doručených přihlášek
1. Přejděte na Lidské zdroje > Nábor > Přihlášky > Doručené přihlášky.
2. Vyhledejte na seznamu požadovaný záznam a vyberte ho.
3. Rozbalte sekci Adresy.
4. Rozbalte oddíl Kontaktní informace.
5. Rozbalte sekci Přílohy.

## <a name="approve-application-inbox-record"></a>Schválení záznamu doručených přihlášek
1. Označte v seznamu vybraný řádek.
2. Poznamenejte si hodnotu v poli Název pro pozdější potřebu.
3. Klepněte na možnost Schválit.
4. Klikněte na tlačítko OK.
5. Zavřete stránku.

## <a name="view-the-newly-created-application-record"></a>Zobrazení nově vytvořeného záznamu přihlášky
