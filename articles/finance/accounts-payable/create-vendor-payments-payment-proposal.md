...
description: Tento článek obsahuje přehled možností návrhu platby a nabízí příklady zobrazující, jak návrh plateb funguje.
author: abruer
ms.date: 04/04/2018
ms.topic: article
ms.prod: ''
