...
Workflow postupuje podle standardního procesu workflow. Schvalovatel je přesměrován na stránku **Dodavatel** , kde můžete zkontrolovat změny na stránce **Navržené změny** a poté vybrat **Workflowu \> Schválit** ke schválení workflow. Po dokončení všech schválení jsou pole aktualizována hodnotami, které jste navrhli.
