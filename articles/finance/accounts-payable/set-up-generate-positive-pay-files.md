...
> [!NOTE]
> Tato funkce bude v září 2022 ukončena, noví uživatelé by měli používat elektronické hlášení. Více informací viz [Nastavení kladných mzdových souborů pomocí elektronického výkaznictví](set-up-positive-pay-er.md).
