...
ms.locfileid: "8863065"
---
# <a name="set-up-fixed-asset-posting-profiles"></a>Nastavení účetních profilů dlouhodobého majetku

[!include [banner](../../includes/banner.md)]

Tento postup ukazuje, jak nastavit účetní profily dlouhodobého majetku. Příklady uvedené v článku jsou určeny pro základní účetní profil, i když účetní profily je nutné vytvořit pro vaši konkrétní účtovou osnovu a požadavky na finanční výkazy.
