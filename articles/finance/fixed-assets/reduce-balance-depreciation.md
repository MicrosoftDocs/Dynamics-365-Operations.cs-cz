...
Možnost **Kalendářní** aktualizuje odpisový základ (což je obvykle čistá účetní hodnota minus konečná zůstatková hodnota) 1. ledna každého roku. V příkladu degresivního odpisu později v tomto článku je odpisová základna čitatelem v prvním výrazu ve výpočtech ve sloupci kalkulací. 
