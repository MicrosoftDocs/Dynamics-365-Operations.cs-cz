...
description: Tento článek definuje klíčové podmínky, které se používají v nákladovém účetnictví.
author: aprilolson
ms.date: 08/31/2017
ms.topic: article
ms.prod: ''
...
Tento článek definuje klíčové podmínky, které se používají v nákladovém účetnictví.
...
-  Dynamics 365 Finance (předkonfigurováno)
...
|  **Datové zdroje** |  **datový konektor Importované transakce** | **Datový konektor Dynamics 365 Finance**  | **Datový konektor Dynamics AX**  |
|---|---|---|---|
