...
description: Tento článek obsahuje informace o mobilním pracovním prostoru řízení nákladů. Tento pracovní prostor umožňuje manažerům nákladového střediska zobrazit informace o výkonu nákladového střediska kdykoli a odkudkoli.
author: AndersGirke
ms.date: 05/24/2022
ms.topic: article
ms.prod: ''
