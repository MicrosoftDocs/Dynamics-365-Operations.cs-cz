...
- Pořiďte fotografii příjemky a odešlete ji do Dynamics 365 Finance. Následně můžete připojit uvedenou fotografii k sestavě výdajů později.
...
Předpoklady se liší podle verze, která byla nasazena ve vaší organizaci.

### <a name="prerequisites-if-you-use-dynamics-365-finance"></a>Předpoklady při použití Dynamics 365 Finance 
Pokud je ve vaší organizaci nasazena aplikace Finance, správce systému musí publikovat mobilní pracovní prostor **Správa výdajů**. Více pokynů naleznete v tématu [Publikování mobilního pracovního prostoru](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
...
Stáhněte a nainstalujte mobilní aplikaci Dynamics 365 for Unified Ops:
