...
description: Tento článek popisuje metody přidělení, které jsou k dispozici v aplikaci Microsoft Dynamics 365 Finance, a jejich použití.
author: panolte
ms.date: 03/05/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8901453"
---
# <a name="budget-planning-data-allocation"></a>Přidělování dat plánování rozpočtu
