...
Pokud rozumíte konceptům a terminologii, které se používají v aplikaci Microsoft Dynamics 365 Finance, je bude pro vás snazší provádět plánování rozpočtu ve vaší organizaci.
...
Workflow rozpočtování můžete vytvořit pro plánování rozpočtu na stránce **Workflowy rozpočtování**. Tento proces se podobá procesu vytváření jiných workflowů. Následující obrázek znázorňuje příklad workflowu ústředí. 
...
[!Note] Ve výchozím nastavení budete mít omezení na 36 sloupců, což vám umožní rozšířit plánování rozpočtů o kroky v části [Rozšíření rozvržení plánování rozpočtu](./extending-budget-planning-layout.md).
