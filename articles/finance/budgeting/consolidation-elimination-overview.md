...
Dávám přednost zaúčtování eliminací v databázi. Jaké jsou mé možnosti?
...
Potřebujeme naše konsolidované výsledky ve více měnách vykazování.
...
Chci zobrazit podrobnosti do úrovně transakcí pro jednotlivé společnosti.
...
Používáme plánování rozpočtu nebo kontrolu rozpočtu a je nutné je konsolidovat.
 - Možnost **Finanční vykazování** je řešení pro konsolidaci veškerého plánování rozpočtu nebo dat kontroly rozpočtu.

Naše dceřiné společností jsou umístěny v celém světě a máme více účtových osnov. Která metoda je pro konsolidaci našich dat nejlepší?
...
Potřebujeme více úrovní konsolidace. Jinými slovy: nejprve konsolidujeme všechny naše evropské dceřiné společnosti na britskou libru (GBP). Potom vezmeme data převádíme konsolidovanou částku na americký dolar. Jak to lze provést?
...
Máme dceřiné společnosti v jiném systému. Jak je můžeme konsolidovat?
- Použijte možnost **Konsolidovat s importem** k přenesení zůstatků do konsolidované společnosti.

Některé naše dceřiné společnosti nejsou plně vlastněny. Která metoda je pro jejich konsolidaci nejlepší?
...
Naše organizace musí zobrazovat konsolidace podle obchodních jednotek nebo chce použít organizační hierarchie.
...
Mohu provést konsolidaci s rozpočtem ve stavu **KONCEPT**? 
