...
description: Tento článek vysvětluje, jak používat sdílené číselné řady pro kopírování odběratele do jiné právnické osoby při zachování stejného ID odběratele.
author: abruer
ms.date: 08/31/2018
ms.topic: index-page
ms.prod: ''
