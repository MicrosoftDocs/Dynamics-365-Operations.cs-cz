...
description: Tento článek vysvětluje, jak nastavit funkci vyúčtování po milnících ve fakturaci předplatného.
...
ms.locfileid: "8856763"
---
# <a name="milestone-billing"></a>Vyúčtování po milnících

[!include [banner](../includes/banner.md)]

Tento článek vysvětluje, jak definovat šablony pro funkci vyúčtování po milnících ve fakturaci předplatného. U každého řádku v šabloně milníku můžete definovat procento nebo částku přidělení. Šablonu milníku pak můžete přiřadit k položkám plánu fakturace, které používají funkci vyúčtování po milnících.
