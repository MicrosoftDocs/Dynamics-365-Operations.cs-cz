...
Standardně uživatelé aplikace mohou zobrazit všechny informace o odběratelích na stránkách se seznamem inkasa. Můžete použít záznamy inkasního agenta a určit s nimi fondy zákazníků, kde je možné filtrovat informace na stránkách se seznamem inkasa a na stránce Inkasa. 

Inkasní agent je osoba, která pracuje s odběrateli k zajištění, že platby se vybírají včas. Inkasní agenti jsou pracovníci, kteří jsou přiřazeni uživatelům na stránce Nastavení uživatelů.
