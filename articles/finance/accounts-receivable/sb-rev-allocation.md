...
description: Tento článek vysvětluje, jak použít přidělení výnosů ve fakturaci předplatného.
...
ms.locfileid: "8864361"
---
# <a name="revenue-allocation"></a>Přidělení výnosu

Tento článek vysvětluje, jak nastavit parametry přidělení výnosů pro plán fakturace. Při vytváření plánu fakturace můžete nastavit nebo upravit přidělení výnosů. Když otevřete stránku **Přidělení příjmů** pro aktivní nebo ukončený plán fakturace, pole jsou pouze pro čtení.
