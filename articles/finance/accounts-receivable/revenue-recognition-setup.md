...
description: Tento článek popisuje možnosti nastavení pro uznání výnosů a jejich dopady.
author: bking
ms.date: 04/28/2022
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "9348403"
---
# <a name="revenue-recognition-setup"></a>Nastavení uznání výnosů
[!include [banner](../includes/banner.md)]

Byl přidán nový modul **Uznání výnosů**, který obsahuje položky nabídky pro veškerá požadovaná nastavení. Tento článek popisuje možnosti nastavení a jejich dopady.
