...
description: Tento článek vysvětluje, jak nastavit období vypořádání pro období vypořádání daně odečtené u zdroje (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Tento článek vysvětluje, jak nastavit období vypořádání pro období vypořádání daně odečtené u zdroje (TDS).
