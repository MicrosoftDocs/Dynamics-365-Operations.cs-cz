---
title: Přidání datových polí v daňových konfiguracích
description: Tento článek vysvětluje, jak přizpůsobit daňové konfigurace přidáním datových polí.
author: Kai-Cloud
ms.date: 10/21/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8872319"
---
# <a name="add-data-fields-in-tax-configurations"></a>Přidání datových polí v daňových konfiguracích

[!include [banner](../includes/banner.md)]

Tento článek vysvětluje, jak přizpůsobit daňové konfigurace pomocí [datových polí, která jsou přidána do daňové integrace](tax-service-add-data-fields-tax-integration-by-extension.md).
