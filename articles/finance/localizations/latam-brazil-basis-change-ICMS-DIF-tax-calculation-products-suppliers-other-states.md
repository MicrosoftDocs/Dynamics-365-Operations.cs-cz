...
description: Toto téma popisuje konfiguraci pro výpočty typu daně ICMS-DIF při obdržení fiskálního dokladu v brazilském státě Rio Grande do Sul (RS) nebo São Paulo (SP).
author: Kai-Cloud
ms.date: 1/20/2022
ms.topic: article
ms.prod: ''
...
Toto téma popisuje konfiguraci pro výpočty typu daně **ICMS-DIF** při obdržení fiskálního dokladu v brazilském státě Rio Grande do Sul (RS) nebo São Paulo (SP).
