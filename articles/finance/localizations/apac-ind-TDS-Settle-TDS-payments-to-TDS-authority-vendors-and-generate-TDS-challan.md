...
description: Tento článek vysvětluje, jak vyrovnat platby daně odečtené u zdroje (TDS) prodejcům autorit TDS.
author: kailiang
ms.date: 03/12/2021
ms.topic: article
ms.prod: ''
...
Tento článek vysvětluje, jak vyrovnat platby daně odečtené u zdroje (TDS) prodejcům autorit TDS.
