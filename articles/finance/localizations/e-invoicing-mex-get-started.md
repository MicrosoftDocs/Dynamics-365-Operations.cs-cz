...
description: Tento článek poskytuje informace, které vám pomohou začít s Elektronickou fakturací pro Mexiko.
author: gionoder
ms.date: 12/01/2020
ms.topic: article
ms.prod: ''
...
Než dokončíte kroky v tomto článku, musíte provést kroky v [Začínáme se správou služby Elektronická fakturace](e-invoicing-get-started-service-administration.md) a [Začínáme s elektronickou fakturací](e-invoicing-get-started.md).
