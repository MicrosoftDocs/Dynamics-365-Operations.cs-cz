...
description: Tento článek vysvětluje, jak řešit problém, kdy je seznam funkcí daně na stránce Parametry výpočtu daně prázdný.
author: wangchen
ms.date: 03/04/2022
...
Pokud se dvě ID tenantů liší, narazíte na problém popsaný v tomto článku. Pokud jsou stejné, narážíte na nesouvisející problém. V takovém případě doporučujeme kontaktovat podporu společnosti Microsoft.
