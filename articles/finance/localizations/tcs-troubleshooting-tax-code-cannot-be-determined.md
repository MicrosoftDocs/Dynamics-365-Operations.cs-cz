---
title: Kód daně nelze určit
description: Toto téma vysvětluje, jak odstranit chybu "Kód daně nelze určit" ve službě Výpočet daně.
author: hangwan
ms.date: 03/25/2022
...
ms.locfileid: "8645386"
---
# <a name="tax-code-cannot-be-determined"></a>Kód daně nelze určit

[!include [banner](../includes/banner.md)]

V tomto tématu jsou vysvětleny kroky k odstranění problémů, které můžete provést, pokud se ve službě Výpočet daně zobrazí chyba "Kód daně nelze určit".
...
1. Projděte každý krok v části [Odstraňování problémů](#troubleshoot) tohoto tématu a podle potřeby opravte nastavení. Pokud nebyla správně určena daňová skupina a daňová skupina položky, získáte informace v tématu [Nebyl nalezen žádný odpovídající výsledek](tcs-troubleshooting-no-matching-result.md).
