...
description: Tento článek poskytuje seznam témat nápovědy a dalších zdrojů pro funkce správy financí v Microsoft Dynamics 365 Finance.
author: kfend
ms.date: 11/04/2021
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "9539226"
---
# <a name="finance-home-page"></a>Domovská stránka aplikace Finance

[!include [banner](includes/banner.md)]

Tento článek poskytuje seznam témat nápovědy a dalších zdrojů pro funkce správy financí v Microsoft Dynamics 365 Finance. 
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        - [Finanční výkaznictví](../fin-ops-core/dev-itpro/analytics/financial-reporting-intro.md?toc=/fin-and-ops/toc.json)
...
Předpisy země/oblasti ovlivňují nastavení daní a další oblasti správy financí. Nahlédněte do části [Lokalizace a funkce týkající se předpisů](../fin-ops-core/dev-itpro/lcs-solutions/country-region.md?toc=/fin-and-ops/toc.json) a dozvíte se o funkcích specifických pro zemi/oblast.
...
Online kurzy a školení naleznete ve [studijních programech Dynamics 365 Finance](/training/browse/?products=dynamics-finance&resource_type=learning+path).
