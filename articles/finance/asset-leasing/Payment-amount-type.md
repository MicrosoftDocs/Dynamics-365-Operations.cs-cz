...
description: Toto téma vysvětluje, jak nastavit typy částky platby v leasingu majetku.
author: moaamer
ms.date: 01/11/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "7968317"
---
# <a name="add-payment-amount-types"></a>Přidání typu částky platby

[!include [banner](../includes/banner.md)]

Toto téma popis, jak nastavit typy částky platby v leasingu majetku. Tímto způsobem můžete rozepsat částku leasingové splátky namísto přidávání jednorázové částky do řádků splátkového kalendáře.
