...
description: Tento článek vysvětluje součásti, které tvoří účtovou osnovu, a jak součásti spolupracují.
author: aprilolson
ms.date: 10/24/2022
ms.topic: article
ms.prod: ''
...
Bohatý systém na základě pravidel se používá pro určení platných kombinací hlavních účtů hodnot finančních dimenzí. Tento oddíl poskytuje stručný přehled funkcí jednotlivých komponent a vysvětluje, kde komponenty naleznete.
...
Některé z následujících zdrojů se vztahují k předchozí verzi aplikace našeho softwaru. Většina informací o použití výchozích dimenzí a mnoho konceptů je však stejných v předchozí verzi a odkazy jsou stále platné.
