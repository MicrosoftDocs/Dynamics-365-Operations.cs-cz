...
description: Tento článek popisuje doporučené postupy pro konfiguraci profilů účtování.
...
ms.locfileid: "8849895"
---
# <a name="recommended-practices-for-posting-profiles"></a>Doporučené postupy pro profily účtování

Existuje několik doporučených postupů, které byste měli dodržovat při konfiguraci účtování odesílání v celém systému. Tento článek popisuje různé scénáře a odpovídající doporučené postupy.
