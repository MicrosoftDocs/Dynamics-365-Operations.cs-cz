...
Tento článek popisuje projektové smlouvy (obsahuje i příklady), které můžete vytvořit pro různé typy projektů a zdroje financování, dále jak lze spravovat smlouvy a fakturovat odběratele projektu.
