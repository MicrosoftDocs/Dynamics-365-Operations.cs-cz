...
Pokud je ve vaší organizaci nasazena aplikace Finance, správce systému musí publikovat mobilní pracovní prostor **Zadání času projektu**. Více pokynů naleznete v tématu [Publikování mobilního pracovního prostoru](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
