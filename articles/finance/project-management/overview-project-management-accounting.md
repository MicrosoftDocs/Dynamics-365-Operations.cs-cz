...
V modulu Finance můžete vytvořit šest typů projektů. Každý typ projektu je nastaven jinak pro rozpoznávání výnosů a nákladů. Vybraný typ projektu závisí na jeho účelu. V následující tabulce je popsán typický příklad použití všech typů projektů.
...
Finance nesnižuje automaticky prognózované odhady. Je proto vhodné zachovat původní model prognózy projektu s pevnou cenou, aby se vytvořila základna pro srovnání při dokončení projektu. 
...
:::row:::
    :::column:::
        #### <a name="cash-flow-page"></a>Stránka Cashflow
        - Přírůstky hotovosti 
        - Úbytky hotovosti
        - Čistý cashflow
    :::column-end:::
    :::column:::
        #### <a name="project-statements-page"></a>Stránka Výkazy projektu
        - Výnosy
        - Celkové náklady
        - Hrubá marže
    :::column-end:::
