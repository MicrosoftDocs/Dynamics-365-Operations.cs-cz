...
---
# <a name="project-timesheet-mobile-application"></a>Mobilní aplikace časového rozvrhu projektu
...
V aplikaci Finance musí být povolena mobilní aplikace Project Timesheet. Chcete-li funkci povolit, přejděte na **Parametry modulu Řízení a účetnictví projektu \> Časový rozvrh** a vyberte parametr **Povolit Microsoft Dynamics 365 Project Timesheet**.

## <a name="sign-in-to-the-app"></a>Přihlášení do aplikace

1.  Spusťte aplikaci na svém mobilním zařízení.

2.  Zadejte adresu URL aplikace Finance.
