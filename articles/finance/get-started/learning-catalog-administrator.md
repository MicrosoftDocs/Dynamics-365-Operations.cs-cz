---
title: Výukový katalog správců pro Dynamics 365 Finance
description: Všechny možnosti školení pro správce Dynamics 365 Finance.
author: cstorega
ms.topic: article
ms.date: 07/23/2020
ms.author: cstorega
...
ms.locfileid: "9539071"
---
# <a name="learning-catalog-for-dynamics-365-finance-administrators"></a>Výukový katalog pro správce Dynamics 365 Finance
...
| [Začínáme se Správou výdajů v Dynamics 365 Project Operations](/training/modules/get-started-expense-management/) | Modul Správa výdajů v Dynamics 365 Project Operations umožňuje organizacím sledovat a spravovat výdaje zaměstnanců. Správa výdajů vám umožňuje ukládat informace o platbách, importovat transakce kreditními kartami a sledovat peníze, které zaměstnanci utrácejí, když provedou výdaj vaší organizace. Pomocí Project Operations můžete také nastavit zásady výdajů, automatizovat schválení a zajistit efektivní obchodní proces. | Libovolná online školení vlastním tempem | 1 hodina |
| [Základy produktu Dynamics 365](/certifications/d365-fundamentals?wt.mc_id=learningredirect_certs-web-wwl) | Prokažte, že rozumíte Microsoft Dynamics 365: Power Platform; cloudové pojmy, možnosti licencování a možnosti nasazení a vydání. | Zkouška; náklady se liší podle oblasti. | |
