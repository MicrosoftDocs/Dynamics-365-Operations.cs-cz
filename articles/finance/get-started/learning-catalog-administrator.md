...
| [Začínáme se Správou výdajů v Dynamics 365 Project Operations](/learn/modules/get-started-expense-management/) | Modul Správa výdajů v Dynamics 365 Project Operations umožňuje organizacím sledovat a spravovat výdaje zaměstnanců. Správa výdajů vám umožňuje ukládat informace o platbách, importovat transakce kreditními kartami a sledovat peníze, které zaměstnanci utrácejí, když provedou výdaj vaší organizace. Pomocí Project Operations můžete také nastavit zásady výdajů, automatizovat schválení a zajistit efektivní obchodní proces. | Libovolná online školení vlastním tempem | 1 hodina |
