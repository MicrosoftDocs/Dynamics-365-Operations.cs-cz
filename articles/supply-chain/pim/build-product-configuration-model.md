...
Sada konfigurace funkcí produktu zahrnuje uživatelské rozhraní (UI) zajišťující vizuální přehled o struktuře modelu konfigurace výrobku a také deklarativní syntaxi omezení, která nemusí být kompilována. Z toho vyplývá, že společnosti, které chtějí podporovat konfigurační postup mohou začít mnohem snadněji. Následující části vysvětlují, jak návrhář produktu již nepotřebuje podporu vývojáře k sestavení modelu konfigurace produktu, jejímu otestování a jejímu uvolnění do prodejní organizace.
...
Následující vývojový diagram API zobrazuje přehled procesu.  

[![Vývojový diagram](./media/product_configuration_2.png)](./media/product_configuration_2.png)  

## <a name="configure-products"></a>Konfigurace produktů

### <a name="configure-one-or-more-products"></a>Konfigurace jednoho nebo více produktů

Produkty můžete konfigurovat z následujících míst:
...
### <a name="multiple-sites-and-intercompany-considerations"></a>Více pracovišť a mezipodniková pracoviště
