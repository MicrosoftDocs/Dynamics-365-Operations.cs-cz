...
description: Tento článek vysvětluje, jak pracovat s různými sestavami, které se týkají nebezpečných materiálů. Mnoho z těchto sestav je potřeba, abyste během přepravy a skladování zůstali v souladu s různými předpisy o nebezpečných materiálech.
author: t-benebo
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
