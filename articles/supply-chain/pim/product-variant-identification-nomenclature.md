...
description: Tento článek popisuje, jak nastavit názvosloví pro čísla produktu, které nahradí opravený formát [základní produkt - konfigurace – velikost – barva – styl].
author: t-benebo
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
