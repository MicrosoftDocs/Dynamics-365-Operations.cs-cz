...
description: Tento článek popisuje nastavení způsobu převodu měrné jednotky pro varianty produktu. Zahrnuje také příklad nastavení.
author: t-benebo
ms.date: 05/11/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8869626"
---
# <a name="unit-of-measure-conversion-per-product-variant"></a>Převod měrné jednotky pro variantu produktu

[!include [banner](../includes/banner.md)]

Tento článek popisuje nastavení způsobu převodu měrné jednotky pro různé varianty produktu.
