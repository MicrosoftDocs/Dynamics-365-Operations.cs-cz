...
description: Shrnutí nákladů a výpočty prodejní ceny jsou označovány jako výpočty kusovníku a spouštějí se ze stránky Výpočty. V tomto článku jsou informace o výpočtu BOM.
author: JennySong-SH
ms.date: 05/01/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8902795"
---
# <a name="bom-calculations"></a>Výpočty hodnoty BOM

[!include [banner](../includes/banner.md)]

Shrnutí nákladů a výpočty prodejní ceny jsou označovány jako výpočty kusovníku a spouštějí se ze stránky Výpočty. V tomto článku jsou informace o výpočtu BOM.
