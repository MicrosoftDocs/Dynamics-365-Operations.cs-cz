...
Ke skladovému účetnictví a účetnictví pro výrobu můžete přistupovat z pracovních prostor **Správa nákladů** a **Analýza nákladů**. Tyto pracovní prostory poskytují komplexní přehled aktuálního stavu, klíčové indikátory výkonnosti (KPI) a detekce odchylky. 
