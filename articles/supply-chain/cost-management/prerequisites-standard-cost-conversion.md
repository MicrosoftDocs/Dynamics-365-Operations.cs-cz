...
description: Tento článek popisuje úkoly prováděné před spuštěním převodu standardních nákladů.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
