...
description: V tomto článku je popsán základní postup při použití standardních nákladů.
author: JennySong-SH
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "9066723"
---
# <a name="prerequisites-for-standard-costs-overview"></a>Přehled předpokladů pro standardní náklady

[!include [banner](../includes/banner.md)]

V tomto článku je popsán základní postup při použití standardních nákladů. Následné kroky závisí na operacích dané společnosti. Kroky se například liší pro nevýrobní prostředí, výrobní prostředí bez postupů nebo výrobní prostředí s postupy. 
...
- [Jak nastavit standardní náklady pro přímé materiály ve financích a provozu](https://financefunction.tech/2018/06/07/how-to-set-up-standard-costs-for-direct-materials-in-dynamics-365-for-finance-and-operations)
- [Standardní přímé mzdové náklady ve financích a provozu](https://financefunction.tech/2018/07/16/standard-direct-labor-cost-in-dynamics-365-for-finance-and-operations)
