...
description: Tento článek popisuje účetní knihy Globálního účetnictví zásob, které jsou definovány kombinací měny, kalendáře, konvence a přidružení k právnické osobě.
author: JennySong-SH
ms.date: 06/18/2021
ms.topic: article
