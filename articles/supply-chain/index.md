...
description: Tato stránka uvádí seznam článků nápovědy a dalších zdrojů pro funkce aplikace Supply Chain Management.
author: kamaybac
ms.date: 09/15/2021
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "9475528"
---
# <a name="supply-chain-management-home-page"></a>Domovská stránka Supply Chain Management

[!include [banner](includes/banner.md)]

Tento článek uvádí seznam článků nápovědy a dalších zdrojů v Dynamics 365 Supply Chain Management.
...
Online kurzy a školení naleznete na [Dynamics 365 Supply Chain Management](/learn/browse/?products=dynamics-scm&resource_type=learning+path).
