...
- [Lean Manufacturing: příslib na základě ověření dostupné kapacity a plánování kanbanové úlohy](https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/white-papers/leanmanufkanban365opt/)
- [Výpočet kusovníku pomocí nákladového formuláře](https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/white-papers/365operationsbomcalsheet/)

## <a name="elearning-courses"></a>Kurzy elektronického vzdělávání

Ohledně online kurzů a školení se podívejte na [Dynamics 365 na Microsoft Learn](https://docs.microsoft.com/learn/dynamics365/).
