...
- **Nabídka mobilního zařízení konfigurovaná pro podporu příjmu nákladů**
    ...
    [Aplikace Dynamics 365 for Finance and Operations - Warehousing](install-configure-warehousing-app.md) pro mobilní zařízení podporuje následující procesy vytváření práce:
