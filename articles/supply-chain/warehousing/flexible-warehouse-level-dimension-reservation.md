...
2. V mobilním zařízení dokončete výdej a vklad práce.
    ...
    Množství **10** pro číslo dávky **B11** je nyní vyskladněno pro řádek prodejní objednávky a je vloženo do umístění **Baydoor**. V tomto okamžiku je vše připraveno k naložení na nákladní vůz a odesláno na adresu odběratele.

## <a name="exception-handling-of-warehouse-work-thas-has-order-committed-batch-numbers"></a>Zpracování výjimky práce skladu s čísly dávek potvrzených objednávkou
...
- Nová práce typu **Přesun zásob** se vytvoří pro nevyzvednuté množství **10** pro číslo dávky **B11**. Tato práce představuje přesun z místa **Baydoor** na registrační značku **LP33** v umístění **FL-001**. Stav je nastaven na **Zavřeno**.
