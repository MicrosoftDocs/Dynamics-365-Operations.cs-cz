...
ms.locfileid: "859752"
---
# <a name="warehouse-mobile-device-display-settings"></a>Nastavení zobrazení skladových mobilních zařízení

[!include [banner](../includes/banner.md)]

> [!NOTE]
> Tato funkce je zastaralá. Další informace naleznete v části [Odstraněné nebo zastaralé funkce](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
