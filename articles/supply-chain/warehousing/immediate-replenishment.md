...
description: Tento článek popisuje, jak můžete použít okamžité doplnění k doplňování zásob při selhání směrnice skladového místa pro přidělení zásob.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''
