---
title: Strategie doplnění
description: Tento článek poskytuje informace o strategiích doplňování a vysvětluje, jak můžete pomocí pole Strategie doplňování na řádcích šablon doplňování poptávky vlny vybrat, jak se doplnění provádí.
author: Mirzaab
ms.date: 10/29/2020
ms.topic: article
ms.prod: ''
