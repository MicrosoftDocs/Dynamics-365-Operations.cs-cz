...
---
# <a name="consolidate-shipments-by-using-shipment-consolidation-policies"></a>Konsolidace dodávek pomocí zásad dodávek zásilek

[!include [banner](../includes/banner.md)]

Následujíc scénáře vás provedou procesem konsolidace dodávek, který používá zásady konsolidace dodávek během automatizovaného a ručního uvolnění do skladu:
