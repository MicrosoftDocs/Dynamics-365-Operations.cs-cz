...
description: Tento článek popisuje způsob nakládání s mobilní skenovací aplikací Warehouse na zařízeních kompatibilních se systémem Android.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
...
Mobilní aplikace Řízení skladu byla testována s výběrem zařízení se systémem Android pro skenování čárových kódů. Tyto testy pokrývají pouze vzorek zařízení, která jsou dostupná na trhu.
