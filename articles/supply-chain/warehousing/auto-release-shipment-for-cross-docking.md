...
3. Zvolte **Nové**.
4. Do pole **Pořadové číslo** zadejte **1**.
5. Do pole **Název** zadejte název, například **Baydoor**.
...
13. Do pole **Název** zadejte název, například **Baydoor**.
14. Zvolte **Uložit**.
...
11. Otevřete okno aplikace a přihlaste se k aplikaci Dynamics 365 for Finance and Operations a spusťte práci ve skladu 51.
