...
description: Tento článek obsahuje informace o poplatcích za obalový materiál, které jsou zaplaceny recyklačním společnostem v určitých intervalech.
author: Mirzaab
ms.date: 02/19/2020
ms.topic: article
ms.prod: ''
