...
description: Tento článek popisuje, jak nastavit a spravovat uživatelské účty, které umožňují pracovníkům přihlásit se a používat aplikaci skladu.
author: Mirzaab
ms.date: 09/15/2021
ms.topic: article
ms.search.form: ''
