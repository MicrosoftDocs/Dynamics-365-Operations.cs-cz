...
description: Tento článek popisuje proces importu dat katalogu dodavatele.
...
5. Vyberte **Zásobování a zdroje** \> **Katalogy** \> **Katalogy dodavatele** a vytvořte katalog dodavatele. Soubory požadavku na údržbu katalogu (CMR), které jste přijali od dodavatele, jsou seskupeny v tomto katalogu.
