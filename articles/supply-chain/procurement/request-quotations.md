...
2.  Příjem a zaznamenání nabídek (odpovědí na požadavek na nabídku).
...
Na kartě Dodavatel případu požadavku na nabídku se zobrazí řádky s nejvyšším a nejnižším stavem pro určitého dodavatele. Když je přidán dodavatele a pokud dosud nebyly odeslány žádné řádky, je nejnižší a nejvyšší stav <strong>vytvořeno. </strong>Při odeslání požadavku na nabídku dodavateli se všemi řádky bude stav dvou řádků <strong>odesláno</strong>. Pokud jsou některé řádky v nabídce od dodavatele přijaty a jiné odmítnuty ostatní, odmítnuté řádky dostanou nejnižší stav, což je <strong>Odmítnuto</strong>, a u přijatých řádek se zobrazí nejvyšší stav, což je <strong>Přijato</strong>.
