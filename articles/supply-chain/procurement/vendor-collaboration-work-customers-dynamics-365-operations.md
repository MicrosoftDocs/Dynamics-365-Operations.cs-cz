...
Pracovní prostor **Potvrzení nákupní objednávky** umožňuje reagovat na nákupní objednávky (PO), která vám byly odeslány ke kontrole. Umožňuje také zobrazit informace o nákupních objednávkách, které čekají na akci od odběratele, a objednávkách, které byly potvrzeny, ale jsou stále otevřené.
...
> [!NOTE]
> Tato funkce je k dispozici pouze v případě, že je zapnutá konfigurace veřejného sektoru.

### <a name="bidding"></a>Nabídky

- Vyberte **Nabídka** a spusťte nabídky na požadavek na nabídku.
