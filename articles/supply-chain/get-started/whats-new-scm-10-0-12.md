...
description: Tento článek popisuje funkce, které jsou nové nebo se změnily v aplikaci Dynamics 365 Supply Chain Management 10.0.12.
author: kamaybac
ms.date: 05/29/2020
ms.topic: article
ms.prod: ''
...
Tento článek uvádí funkce, které jsou nové nebo se změnily v aplikaci Microsoft Dynamics 365 Supply Chain Management 10.0.12. Tato verze má číslo sestavení 10.0.507 a je k dispozici následujícím způsobem:
...
- [Hromadné nasazení pro Warehouse mobile app](/dynamics365-release-plan/2020wave1/dynamics365-supply-chain-management/mass-deployment-warehouse-mobile-app)<br> - Další informace naleznete v části [Instalace a připojení mobilní aplikace Řízení skladu](../warehousing/install-configure-warehouse-management-app.md).
...
Microsoft Dynamics 365 Supply Chain Management 10.0.12 zahrnuje aktualizace platformy. Další informace naleznete v tématu [Aktualizace platformy pro verze 10.0.12 finančních a provozních aplikací (srpen 2020)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-10-0-12.md).
