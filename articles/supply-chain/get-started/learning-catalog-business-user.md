...
| Obsah | popis | Formát | Délka |
|---------|-------------|--------|--------|
| [Nastavení správy technických změn pro Dynamics 365 Supply Chain Management](/training/paths/set-up-engineering-change-management/) | Dynamics 365 Supply Chain Management poskytuje zaměstnancům a organizacím možnost získat jednotný přehled zásob, skladu, výroby, servisu a logistiky s prediktivní analýzou, která převádí data na postřehy zajišťující lepší strategická rozhodnutí. | Bezplatný online výukový modul pro školení vlastním tempem | 4 hodin |
