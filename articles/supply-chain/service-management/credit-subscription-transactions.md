...
description: Tento článek ukazuje způsob připsání transakcí předplatného na stranu Dal.
author: sorenva
ms.date: 05/01/2018
ms.topic: article
ms.prod: ''
...
1.  Klikněte na uzel **Správa služeb** \> **Servisní zakázky** \> **Všechny servisní zakázky**.
...
[Transakce faktur odběru](invoice-subscription-transactions.md)
