...
> [!TIP]
> <P>Chcete-li přesunout připojený kusovník k jinému předmětu servisu nebo jej chcete odstranit, ve formuláři <STRONG>Předměty servisu</STRONG> klikněte na <STRONG>Funkce</STRONG> a potom klikněte na <STRONG>Přesunout kusovník služby</STRONG> nebo <STRONG>Odstranit kusovník servisu</STRONG>.</P>
