...
### <a name="enable-or-disable-readiness-checks-on-standard-products"></a>Zapnutí nebo vypnutí kontroly připravenosti standardních produktů

Tato funkce vyžaduje, aby byly na vašem systému zapnuty funkce *Správa technických změn* a *Kontroly připravenosti produktu*. Podrobnosti o tom, jak tyto funkce zapnout nebo vypnout, najdete v tématu [Přehled správy technických změn](product-engineering-overview.md).
