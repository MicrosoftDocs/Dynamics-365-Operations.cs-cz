...
description: Tento článek vysvětluje, jak můžete kromě uvolnění produktů společně s jejich technickými verzemi uvolnit kompletní produktové struktury. Tímto způsobem můžete zajistit, že technicky relevantní data o produktech lze snadno znovu použít v různých právnických osobách.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
