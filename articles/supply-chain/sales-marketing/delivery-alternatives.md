...
1. Vyberte **Podrobnosti řádku \> Doručení \> Alternativní doručení**.
...
Tento oddíl popisuje informace o alternativách dodání, které jsou k dispozici na všech kartách s náhledem stránky **Alternativní dodání**.

### <a name="the-product-fasttab"></a>Karta s náhledem Produkty

Na této kartě se zobrazuje souhrn produktu a podrobnosti o stávajícím řádku prodeje.

### <a name="the-delivery-alternatives-fasttab"></a>Karta s náhledem Alternativní dodání

Tato karta s náhledem zobrazí seznam alternativních dodání seřazených podle data příjmu. Nad seznamem můžete vybrat možnosti, na kterých budou založeny návrhy. Můžete také vybrat způsob dodání, který určuje dopravní dny. Existují tyto možnosti:
...
### <a name="the-availability-information-fasttab"></a>Informace o dostupnosti karty s náhledem

Informace na této kartě s náhledem souvisí s vybranou alternativní řádkou dodávky. Zobrazují se následující informace v závislosti na řízení data dodání pro řádku prodeje:
