...
description: Tento článek poskytuje přehled o integraci s Microsoft Dynamics 365 Field Service.
author: Henrikan
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
- Aplikace Dynamics 365 Finance a provoz verze 8.1.2 (prosinec 2018) byla vydána v prosinci 2018 a má číslo sestavení aplikace 8.1.195 s aktualizací platformy 22 (7.0.5095). 
