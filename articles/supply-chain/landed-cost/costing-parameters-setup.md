...
description: Když nastavujete modul Náklady za doručení, můžete definovat několik sad společných hodnot, které budou k dispozici, když vyberete konkrétní typy hodnot parametrů výpočtu nákladů v jiných částech aplikace. Tento článek vysvětluje postup nastavení těchto sad hodnot.
author: Weijiesa
ms.date: 12/07/2020
ms.topic: article
ms.prod: ''
