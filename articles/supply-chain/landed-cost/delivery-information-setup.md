...
description: Tento článek popisuje, jak nastavit informace o dodání pro modul nákladů za doručení.
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8895605"
---
# <a name="delivery-information-setup"></a>Nastavení informací o doručení

[!include [banner](../../includes/banner.md)]

Tento článek popisuje, jak nastavit informace o dodání pro modul **nákladů za doručení**.
