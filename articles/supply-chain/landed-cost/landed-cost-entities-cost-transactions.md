...
description: Toto téma poskytuje informace o entitách nákladových transakcí, které umožňují rozdělit hodnotu nákladů mezi obsah nákladové oblasti výběrem metody rozdělení.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
