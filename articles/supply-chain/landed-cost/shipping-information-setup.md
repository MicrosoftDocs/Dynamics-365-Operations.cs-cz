...
description: Tento článek popisuje, jak nastavit informace o přepravě pro modul nákladů za doručení.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
Tento článek popisuje, jak nastavit informace o přepravě pro modul **nákladů za doručení**.
