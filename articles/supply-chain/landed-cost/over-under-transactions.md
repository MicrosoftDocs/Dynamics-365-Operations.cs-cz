...
description: Tento článek poskytuje informace, které vám pomohou nastavit podrobnosti zásad pro transakce nadměrného nebo nedostatečného množství, takže systém může určit, jak spravovat nadměrné zpracování a nedostatečné zpracování zboží v době přijetí.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
