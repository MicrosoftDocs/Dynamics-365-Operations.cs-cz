---
title: Entita aktivit kontejneru
description: Toto téma poskytuje informace o aktivitách kontejneru, které se používají ke sledování postupu přepravních kontejnerů.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
