...
Následující obrázek představuje matici, která shrnuje, které kalendáře se použijí při výpočtu pojistných dob. Následující zkratky a barvy se používají k označení, kde je zadán každý typ kalendáře:
