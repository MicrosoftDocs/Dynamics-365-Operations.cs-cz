...
description: Tento článek vysvětluje, jak se nakládá se záporným množstvím na skladě.
author: t-benebo
ms.date: 07/22/2021
ms.topic: article
ms.prod: ''
...
1. Hlavní plánování agreguje množství na skladě na nejnižší úrovni dimenzí disponibility. (Pokud například *skladové místo* není dimenze disponibility, hlavní plánování agreguje množství na skladě na úrovni *skladu*.)
