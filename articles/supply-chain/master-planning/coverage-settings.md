---
title: Nastavení disponibility
description: Tento článek poskytuje informace o nastavení disponibility, které hlavní plánování používá k výpočtu požadavků na položky.
author: t-benebo
ms.date: 09/13/2019
ms.topic: article
ms.prod: ''
