...
Další informace o nastavení dodavatelů pro použití dodavatelské spolupráce naleznete v tématu [Správa uživatelů dodavatelské spolupráce](../procurement/manage-vendor-collaboration-users.md).
