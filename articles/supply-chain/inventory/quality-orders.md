...
description: Tento článek popisuje, jak ručně nebo automaticky vytvářet objednávky kvality a jak s nimi pracovat při provádění kontrol a zaznamenávání výsledků testů v Microsoft Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857772"
---
# <a name="quality-orders"></a>Objednávky kvality

[!include [banner](../includes/banner.md)]

Tento článek popisuje, jak ručně nebo automaticky vytvářet objednávky kvality a jak s nimi pracovat při provádění kontrol a zaznamenávání výsledků testů v Microsoft Dynamics 365 Supply Chain Management.
...
1. Zvolte **Nové**.
1. V dialogovém okně **Objednávky kvality** vyberte v poli **Typ odkazu** odkaz zásob, se kterými bude vaše objednávka kvality souviset. Popis typů odkazů, které jsou k dispozici pro výběr, najdete v části [Typy odkazů objednávek kvality](#ref-types) dále v tomto článku.
...
Chcete-li ručně vytvořit objednávky kvality a zobrazit všechny stávající objednávky kvality, přejděte na možnost **Řízení zásob \> Periodické úkoly \> Správa kvality \> Objednávky kvality**. Zbývající části tohoto článku poskytují další informace o tom, jak pracovat se stránkou **Objednávky kvality**.
