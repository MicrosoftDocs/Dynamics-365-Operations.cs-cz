...
description: Tento článek popisuje, jak vytvořit testy, které bude možné použít pro objednávky kvality v softwaru Microsoft Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857598"
---
# <a name="quality-management-tests"></a>Testy správy kvality

[!include [banner](../includes/banner.md)]

Tento článek popisuje, jak vytvořit testy, které bude možné použít pro objednávky kvality v softwaru Microsoft Dynamics 365 Supply Chain Management.
