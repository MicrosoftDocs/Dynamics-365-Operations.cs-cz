...
Další informace o každém z těchto prvků a o tom, jak se jejich hodnoty nacházejí, najdete ve zbývajících částech tohoto článku.
...
1. Proveďte některou z následujících akcí:
    - Přejděte na **Správa přepravy \> Plánování \> Zásilky \> Všechny zásilky** a vyberte zásilku, pro kterou chcete dokument vytisknout.
