...
- V poli **Zobrazení** vyberte standardní zobrazení, které se zobrazí při otevření formuláře **Zobrazení majetku** (**Správa majetku** > **Společné** > **Majetek** > **Zobrazení majetku**).
...
>   - objektech nastavených na plánech nebo pořadích údržby  
...
Vyberte typy dokumentů, které mají být k dispozici pro tisk příloh souvisejících se sestavou pracovního příkazu. To se provádí kliknutím na typ dokumentu v části **Dostupné** a kliknutím na tlačítko se ![šipkou vpřed](media/15-setup-for-objects.png). Pokud chcete odstranit vybraný typ dokumentu, vyberte typ dokumentu v části **Vybrané** a klikněte na tlačítko se ![šipkou zpět](media/16-setup-for-objects.png).
