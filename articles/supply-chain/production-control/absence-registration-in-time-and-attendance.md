...
description: Tento článek vysvětluje, jak pracovat s registracemi absence v modulu Čas a docházka.
...
Tento článek popisuje koncept absence a vysvětluje, jak pracovat s absencí v modulu Čas a docházka.
