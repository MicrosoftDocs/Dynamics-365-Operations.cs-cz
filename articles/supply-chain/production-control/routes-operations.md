...
description: Tento článek obsahuje informace o postupech a operacích.
...
ms.locfileid: "8856012"
---
# <a name="routes-and-operations"></a>Postupy a operace

[!include [banner](../includes/banner.md)]

Tento článek obsahuje informace o postupech a operacích. Postup definuje proces pro výrobu produktu nebo varianty produktu. Popisuje jednotlivé kroky (operace) ve výrobním procesu a pořadí, ve kterém je nutné je provádět. U každého kroku postup také definuje požadované provozní prostředky, čas, který je nutný k přípravě a provedení operace, a způsob výpočtu nákladů.
