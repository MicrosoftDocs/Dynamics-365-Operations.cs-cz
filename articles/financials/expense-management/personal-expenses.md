...
# <a name="personal-expenses-on-an-expense-report"></a>Osobní výdaje ve vyúčtování výdajů
...
V aplikaci Microsoft Dynamics 365 for Finance and Operations existují dvě metody pro zpracování osobních výdajů pracovníka:
