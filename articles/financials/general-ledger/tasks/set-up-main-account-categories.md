...
1. Klepněte na Připojit hlavní účty.
2. V seznamu vyberte hlavní účty, které mají být přiřazeny ke kategorii hlavního účtu.
    * Přiřazením hlavních účtů do kategorie hlavních účtů budou nahromaděny zůstatky účtů, když tato kategorie se používá k vytváření finančních sestav a analýzy.  
