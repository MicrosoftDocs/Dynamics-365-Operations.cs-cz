...
---
# <a name="register-a-vendor-vat-id"></a>Zaregistrování DIČ dodavatele
...
Dokončení této procedury vyžaduje nastavení hodnot DIČ. Postup se vztahuje na všechny evropské země/oblasti. Procedura byla vytvořena za použití ukázkových dat společnosti DEMF s primární adresou právnické osoby v Německu. Tato procedura je určena pro správce správy dat, manažera závazků nebo manažera pohledávek. Tato procedura je určena pro funkci, která byla přidána do aplikace Dynamics 365 for Operations verze 1611.
