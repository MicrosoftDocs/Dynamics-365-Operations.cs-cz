...
# <a name="add-new-location-roles-and-party-relationship-types"></a>Přidání nových rolí místa a typů vztahu strany 

## <a name="add-new-location-roles"></a>Přidání nových rolí umístění
...
## <a name="add-new-party-relationship-types"></a>Přidání nových typů vztahu strany 
