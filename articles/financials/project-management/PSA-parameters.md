...
description: "Toto téma vysvětluje, jak nakonfigurovat způsob zadávání výchozích dat při integraci aplikace Microsoft Dynamics 365 for Project Service Automation s aplikací Microsoft Dynamics 365 for Finance and Operations."
author: KimANelson
manager: AnnBe
ms.date: 07/20/2018
ms.topic: article
...
Na stránce **Parmetry integrace Project Service Automation** můžete nakonfigurovat způsob zadávání výchozích dat při integraci aplikace Microsoft Dynamics 365 for Project Service Automation s aplikací Microsoft Dynamics 365 for Finance and Operations. Následující pole musí být nastaveny pro projekty, aby byly synchronizovány úspěšně z aplikace Project Service Automation do aplikace Finance and Operations.
