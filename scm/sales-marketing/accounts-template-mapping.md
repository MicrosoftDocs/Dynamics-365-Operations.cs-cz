...
- **CustomerGroupId** musí být aktualizován na platnou hodnotu v modulu Finance and Operations. Lze určit výchozí hodnotu nebo můžete nastavit hodnoty pomocí mapování hodnot. Výchozí hodnota šablony je **10**.
- **Kód země/oblasti pro adresu** je v aplikaci Finance and Operations vyžadován. Abyste zabránili chybám synchronizace, můžete určit výchozí hodnotu. Tato výchozí hodnota se pak použije, pokud pole v aplikaci Sales zůstane prázdné.
