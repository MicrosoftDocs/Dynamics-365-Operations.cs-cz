...
Konečné termíny zadání objednávky se používají jako vstup pro příslib objednávek. Proto pomáhají spravovat očekávání odběratelů ohledně dodávky objednávky. Odběratele mohou například vidět, že pokud u vás podají objednávky před určeným časem, zajistíte expedici zboží ve stejný den. Pokud se tento termín vůbec nedostanou, mohou očekávat dodávky pouze na následující pracovní den. Nastavení konečných termínů zadání objednávek na základě funkce skladu a expedice plány dopravce.  
...
Konečný termín pro zadání objednávky v úterý byl nastaven na 16:00. K určitému úterý v 17:00 se pokusíte nastavit aktuální datum jako datum dodání. (Všimněte si, že neexistuje žádná doba realizace v tomto příkladu.) Pokud **řízení data dodání** políčko zaškrtnuto, zobrazí se upozornění oznamující, že datum není platné. Toto upozornění se zobrazí na stránce **Dostupná data expedice a příjmu**, kde můžete vybrat alternativní data.
...
| Den v týdnu             | A: pořadí konečné termíny zadání (PST) | B: pořadí konečné termíny zadání (EST) |
|-----------------------------|--------------------------------|--------------------------------|
| Pondělí                      | 13:00                          | 14:00                          |
| Úterý                     | 13:00                          | 14:00                          |
| Středa                   | 13:00                          | 14:00                          |
...
| Web A: PST         | Web A: MST        | Web b EST           | Web b MST        |
|---------------------|--------------------|-----------------------|--------------------|
