...
**Poznámka:** v dřívějších verzích prodejní smlouvy byly označovány jako hromadné prodejní objednávky.
...
| Hodnota CurrencyDiscount, percentDiscountUnit, pricePrice, unitNet | Jestliže změníte hodnotu v některém z těchto polí a označíte pole **Cena a sleva je pevná** u řádku související prodejní smlouvy, zobrazí se zpráva s dotazem, zda chcete uložit změny. Klepněte na tlačítko **Ano** Chcete-li odebrat odkaz na řádek prodejní smlouvy a Přepočítat cenu. Klepněte na tlačítko **č** Chcete-li odebrat odkaz na řádek prodejní smlouvy bez přepočtu ceny.                                                                   |
| Čistá částka                                                        | Pokud zadáte částku přesahující částku, která je specifikována na řádku prodejní smlouvy, kde je označeno pole **Max je vynuceno**, zobrazí se zpráva s dotazem, zda chcete uložit upravené množství. Klepněte na tlačítko **Ano** Chcete-li odebrat odkaz na řádek prodejní smlouvy a Přepočítat cenu. Klepněte na tlačítko **č** Chcete-li odebrat odkaz na řádek prodejní smlouvy bez přepočtu ceny.                                                                 |
...
Když odběratel vrací produkt objednané z prodejní smlouvy, můžete 365 Microsoft Dynamics pro operace najít a automaticky aktualizovat související prodejní smlouva závazek tak, aby odrážely změny v množství nebo částka. Vytvořením vratky na základě původní prodejní objednávky, která je propojena s prodejní smlouvou, vytvoříte vztah mezi závazkem prodejní smlouvy, řádkem prodejní objednávky a fakturou vratky.  
...
V některých situacích, kde jsou prodejní objednávky vytvářeny nepřímo například při vytváření dobropisu nebo mezipodnikové prodejní objednávky, můžete určit, zda 365 Microsoft Dynamics pro operace automaticky vyhledá příslušné prodejní smlouvy.
