...
-   Ujistěte se, že **podporované desetinné hodnoty** pro JM odpovídají vašim požadavkům definovaným ve službě **CDS -\> Cíl**. Pokud požadujete různé hodnoty na MJ, lze to provést pomocí atributu **ValueMap** z jednotky, například [Ks : 0] & [Libra : 2].

    -   Výchozí hodnota šablony je 0.
