...
Kusovník definuje součásti, které jsou potřebné pro výrobu produktu. Komponenty mohou být suroviny, polotovary a látky. V některých případech může kusovník odkazovat na služby. Nejčastěji však kusovníky popisují *materiálové zdroje*, které jsou vyžadované.  
