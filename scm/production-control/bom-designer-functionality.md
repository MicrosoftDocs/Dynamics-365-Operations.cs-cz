---
title: "Funkce pro návrh kusovníku"
...
<td>Pokud je vybraný hotový produkt základním produktem, můžete definovat aktivní dimenze produktu pro hlavní výběr.<strong>Poznámka:</strong> Pokud otevřete návrhář kusovníku pro produkt, který není základním produktem, nelze v dialogovém okně <strong>Filtr</strong> vybrat žádné dimenze produktu.</td>
</tr>
<tr class="even">
<td>Lokalita</td>
...
<li>Pokud je zásada nastavena na <strong>vybrané/aktivní nebo vybrané</strong>, verze Kusovníku nebo verze postupu můžete vybrat klepnutím na <strong>Kusovníku</strong>&gt;<strong>verze Kusovníku</strong> nebo <strong>postupu</strong>&gt;<strong>verzí postupu</strong>.</li>
</ul></td>
</tr>
<tr class="even">
<td>Datum verze</td>
...
Použijete-li návrhář kusovníku ke kontrole nebo úpravě kusovníků, které se skládají z jedné nebo více úrovní fiktivních kusovníků, pak postup, který je přidružen k nejvyšší položce, obvykle zahrnuje celou hierarchii kusovníku. Pro zjednodušení přehledu, můžete uzamknout postupu nejvyšší úrovně v zobrazení klepnutím na **zobrazení**&gt;**uzamknout postup**. Postupu odemknout, klepněte na tlačítko **zobrazení**&gt;**postupu odemknout**.

## <a name="adding-and-editing-boms-and-bom-lines"></a>Přidávání a úprava kusovníků a řádků kusovníku
Použití ** řádky Kusovníku ** nebo **Kusovníku** funkce Upravit řádky Kusovníku nebo Kusovník. Když vyberete uzel ze stromu, typ uzlu určí, které z funkcí budou k dispozici.

| Funkce                            | popis                                                                                               | Typ a podmínky uzlu                                                                                                                                                                                                                                                                       |
|-------------------------------------|-----------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Řádky Kusovníku &gt;úpravy                 | Otevřete dialogové okno, ve kterém můžete upravit atributy řádku kusovníku.                                             | Tato funkce je k dispozici, pokud je vybrán uzel řádku kusovníku.                                                                                                                                                                                                                                   |
...
| Řádky Kusovníku &gt;přidat komponentu Kusovníku | Otevře dialogové okno, ve kterém můžete vybrat variantu produktu k zahrnutí na konci vybraného kusovníku.       | Tato funkce je k dispozici, pokud má vybraný uzel zvolený kusovník. Pokud tato funkce není dostupná, verze kusovníku možná chybí pro vybranou variantu položky. V takovém případě po klepnutí **Kusovníku**&gt;**vytvoření verze** Chcete-li vytvořit chybějící verze vybraného uzlu. |
| Řádky Kusovníku &gt;přidat po řádku       | Otevře dialogové okno, ve kterém můžete vybrat variantu produktu k zahrnutí za vybraným řádkem kusovníku.          | Tato funkce je k dispozici, pokud je vybrán uzel řádku kusovníku.                                                                                                                                                                                                                                   |
| Kusovník &gt;vytvoření verze             | Vytvoří nový kusovník nebo verzi kusovníku pro variantu produktu vybraného uzlu.                             | Tato funkce je k dispozici, pokud je vybraný uzel řádku kusovníku spojen s položkou, která má typ výroby **Kusovník** nebo **Receptura**.                                                                                                                                                  |
...
| Kusovník &gt;kontrola                      | Ověří a zkontroluje vybraný kusovník.                                                                      | Tato funkce je k dispozici, pokud vybraný uzel souvisí s verzí kusovníku.                                                                                                                                                                                                         |
