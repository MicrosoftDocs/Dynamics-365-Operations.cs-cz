...
description: "Toto téma popisuje klíčové pojmy a termíny, které je třeba pochopit a nakonfigurujte provádění výroby."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Toto téma popisuje klíčové pojmy a termíny, které je třeba pochopit a nakonfigurujte provádění výroby. 

Provádění výroby je určeno především pro výrobní společnosti. Zaměstnanci mohou registrovat čas a spotřebu zboží ve výrobních úlohách pomocí stránky **Registrace úlohy**. Všechny registrace jsou schváleny a jsou později převedeny na příslušné moduly. Souvislá schvalování a převod registrací umožňuje správcům snadno sledovat skutečné náklady pro výrobní zakázky.
...
| Termín                          | popis                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Provádění výroby       | Funkce, která slouží k evidenci času, spotřeby materiálu, náklady na výrobní úlohy, projektech a nepřímých aktivit. Registrace je prováděna u klienta registrace provádění výroby.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
-   **Registrace poplatků projektu a položek projektu** (k dispozici čas a docházka) – pracovníci mohou registrovat poplatků (náklady), které jsou přidruženy k projektu v deníku poplatků projektu, například poplatků za ujeté kilometry a most. Zaměstnanci lze také zaregistrovat spotřebu položky v projektech. To se provádí v deníku položek projektu.
