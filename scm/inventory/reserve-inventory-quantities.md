...
| Rezervace prodeje zboží  | Určuje, zda je rezervace položek ruční nebo automatická. Pokud je rezervace automatická, zásoby se rezervují po vytvoření řádků objednávky. Rezervace je možné porvádět na úrovni čísla položky pro kusovníky (možnost **Automatické**) nebo pro jednotlivé prvky kusovníku (Možnost **Rozpad**). Výchozí hodnota pro **položky rezervace prodejní** mohou být děděny z **parametry pohledávek.** Na této stránce, je hodnota v poli Rezervace v **prodej výchozí hodnoty****části** na **Obecné** kartu. |
