...
Můžete uložit informace na **podrobnosti** jako soubor XML klepnutím na kartu **Export** pod *** trasování *** akce v podokně akcí. Kromě podrobností o sledování obsahuje soubor XML kritéria sledování, nadřazený uzel a množství na skladě. Možnost uložení podrobností o sledování je užitečné, například pokud mají být připojeny informace o objednávce kvality nebo jiná dokumentace o kompatibilitě. Můžete určit, kde je soubor uložen. Chcete-li zobrazit soubor ihned, vyberte možnost **Zobrazit dokument**. **Poznámka:** Soubor se uloží vždy, i v případě, že ho chcete pouze zobrazit. Ve výchozím nastavení se otevře soubor XML v okně prohlížeče. To lze změnit klepnutím pravým tlačítkem myši na soubor, výběrem volby **Otevřít v programu** a potom výběrem programu, který se má použít k zobrazení obsahu.
...
## <a name="can-i-trace-coproducts-and-byproducts"></a>Můžete sledovat coproducts a vedlejší produkty?
