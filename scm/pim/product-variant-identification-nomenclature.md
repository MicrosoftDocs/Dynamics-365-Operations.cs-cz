...
[Vytvoření názvosloví čísel produktů pro předdefinované varianty produktu](http://ax.help.dynamics.com/en/wiki/create-a-product-number-nomenclature-for-predefined-product-variants/)

[Vytvoření názvosloví čísel produktů pro nakonfigurované varianty produktu](http://ax.help.dynamics.com/en/wiki/create-a-product-number-nomenclature-for-configured-product-variants/)
