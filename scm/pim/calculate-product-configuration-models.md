---
title: "Výpočty pro modely konfigurace produktu, nejčastější dotazy"
description: "Tento článek popisuje výpočty pro modely konfigurace produktu a vysvětluje, jak použít výpočty a omezení."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="calculations-for-product-configuration-models-faq"></a>Výpočty pro modely konfigurace produktu, nejčastější dotazy

[!include[banner](../includes/banner.md)]


Tento článek popisuje výpočty pro modely konfigurace produktu a vysvětluje, jak použít výpočty a omezení.
...
**Výraz:**\[-li barvu == "Green" 1.5, 1.0\]  

Při konfiguraci položky, délka šňůry je nastavena na **1.5** Pokud zadáte **zelená** jako hodnotu atribut barvy. Pokud zadáte libovolnou jinou barvu, délka je nastavena na **1,0**. Vzhledem k tomu, že jsou výpočty jednosměrné, však výpočet nenastaví hodnotu atributu barva na **Zelená** při zadání délky **1,5**.
...
## <a name="how-do-i-set-a-target-attribute-as-hidden-or-readonly"></a>Jak nastavit cílový atribut jako skrytý nebo jen pro čtení?
Pokud chcete nastavit atribut jako skrytý nebo jen pro čtení, postupujte takto.

1.  Klepněte na tlačítko **řízení informací o produktech**&gt;**běžné**&gt;**modely konfigurace produktu**.
...
Č. Hodnoty, které jste nastavili při konfiguraci produktu jsou hodnoty, které jsou používány. Výpočet, ke kterému dochází při změně vstupních hodnot ve výpočtu, nemůže přepsat hodnoty, které zadáte pro konkrétní atribut.
...
-   Hodnoty, které jsou vráceny výpočem, jsou mimo doménu atributu. Je například celé číslo od \[1..10\] vypočtený na hodnotu 0.
