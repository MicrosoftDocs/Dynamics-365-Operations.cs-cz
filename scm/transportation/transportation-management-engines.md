...
| Parametr             | Popis                                                                                                                                                                                                                                                                                                                                                                      |
|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *RateBaseAssigner*    | Typ rozhraní .NET, který interpretuje data pro přiřazení základní sazby v konkrétním schématu. Hodnota parametru syntaxe se skládá ze dvou segmentů odděleny svislé pruhu ()|). První segment obsahuje název sestavení, který definuje typ přiřazujícího uživatele. Druhý segment definuje plně kvalifikovaný název typu přiřazujícího uživatele. Jedná se o obor názvů typu. |
| *MileageEngineCode*   | Modul pro výpočet kilometrovného, který identifikuje záznam v modulu kilometrovného v databázi Microsoft Dynamics 365 for Operations.                                                                                                                                                                                                                                                             |
| *ApportionmentEngine* | Modul pro obecný výpočet, který identifikuje výpočet rozdělení nákladů v databázi Microsoft Dynamics 365 for Operations.                                                                                                                                                                                                                                                              |
...
-   Definovat tyto informace v **Správa přepravy**&gt;**nastavení** na **základní typ sazby** stránky.
