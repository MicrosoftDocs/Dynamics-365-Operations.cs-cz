...
V následujícím scénáři byl zaúčtován finančně aktualizovaný příjem a výdej. Během skladové uzávěrky systém vyrovná příjem přímo oproti výdeji a pro daný výdej nebude nutné provádět žádnou úpravu nákladové ceny. Následující obrázek znázorňuje tyto transakce:
...
V systému bude pro den 1 použita metoda přímého vyrovnání. **Den 2:**
...
V systému bude pro den 2 použita metoda přímého vyrovnání. **Den 3:**
