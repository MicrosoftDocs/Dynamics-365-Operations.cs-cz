...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Zkontrolujte a změňte nové nákladové verze pro záznam převodu
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. Určete položky, které chcete převést na standardní náklady.
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. Zadejte nebo vypočítat čekající standardní náklady pro každou položku, která je převáděna.
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. Zkontrolujte a vyřešte všechny problémy pro položky, které jsou převáděny
...
## <a name="6-change-the-status-of-the-conversion-record-to-ready"></a>6. změníte stav záznamu převodu na připraven
...
## <a name="7-back-up-the-database-before-conversion"></a>7. zálohování databáze před převodem
Záloha umožňuje obnovit databázi v případě, že během převodu dojde k chybám.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. převod proveďte při převodu záznamu má stav připraven
...
## <a name="9-validate-and-reconcile-the-inventory-values-for-the-converted-items"></a>9. ověření a sloučit hodnoty zásob pro převedené položky.
