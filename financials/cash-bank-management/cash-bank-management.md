...
description: "Pomocí nástroje Správa hotovosti a banky spravujte bankovní účty a finanční nástroje právnické osoby, které jsou přidruženy k těmto bankovním účtům."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
ms.sourcegitcommit: dc44c5e1081733954f0e0b018f429ac915c5010e
...
-   [Akreditivy a kolekce importu](letters-of-credit-import-collections.md)
...
-   [Nastavení importu rozšířené bankovního odsouhlasení](set-up-advanced-bank-reconciliation-import-process.md)
...
-   [Nastavení sady pravidel párování pro odsouhlasení banky](set-up-bank-reconciliation-matching-rules.md)
...
-   [Vytvoření faktury dodavatele pomocí návrhu platby](../accounts-payable/create-vendor-payments-payment-proposal.md)
