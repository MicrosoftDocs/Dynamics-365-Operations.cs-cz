...
Použití **přecenění cizí měny** stránky v **pravidelné úlohy** k přecenění otevřených transakcí. Proces můžete spustit v reálném čase nebo naplánovat jeho spuštění použitím dávky. Při definování nastavení pro proces přecenění, ujistěte se, chcete-li ověřit, zda chcete vytisknout sestavu výsledků. Po dokončení procesu nemůže být provedení sestavu přecenění. Pokud generujete sestavu přecenění cizí měny, zobrazí se v ní různé zůstatky na úrovni odběratele/dodavatele a úrovni měny:
...
Při každém spuštění přecenění cizí měny je vytvořen záznam. Ze záznamu na stránce **Zhodnocení cizí měny** vyberte **Transakce** pro zobrazení podrobného seznamu transakcí, které byly vytvořeny z důvodu přecenění. Každý doklad transakce představuje otevřené transakce, které byly přehodnoceny. Otevřené transakce byla oceňují více než jednou, zobrazí se dva záznamy, které používají stejný doklad. Jeden záznam bude pro změnu předchozího nerealizovaný zisk nebo ztrátu a ostatní záznamy budou pro nové nerealizovaný zisk nebo ztrátu. Spusťte proces přecenění klepnutím na tlačítko **Přecenění cizí měny**. Definujte vhodné nastavení pro následující parametry:
