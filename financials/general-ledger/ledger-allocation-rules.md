...
-   **Zdroj** – tato součást slouží uživateli k určení zdrojových dat pro přidělení. Rozdělení může být založen na zůstatky hlavní knihy (**zdroj dat** = **knihy**) nebo pevné částky (**zdroj dat** = **pevnou hodnotu**). Při nastavení možnosti **Zdroj dat** na hodnotu **Hlavní kniha** musí být definována kritéria filtru zdroje pro pravidlo přidělení hlavní knihy (například pro výdaje na reklamu).
