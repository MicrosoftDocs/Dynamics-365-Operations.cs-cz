...
Jakmile vstoupíte do deníku, můžete kliknout na volbu **Časové rozlišení hlavní knihy** v nabídce **Funkce**. Až poté vyberte schéma časového rozlišení, se zobrazí základní částka v deníku, která se rozloží v období podle určení schématu časového rozlišení. Například pokud platíte pojištění zaměstnance za celý rok v lednu a částka je 12 000, můžete musí rozpoznat tyto náklady každý měsíc. Můžete vybrat počáteční datum. Můžete také určit, zda je částka, která je časově rozlišená, založená na účtu nebo protiúčtu. Po provedení výběru klepněte na tlačítko **transakce** ke zobrazení všech transakcí, které byly vytvořeny podle schématu časového rozlišení. Například pokud rozložení 12 000 v pojištění výdajů za rok, uvidíte 1 000 za každý měsíc. Po zaúčtování deníku, můžete zobrazit transakce pomocí **doklad transakcí** dotaz na stránce. Schématu časového rozlišení nelze použít (například když zapojen faktury prodejní objednávky nebo faktury nákupní objednávky), můžete zaúčtování částky zálohy a debetní částka výdajů. Můžete vybrat **Protiúčet**, když nasazujete schéma časového rozlišení.
