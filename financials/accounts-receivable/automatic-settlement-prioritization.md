...
Při vyrovnání plateb pomocí faktur a ostatních transakcí, máte k dispozici dvě možnosti. Můžete ručně vybrat transakce k vyrovnání nebo 365 Microsoft Dynamics pro operace lze automaticky vybrat transakce pomocí funkce Automatické vyrovnání. Můžete také upravit, jak je automatické vyrovnání zpracováno, pomocí možnosti **Určit prioritu vyrovnání**. Tyto možnosti jsou parametry vyrovnání, které jsou definovány v části **parametry pohledávek** stránky. Způsob automatického vyrovnání transakcí se může lišit v závislosti na metodě, kterou používáte pro automatické vyrovnání. K dispozici jsou následující metody:
...
| Oznámení úroků | 15. října  | 7:00   |                     |                    | Tohoto oznámení úroků pro fakturu, která je 1 a 2 faktury. Částka se počítá jako 2 % úrok na částky, které jsou 30 nebo více dnů po splatnosti. Například 0,02 × (100,00 + 250,00) = 7,00. |

## <a name="userdefined-settlement-priority"></a>Priorita vyrovnání UserDefined
...
|---------------|------------|---------|--------------------------------|------------------|---------|----------|
| Oznámení úroků | 10/15/2015 |         | 7:00                           | 7:00             | 0,00    | USD      |
...
| Oznámení úroků | 10/15/2015 |         | 7:00                           | 0,00             | 0,00    | USD      |
