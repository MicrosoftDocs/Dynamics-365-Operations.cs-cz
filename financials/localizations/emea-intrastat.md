...
### <a name="3-use-the-intrastat-journal-to-report-information-about-trade-among-eu-countriesregions"></a>3. pomocí deníku Intrastat sestavy informací o obchodu mezi zeměmi/oblastmi EU

Každý měsíc vykazujete pro statistické účely informace o obchodu mezi zeměmi/oblastmi EU. Můžete vytisknout sestavy systému Intrastat na základě nastavení **Mapování formátu sestavy** na stránce **Parametry zahraničního obchodu**. Také můžete vytvořit elektronický soubor na základě nastavení **Mapování formátu souboru** na stránce **Parametry zahraničního obchodu**. Další informace o systému Intrastat naleznete nezbytné součásti sestav, včetně úlohy nahrávání vykazování Intrastat:

-   Generovat prohlášení systému Intrastat EU,
-   Převod transakcí do Intrastatu,
-   Určení adresy přepravních dokladů pro transakce v rámci obchodu uvnitř Společenství.

## <a name="prerequisites"></a>Předpoklady
V následující tabulce jsou uvedeny požadavky pro vykazování v systému Intrastat.
