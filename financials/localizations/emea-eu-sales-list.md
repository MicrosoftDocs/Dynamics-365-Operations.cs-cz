...
<td>Primární adresa právnické osoby musí být v členském státě EU. Na <strong>právnické osoby</strong> stránku (klepněte na tlačítko <strong>Správa organizace</strong>&gt;<strong>organizace</strong>&gt;<strong>právnické osoby</strong>), vyberte právnickou osobu. Na pevné záložce <strong>Adresy</strong> vytvořte adresu, vyberte zemi/oblast a ostatní součásti adresy a označte adresu jako <strong>Primární</strong>. Na pevné záložce <strong>Daňová registrace</strong> v poli <strong>Daňové registrační číslo</strong> zadejte daňové identifikační číslo (DIČ) vaší společnosti.</td>
</tr>
<tr class="even">
<td><strong>Nastavení:</strong> Parametry identifikace osvobození od daně</td>
<td>Nastavit parametry identifikační osvobození od daně na <strong>parametry země</strong> stránku (klepněte na tlačítko <strong>daně</strong>&gt;<strong>nastavení</strong>&gt;<strong>DPH</strong>&gt;<strong>parametry země</strong>). Pro jednotlivé země/oblasti, kde máte protistrany, vytvořte záznam na stránce a zadejte následující informace:
<ul>
...
<td>Vytvořit čísla osvobození od daně pro vaší protistrany na <strong>čísla osvobození od daně</strong> stránku (klepněte na tlačítko <strong>daně</strong>&gt;<strong>nastavení</strong>&gt;<strong>DPH</strong>&gt;<strong>čísla osvobození od daně</strong>). Pro každé číslo osvobození od daně vytvořte záznam na stránce a zadejte následující informace:
<ul>
...
<td>Nastavit daňové registrační informace pro vaší protistrany buď <strong>všechny zákazníky</strong> stránky (klepněte na tlačítko <strong>prodeje a marketingu</strong>&gt;<strong>zákazníci</strong>&gt;<strong>všechny zákazníky</strong>, vyberte záznam zákazníka a potom klepněte na tlačítko <strong>možnosti</strong>&gt;<strong>změnit zobrazení</strong>&gt;<strong>zobrazení podrobností</strong>) nebo <strong>dodavatele</strong> stránky (klepněte na tlačítko <strong>zásobování a zdroje</strong>&gt;<strong>dodavatelů</strong>&gt;<strong>dodavatelů</strong>, vyberte záznam dodavatele a potom klepněte na tlačítko <strong>možnosti</strong>&gt;<strong>změnit zobrazení</strong>&gt;<strong>zobrazení podrobností</strong>). Na pevné záložce <strong>Faktury a dodávky</strong> v poli <strong>Číslo osvobození od daně</strong> vyberte číslo daňové registrace.</td>
</tr>
<tr class="odd">
<td><strong>Nastavení: </strong>DPH</td>
<td>Nastavení kódů DPH zahrnout <strong>seznamu prodeje v EU</strong> zprávu o <strong>kódy DPH</strong> stránky (klepněte na tlačítko <strong>daně</strong>&gt;<strong>nepřímých daní</strong>&gt;<strong>DPH</strong>&gt;<strong>kódy DPH</strong>). Na pevné záložce <strong>Nastavení sestavy</strong> pro každý kód DPH, který bude zahrnut v sestavě, zrušte zaškrtnutí políčka <strong>Vyloučeno</strong>. Nastavit parametry DPH pro zboží na <strong>skupiny DPH položky</strong> stránku (klepněte na tlačítko <strong>daně</strong>&gt;<strong>nepřímých daní</strong>&gt;<strong>DPH</strong>&gt;<strong>skupiny DPH položky</strong>). Pro každou skupinu DPH položky vyberte hodnotu v poli <strong>Typ vykazování</strong>. Hodnota, kterou jste vybrali, určuje sloupec částky ESL, ve kterém bude částka řádku zahrnuta.
<ul>
...
<td>Nastavit parametry sestavy na ESL <strong>parametry zahraničního obchodu</strong> stránku (klepněte na tlačítko <strong>daně</strong>&gt;<strong>nastavení</strong>&gt;<strong>zahraničního obchodu</strong>&gt;<strong>parametry zahraničního obchodu</strong>). Zadejte následující parametry:
<ul>
