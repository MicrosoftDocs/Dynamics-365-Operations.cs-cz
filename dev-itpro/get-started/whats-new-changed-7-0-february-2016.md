---
title: "Co je nové nebo změněné v Dynamics AX 7.0 (únor 2016)"
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Co je nové nebo změněné v Dynamics AX 7.0 (únor 2016)
...
| Automatizace sestavování, testování a nasazení.                                                                            | Částečně k dispozici                                                                                                                                                                                | Nasazení topologie pro vývojáře pomocí nástrojů Vývojář a Build VM. Automatická konfigurace nástroje Build VM, sestavování modulů z aplikace Visual Studio Online (VSO) a spouštění testů. C\# a jsou podporovány modul kompilaci jazyka X ++ a odkazy. | Snížením nákladů a nutného úsilí při testování a ověřování se zvýší produktivita vývojářů.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
<td>Byly přidány možnosti sestavy, takže různé filtry lze použít, když uživatel prohlíží sestavu. Nová sestava je generována pak podle těchto filtrů.</td>
...
<td>Finanční data analyzujte pomocí obsahu Power BI "Sledovat finanční výsledky".</td>
<td>Není k dispozici</td>
...
<td>Není k dispozici.</td>
<td>Na stránce **Parametry dlouhodobého majetku** můžete zvolit, zda má být zachycován na konci fiskálního období nebo fiskálního roku.</td>
...
<td>Funkce byla implementována jako konfigurace elektronických sestav. Funkce je k dispozici pro Německo a Rakousko.</td>
...
<td>Seznam zůstatků pomocí sestavy součty skupiny, je implementováno jako sestavy SSRS (LedgerAccountSum\_FR).</td>
...
<td>Samostatný seznam kódů komodit systému Intrastat jsou sloučeny s hierarchie produktů typu kód zboží.</td>
...
<td>Kód Intrastat zboží obsahuje textové pole pro identifikaci dalších jednotek a ** ** produkt karta má pole k identifikaci množství dalších jednotek v kilogramech.</td>
...
<tr class="odd">
<td>Analyzujte data prodeje maloobchodních kanálů pomocí obsahu Power BI "Maloobchodní sítě sledování výkonu".</td>
<td>Není k dispozici</td>
...
<ul>
<li>Moderní programu Retail POS.</li>
...
<li>Nabízí alternativní "připravené" balíčky, například režimu/skladování/varianta/přenosová kombinace založené na nejrychlejší dodání (nejbližší dostupné datum) kritérium, které uživatel může vybrat z.</li>
