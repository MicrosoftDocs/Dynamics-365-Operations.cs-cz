...
## <a name="pos--microsoft-dynamics-ax-retail"></a>Retail POS – aplikace Microsoft Dynamics AX Retail
|                                |                                                                                                                                                                                         |
|--------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Co můžete udělat?**           | **Proč je to důležité?**                                                                                                                                                              |
...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Co můžete udělat?**                                                | **Proč je to důležité?**                                                                                                                                                                                                                                                                                         |
| Znovu sestavte datové tržiště finančního vykazování.                          | Při přesunutí databází aplikace Dynamics AX mezi prostředím nebo provést jiné invazivní změny životního prostředí, finanční vykazování databáze pravděpodobně být znovu sestavovány. Skript prostředí Windows PowerShell je k dispozici nyní můžete znovu vytvořit databázi.                                                                |
| Nově již není možné vybrat možnosti návrháře sestav, které nejsou platné. | Některé možnosti návrháře sestav, které byly použity ve verzích trhu v aplikaci Management Reporter, se na tuto verzi Dynamics AX nevztahují. Tyto možnosti jsou spřízněni s návrh finanční sestavy, výstupu a propojení. Tyto možnosti byly odebrány z Návrháře finanční sestavy, chcete-li zabránit chybám uživatele. |
...
| Výpočet samostatné úrovně Kusovníku pro plánování materiálových zdrojů a nákladů výpočet: • plánování materiálových zdrojů, úrovně Kusovníku se vypočítají nové **ReqItemLevel** tabulka. Ve výpočtu jsou ignorovány ukončené výrobní zakázky. • Pro výpočet výrobních nákladů se úrovně kusovníku počítají v tabulce **InventTable**. Ve výpočtu jsou zahrnuty ukončené výrobní zakázky. | • Při spuštění plánování materiálových zdrojů, jako je například plánování hlavního plánu a rozpad, je nutné přepočítat pouze úrovně kusovníku používané pro plánování materiálových zdrojů. Jinými slovy není třeba vypočítat úrovně kusovníku, které jsou použity pro výpočet výrobních nákladů. • Při spuštění operací pro výpočet nákladů, jako jsou například skladové uzávěrky, je nutné přepočítat pouze úrovně kusovníku používané pro výpočet výrobních nákladů. |
...
[Nové nebo aktualizované úkoly vodítka (květen 2016)](new-updated-task-guides-available-may-2016.md)
