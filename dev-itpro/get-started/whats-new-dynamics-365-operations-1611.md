...
<tr class="even">
<td>Vytvořte sestavy pomocí aplikace Excel. <strong>Poznámka:</strong> musíte nejprve spustit aplikaci Microsoft Excel 2016.</td>
...
| Vytvořte podrobnější cíle.                                                                    | Budete mít větší kontrolu nad obsahem cílů, které si stanovíte. Můžete vytvořit měření pro cíle, propojovat položky v deníku výkonosti s měřeními a připojovat a zobrazovat dokumenty. Cíle můžete uložit jako šablony a znovu je použít pro rychlé nastavení.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Vytvořte podrobnější hodnocení výkonu.                                                      | Hodnocení výkonu, která se oficiálně nazývají diskuse, jsou nyní dostatečně flexibilní, aby podporovaly jak průběžnou zpětnou vazbu tak formálnější přezkoumání. Můžete směřovat k aktivním cílům, zveřejňovat komentáře o nich a přidávat oddíly pro revizi vašich kompetencí. K dispozici jsou další oddíly, kde lze přidávat nebo zobrazovat měření, deníky výkonu, přílohy a schválení, která souvisejí s příslušnou kontrolu.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Přidružte další hierarchie pozic k workflowům.                                      | Workflow je možné přiřadit k hierarchii pozic. Můžete také upravit kroky workflowu pro optimalizaci procesu schválení, tak aby odpovídal požadavkům společnosti. Proto můžete definovat efektivní strukturu schvalování, která bude vyhovovat různým vztahům vykazování, který vaše organizace používá.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Podpora workflowu pro zadávání osobních identifikačních kódů PIN na samoobslužných stránkách zaměstnanců. | Schopnost workflowu pro lidské zdroje (HR) se rozšířila a nyní podporuje kódy PIN. Zaměstnanci mohou přidávat a upravovat své PIN a zvyšovat tak efektivitu. Zaměstnanci HR však mohou zkontrolovat přesnost a úplnost těchto informací, než je přidají k záznamu zaměstnance.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Vytvořte šablony pro stanovování cílů a použijte je pro přidání nového cíle.                                          | Můžete vytvořit šablony cílů pro cíle, které může sdílet mnoho zaměstnancům v dané společnosti. Zaměstnanci mohou přidávat své vlastní cíle ze šablon, manažeři mohou přidat cíle pro své týmy ze šablony a členové HR týmů mohou přidávat cíle pro zaměstnance napříč společnostmi.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Vytvořte skupiny cílů a použijte je pro přidání nových cílů.                                             | Můžete přidat šablony cílů do skupiny a s její pomocí vytvořit jeden nebo více cílů pro zaměstnance, tým, pozici, oddělení nebo společnosti.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Mějte větší kontrolu nad procesem kontroly.                                                     | Workflow slouží i k řízení procesu kontroly. Můžete vytvořit šablony revize a použít je k vytvoření hodnocení. Můžete také přidat hodnocení pro revize.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Období revizí můžete využít k definování časového období pro kontrolu.                                    | Můžete definovat časové období pro provedení kontroly výkonu, přičemž počáteční a koncové datum revize jsou zadány automaticky. Výchozí data můžete podle potřeby měnit.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Přístup k pěti nové sady obsahu Power BI pro lidské zdroje                                     | Nové sady obsahu povolit organizace a personální manažeři lidských zdrojů analyzovat následující: pracovníků metriky • demografické rozdělení podle věku, pohlaví a rodinného stavu • porovnat sazby otěr přes rok a zobrazí seznam důvodů zaměstnanci dali pro opuštění organizace • zobrazit seznam otevřených pozic, jakož i porovnání k uzavření otevřených pozic kompenzace a výhody • porovnat každou hodinu a mzda zaměstnance • zobrazit počet zaměstnanců zapsanou v k dispozici výhody • zobrazení zaměstnanců podle typu zaměstnání • nábor analyzovat držení žadatelů na základě počtu žadatelů, kde jste pocházející z, a pozice, které jsou žádající organizace školení • registraci kurzu podle umístění • Couse docházky ve stavu • seznam zaměstnanců registrovaných kurzů zaměstnance kompetence a rozvoj • seznam dovedností zaměstnanců • rozdělení typů dovedností tak, že člen týmu |
...
Následující země také vyžadují lokalizaci maloobchodu. Lokalizace maloobchodu pro tyto země nebyla dokončena a je plánována pouze pro H1 CY2017:
<ul>
<li>Brazílie</li>
<li>Česká republika</li>
<li>Estonsko</li>
...
<td>Různé banky LC Poplatek za přidělení formát Saúdská Arábie</td>
</tr>
<tr class="odd">
...
### <a name="personalized-product-recommendations"></a>Doporučení pro individuální produkt.

| Co můžete dělat                                                                                                                                                                                                                                                                        | Proč je to důležité                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Zobrazit produkt individuální doporučení více touchpoints na pokladním místě (POS) Chcete-li zjistit, jaký zákazník může mít zájem na základě jejich historie nákupů, položek v seznamu jejich přání a položky, které ostatní zákazníci zakoupili online a v cihel a Malty obchody | Individuální doporučení prodejců s velkým katalogy zákazníkovi pomoci s zjišťování produktu a zmocnit associates store s inteligentní clienteling. Demonstrační výrobky cílené na zájmy zákazníka a nákupních zvyklostech doporučení produktu pomáhá maloobchodníkům s upsell a mohou zlepšit uchovávání informací zákazníka. V 365 Dynamics pro operace - maloobchod, doporučení produktu jsou napájeny z kognitivních služeb a Microsoft Azure machine learning. |
...
| Další informace o podpoře zásilek Dynamics 365 for Operations                                                                                                         | Další informace o podpoře pro dodávku procesy, naleznete v [zásilky](/dynamics365/operations/scm/inventory/consignment), [nastavení zásilky](/dynamics365/operations/scm/inventory/set-up-consignment), [vytvořit zásilku doplňující objednávky (úkol guide)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), a [změna vlastnictví šarže zásob na základě výrobní poptávky (úkol guide)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
<tbody>
<tr class="odd">
<td>Definujte přímo na řádcích prodejní objednávky, odkud a jak mají poptávky čerpat své zdroje. <strong>Příklad</strong> vytvořte řádek prodejní objednávky a zadat jako typ dodávky Přímá dodávka. Primární dodavatel je přidán do řádku prodejní objednávky jako zdrojový bod.</td>
...
<tr class="even">
<td>Vytvořte příslib objednávky přímo z řádků prodejní objednávky. <strong>Příklad</strong> vytvořte řádek prodejní objednávky, která je získávána z mezipodnikového dodavatele. Opusťte řádek. Data doručení se vypočítávají podle dostupnosti ve zdrojové společnosti.</td>
