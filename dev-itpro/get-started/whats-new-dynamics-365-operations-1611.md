...
<td>Vedlejší náklady akreditivu banky Formát přidělení nákladů pro Saúdskou Arábii</td>
</tr>
<tr class="odd">
...
| Další informace o podpoře zásilek Dynamics 365 for Operations                                                                                                         | Chcete-li zobrazit další informace týkající se podpory pro procesy dodávek, otevřete [Zásilka](/dynamics365/unified-operations/supply-chain/inventory/consignment), [Nastavení zásilky](/dynamics365/unified-operations/supply-chain/inventory/set-up-consignment), [Vytvoření nové zakázky na doplnění stavu zásob dodávky (Průvodce záznamem úloh)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) a [Změna vlastnictví zásilky zásob na základě výrobní poptávky (Průvodce záznamem úloh)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
<tbody>
<tr class="odd">
<td>Definujte přímo na řádcích prodejní objednávky, odkud a jak mají poptávky čerpat své zdroje. <strong>Příklad</strong> Vytvořte řádek prodejní objednávky a určete přímou dodávku jakožto typ dodání. Primární dodavatel je přidán do řádku prodejní objednávky jako zdrojový bod.</td>
...
<tr class="even">
<td>Vytvořte příslib objednávky přímo z řádků prodejní objednávky. <strong>Příklad:</strong> Vytvořte řádek prodejní objednávky, která čerpá zdroje u vnitropodnikového dodavatele. Opusťte řádek. Data doručení se vypočítávají podle dostupnosti ve zdrojové společnosti.</td>
