...
---
# <a name="use-computations-to-make-the-output-for-counting-and-summing-for-electronic-reporting-er"></a>Použití výpočtů pro provádění výstupu počítání a sčítání pro elektronické výkaznictví (ER)
