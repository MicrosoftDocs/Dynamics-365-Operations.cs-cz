...
---
# <a name="import-a-configuration-from-lifecycle-services-for-electronic-reporting-er"></a>Import konfigurace ze služby Lifecycle Services pro elektronické výkaznictví (ER)
