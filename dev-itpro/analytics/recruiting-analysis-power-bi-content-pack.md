...
Pokud používáte aplikaci Microsoft Dynamics 365 Finance and Operations, Enterprise edition v aktualizaci z července 2017, obsah Power BI **Nábor** se zobrazuje v pracovním prostoru **Řízení náboru**. 
...
Pracovní prostor **Řízení náboru** obsahuje kartu **Analýza**. Tato karta obsahuje zabudovaný obsah Power BI pro nábor. Obsah je tvořen kartou Přehled a dalšími kartami, které obsahují podrobnosti. Následující tabulka obsahuje popis daných sestav na jednotlivých kartách.
