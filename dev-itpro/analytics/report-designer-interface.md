...
| Příkaz | popis                                                  |
|---------|--------------------------------------------------------------|
| Nápověda    | Otevřete stránku wiki s nápovědou k aplikaci Dynamics 365 for Operations pro finanční výkaznictví. |
|         |                                                              |
...
[Generování finanční sestavy](\financials\general-ledger\generate-financial-report.md)
