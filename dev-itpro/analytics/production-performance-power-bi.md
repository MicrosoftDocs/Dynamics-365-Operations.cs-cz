...
- [Datové entity](https://ax.help.dynamics.com/en/wiki/data-entities/)
...
- [Přidání dlaždic Power BI do pracovních prostorů](http://ax.help.dynamics.com/en/wiki/configuring-powerbi-integration/)
