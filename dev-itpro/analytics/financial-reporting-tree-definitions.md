...
-   Zvažte, jak je nastavena vaše struktura, a potom vytvořte organizační graf vaší společnosti. Organizační graf vám pomůže vizualizovat způsob seskupení jednotek výkaznictví do jednoho nebo více stromů výkaznictví.
...
| Definice řádku       | Název definice řádku pro jednotku výkaznictví. Pro každou jednotku stromu výkaznictví se používá stejná definice řádku. Při generování sestavy se tato definice řádku používá pro každou jednotku vykazování. Definice řádku může zahrnovat více propojení finančních dimenzí. Je-li zadána definice řádku ve stromové struktuře vykazování, zaškrtněte pole **Použít definici řádku ze stromu výkaznictví** na kartě **Sestava** v definici sestavy.|
| Odkaz řádku              | Odkaz řádku pro jednotku výkaznictví. Odkazy řádků jsou definovány pro definici řádku k identifikaci finančních dimenzí k propojení.|
