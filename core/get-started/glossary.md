...
###### <a name="co-product"></a>**vedlejší produkt**
...
###### <a name="demand-forecasting"></a>**tvorba prognózy poptávky**
...
###### <a name="financial-dimensionsdimension-based-configuration"></a>**konfigurace produktu založená na dimenzích**
...
###### <a name="intercompany"></a>**mezipodnikové**
...
Označuje atributy Velikost, Barva a Konfigurace produktu, které se používají v konfiguraci produktu založené na dimenzích.
...
###### <a name="purchase-order-policy"></a>**zásady nákupních objednávek**
...
###### <a name="purchase-requisition"></a>**nákupní žádanka**
