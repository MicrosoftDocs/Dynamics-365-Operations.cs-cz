...
[![Konfigurace a filtr-pracovní prostory](./media/configure-and-filter-workspaces.png)](./media/configure-and-filter-workspaces.png)   
...
[![Konfigurace Můj prostoru](./media/configure-my-workspace.png)](./media/configure-my-workspace.png)
...
[![Filtr pracovní prostor](./media/workspace-filter.png)](./media/workspace-filter.png) 

Po kliknutí na tlačítko k otevření filtru se zobrazí několik možností. 

[![Rozbalit filtr pracovního prostoru](./media/workspace-filter-expanded.png)](./media/workspace-filter-expanded.png) 
...
[![prostoru oddíl filtry](./media/workspace-section-filters.png)](./media/workspace-section-filters.png) 
