...
description: "Tento článek vysvětluje, jak nastavit a používat dva typy maloobchodní místa prodeje (POS) směny - sdílené a samostatné. Sdílené směny může používat více uživatelů na více místech, zatímco samostatné směny může využívat vždy pouze jeden pracovník najednou."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Tento článek vysvětluje, jak nastavit a používat dva typy maloobchodní místa prodeje (POS) směny - sdílené a samostatné. Sdílené směny může používat více uživatelů na více místech, zatímco samostatné směny může využívat vždy pouze jeden pracovník najednou.
...
1.  Klepněte na tlačítko **maloobchodní a commerce**&gt;**nastavení kanálu**&gt;**instalace POS**&gt;**profily POS**&gt;**hardwarové profily**.
...
4.  Click **Save**.
5.  Klepněte na tlačítko **maloobchodní a commerce**&gt;**nastavení kanálu**&gt;**instalace POS**&gt;**registruje**.
...
8.  Click **Save**.
9.  Klepněte na tlačítko **maloobchodní a commerce**&gt;**Retail IT**&gt;**plán distribuce**.
