...
## <a name="install-the-oneclick-designer"></a>Instalace návrháře oneclick
1.  V 365 Microsoft Dynamics pro operace, použijte nabídku vlevo nahoře přejděte do **Retail****a commerce**&gt;**nastavení kanálu**&gt;**instalace POS**&gt;**POS**&gt;**rozložení obrazovky**.
...
6.  Po ověření pověření a spuštění návrháře můžete začít navrhovat vlastní rozložení nebo změnit existující rozložení. [![Rozložení v Návrháři jedním kliknutím](./media/screenlayoutdesign_mposdownload-1024x664.png)](./media/screenlayoutdesign_mposdownload.png)
...
-   Po klepnutí na tlačítko **Návrhář** se nezobrazí výzva ke stažení (nebo spuštění) instalačního programu nebo vaše stávající nastavení zabezpečení neumožňuje stažení souboru. **Řešení:**
    -   V aplikaci Internet Explorer se ujistěte, že je pro tento web blokování zakázáno. Klepněte na tlačítko **nastavení**&gt;**možnosti**&gt;**osobních**&gt;**najít blokování automaticky otevíraných oken**a změnit nastavení, pokud je požadována změna.
    -   V aplikaci Internet Explorer přidejte adresu URL Dynamics 365 for Operations do seznamu důvěryhodných webů. Klepněte na tlačítko **nastavení**&gt;**možnosti**&gt;**zabezpečení**&gt;**Důvěryhodné servery**&gt;**servery**&gt;**přidat**.
-   Program nelze spustit, a jste vyzváni, abyste kontaktovali dodavatele. **Řešení:** V aplikaci Internet Explorer přidejte adresu URL Dynamics 365 for Operations do seznamu důvěryhodných webů. Klepněte na tlačítko **nastavení**&gt;**možnosti**&gt;**zabezpečení**&gt;**Důvěryhodné servery**&gt;**servery**&gt;**přidat**.
