...
Částky fixní kompenzace lze vypočítat pro zaměstnance na základě faktorů, jako je výkon, oblast a zvýšení rozpočtu. Microsoft Dynamics 365 for Operations podporuje typy kompenzace kroku, stupně a pásma.
